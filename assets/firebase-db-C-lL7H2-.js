 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _n="remoteDocuments",Xi="owner",Kn="owner",Ni="mutationQueues",Dy="userId",rt="mutations",Sh="batchId",In="userMutationsIndex",Ph=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Br(s,e){return[s,qe(e)]}function Xf(s,e,t){return[s,qe(e),t]}const ky={},ds="documentMutations",no="remoteDocumentsV14",Oy=["prefixPath","collectionGroup","readTime","documentId"],qr="documentKeyIndex",My=["prefixPath","collectionGroup","documentId"],Jf="collectionGroupIndex",Fy=["collectionGroup","readTime","prefixPath","documentId"],Di="remoteDocumentGlobal",sl="remoteDocumentGlobalKey",fs="targets",Zf="queryTargetsIndex",Ly=["canonicalId","targetId"],_s="targetDocuments",Uy=["targetId","path"],$l="documentTargetsIndex",By=["path","targetId"],so="targetGlobalKey",wn="targetGlobal",ki="collectionParents",qy=["collectionId","parent"],ps="clientMetadata",jy="clientId",Lo="bundles",Gy="bundleId",Uo="namedQueries",zy="name",Ql="indexConfiguration",Ky="indexId",il="collectionGroupIndex",Wy="collectionGroup",yi="indexState",$y=["indexId","uid"],e_="sequenceNumberIndex",Qy=["uid","sequenceNumber"],Ei="indexEntries",Hy=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],t_="documentKeyIndex",Yy=["indexId","uid","orderedDocumentKey"],Bo="documentOverlays",Xy=["userId","collectionPath","documentId"],rl="collectionPathOverlayIndex",Jy=["userId","collectionPath","largestBatchId"],n_="collectionGroupOverlayIndex",Zy=["userId","collectionGroup","largestBatchId"],Hl="globals",eE="name",s_=[Ni,rt,ds,_n,fs,Xi,wn,_s,ps,Di,ki,Lo,Uo],tE=[...s_,Bo],i_=[Ni,rt,ds,no,fs,Xi,wn,_s,ps,Di,ki,Lo,Uo,Bo],r_=i_,Yl=[...r_,Ql,yi,Ei],nE=Yl,o_=[...Yl,Hl],sE=o_;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ui{constructor(e,t="asc"){this.field=e,this.dir=t}}function lE(s,e){return s.dir===e.dir&&s.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pE{constructor(e,t=null,n=[],i=[],r=null,o=null,l=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=i,this.limit=r,this.startAt=o,this.endAt=l,this.Pe=null}}function dl(s,e=null,t=[],n=[],i=null,r=null,o=null){return new pE(s,e,t,n,i,r,o)}function bn(s){const e=L(s);if(e.Pe===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(n=>hl(n)).join(","),t+="|ob:",t+=e.orderBy.map(n=>function(r){return r.field.canonicalString()+r.dir}(n)).join(","),Fo(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(n=>gs(n)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(n=>gs(n)).join(",")),e.Pe=t}return e.Pe}function Ji(s,e){if(s.limit!==e.limit||s.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<s.orderBy.length;t++)if(!lE(s.orderBy[t],e.orderBy[t]))return!1;if(s.filters.length!==e.filters.length)return!1;for(let t=0;t<s.filters.length;t++)if(!E_(s.filters[t],e.filters[t]))return!1;return s.collectionGroup===e.collectionGroup&&!!s.path.isEqual(e.path)&&!!Lh(s.startAt,e.startAt)&&Lh(s.endAt,e.endAt)}function ro(s){return M.isDocumentKey(s.path)&&s.collectionGroup===null&&s.filters.length===0}function oo(s,e){return s.filters.filter(t=>t instanceof Y&&t.field.isEqual(e))}function Uh(s,e,t){let n=jr,i=!0;for(const r of oo(s,e)){let o=jr,l=!0;switch(r.op){case"<":case"<=":o=oE(r.value);break;case"==":case"in":case">=":o=r.value;break;case">":o=r.value,l=!1;break;case"!=":case"not-in":o=jr}Oh({value:n,inclusive:i},{value:o,inclusive:l})<0&&(n=o,i=l)}if(t!==null){for(let r=0;r<s.orderBy.length;++r)if(s.orderBy[r].field.isEqual(e)){const o=t.position[r];Oh({value:n,inclusive:i},{value:o,inclusive:t.inclusive})<0&&(n=o,i=t.inclusive);break}}return{value:n,inclusive:i}}function Bh(s,e,t){let n=jt,i=!0;for(const r of oo(s,e)){let o=jt,l=!0;switch(r.op){case">=":case">":o=aE(r.value),l=!1;break;case"==":case"in":case"<=":o=r.value;break;case"<":o=r.value,l=!1;break;case"!=":case"not-in":o=jt}Mh({value:n,inclusive:i},{value:o,inclusive:l})>0&&(n=o,i=l)}if(t!==null){for(let r=0;r<s.orderBy.length;++r)if(s.orderBy[r].field.isEqual(e)){const o=t.position[r];Mh({value:n,inclusive:i},{value:o,inclusive:t.inclusive})>0&&(n=o,i=t.inclusive);break}}return{value:n,inclusive:i}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yE=new _e(M.comparator);function Ze(){return yE}const b_=new _e(M.comparator);function di(...s){let e=b_;for(const t of s)e=e.insert(t.key,t);return e}function V_(s){let e=b_;return s.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function pt(){return Ti()}function x_(){return Ti()}function Ti(){return new xt(s=>s.toString(),(s,e)=>s.isEqual(e))}const EE=new _e(M.comparator),IE=new re(M.comparator);function W(...s){let e=IE;for(const t of s)e=e.add(t);return e}const vE=new re(G);function tu(){return vE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nu(s,e){if(s.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:xi(e)?"-0":e}}function N_(s){return{integerValue:""+s}}function TE(s,e){return Yf(e)?N_(e):nu(s,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class QE{St(e){return Ae(e,Hl)}getSessionToken(e){return this.St(e).get("sessionToken").next(t=>{const n=t==null?void 0:t.value;return n?Ie.fromUint8Array(n):Ie.EMPTY_BYTE_STRING})}setSessionToken(e,t){return this.St(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eI{constructor(){this.Dn=new uu}addToCollectionParentIndex(e,t){return this.Dn.add(t),A.resolve()}getCollectionParents(e,t){return A.resolve(this.Dn.getEntries(t))}addFieldIndex(e,t){return A.resolve()}deleteFieldIndex(e,t){return A.resolve()}deleteAllFieldIndexes(e){return A.resolve()}createTargetIndexes(e,t){return A.resolve()}getDocumentsMatchingTarget(e,t){return A.resolve(null)}getIndexType(e,t){return A.resolve(0)}getFieldIndexes(e,t){return A.resolve([])}getNextCollectionGroupToUpdate(e){return A.resolve(null)}getMinOffset(e,t){return A.resolve(nt.min())}getMinOffsetFromCollectionGroup(e,t){return A.resolve(nt.min())}updateCollectionGroup(e,t,n){return A.resolve()}updateIndexEntries(e,t){return A.resolve()}}class uu{constructor(){this.index={}}add(e){const t=e.lastSegment(),n=e.popLast(),i=this.index[t]||new re(te.comparator),r=!i.has(n);return this.index[t]=i.add(n),r}has(e){const t=e.lastSegment(),n=e.popLast(),i=this.index[t];return i&&i.has(n)}getEntries(e){return(this.index[e]||new re(te.comparator)).toArray()}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hI{constructor(){this.sessionToken=Ie.EMPTY_BYTE_STRING}getSessionToken(e){return A.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,A.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ka="RestConnection",SI={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class PI{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${n}/databases/${i}`,this.Ko=this.databaseId.database===io?`project_id=${n}`:`project_id=${n}&database_id=${i}`}Wo(e,t,n,i,r){const o=wl(),l=this.Go(e,t.toUriEncodedString());N(Ka,`Sending RPC '${e}' ${o}:`,l,n);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(u,i,r);const{host:c}=new URL(l),f=Do(c);return this.jo(e,l,u,n,f).then(_=>(N(Ka,`Received RPC '${e}' ${o}: `,_),_),_=>{throw Qt(Ka,`RPC '${e}' ${o} failed with error: `,_,"url: ",l,"request:",n),_})}Jo(e,t,n,i,r,o){return this.Wo(e,t,n,i,r)}zo(e,t,n){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+xs}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((i,r)=>e[r]=i),n&&n.headers.forEach((i,r)=>e[r]=i)}Go(e,t){const n=SI[e];return`${this.$o}/v1/${t}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xo(s){return new ME(s,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Td="PersistentStream";class Vp{constructor(e,t,n,i,r,o,l,u){this.Fi=e,this.w_=n,this.S_=i,this.connection=r,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=l,this.listener=u,this.state=0,this.b_=0,this.D_=null,this.v_=null,this.stream=null,this.C_=0,this.F_=new bp(e,t)}M_(){return this.state===1||this.state===5||this.x_()}x_(){return this.state===2||this.state===3}start(){this.C_=0,this.state!==4?this.auth():this.O_()}async stop(){this.M_()&&await this.close(0)}N_(){this.state=0,this.F_.reset()}B_(){this.x_()&&this.D_===null&&(this.D_=this.Fi.enqueueAfterDelay(this.w_,6e4,()=>this.L_()))}k_(e){this.q_(),this.stream.send(e)}async L_(){if(this.x_())return this.close(0)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}Q_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.q_(),this.Q_(),this.F_.cancel(),this.b_++,e!==4?this.F_.reset():t&&t.code===b.RESOURCE_EXHAUSTED?(ye(t.toString()),ye("Using maximum backoff delay to prevent overloading the backend."),this.F_.f_()):t&&t.code===b.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.U_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.n_(t)}U_(){}auth(){this.state=1;const e=this.K_(this.b_),t=this.b_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,i])=>{this.b_===t&&this.W_(n,i)},n=>{e(()=>{const i=new D(b.UNKNOWN,"Fetching auth token failed: "+n.message);return this.G_(i)})})}W_(e,t){const n=this.K_(this.b_);this.stream=this.z_(e,t),this.stream.Zo(()=>{n(()=>this.listener.Zo())}),this.stream.e_(()=>{n(()=>(this.state=2,this.v_=this.Fi.enqueueAfterDelay(this.S_,1e4,()=>(this.x_()&&(this.state=3),Promise.resolve())),this.listener.e_()))}),this.stream.n_(i=>{n(()=>this.G_(i))}),this.stream.onMessage(i=>{n(()=>++this.C_==1?this.j_(i):this.onNext(i))})}O_(){this.state=5,this.F_.g_(async()=>{this.state=0,this.start()})}G_(e){return N(Td,`close with error: ${e}`),this.stream=null,this.close(4,e)}K_(e){return t=>{this.Fi.enqueueAndForget(()=>this.b_===e?t():(N(Td,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class xI extends Vp{constructor(e,t,n,i,r,o){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,i,o),this.serializer=r}z_(e,t){return this.connection.P_("Listen",e,t)}j_(e){return this.onNext(e)}onNext(e){this.F_.reset();const t=UE(this.serializer,e),n=function(r){if(!("targetChange"in r))return q.min();const o=r.targetChange;return o.targetIds&&o.targetIds.length?q.min():o.readTime?ze(o.readTime):q.min()}(e);return this.listener.J_(t,n)}H_(e){const t={};t.database=ml(this.serializer),t.addTarget=function(r,o){let l;const u=o.target;if(l=ro(u)?{documents:H_(r,u)}:{query:Y_(r,u).Vt},l.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){l.resumeToken=z_(r,o.resumeToken);const c=_l(r,o.expectedCount);c!==null&&(l.expectedCount=c)}else if(o.snapshotVersion.compareTo(q.min())>0){l.readTime=ws(r,o.snapshotVersion.toTimestamp());const c=_l(r,o.expectedCount);c!==null&&(l.expectedCount=c)}return l}(this.serializer,e);const n=qE(this.serializer,e);n&&(t.labels=n),this.k_(t)}Y_(e){const t={};t.database=ml(this.serializer),t.removeTarget=e,this.k_(t)}}class NI extends Vp{constructor(e,t,n,i,r,o){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,i,o),this.serializer=r}get Z_(){return this.C_>0}start(){this.lastStreamToken=void 0,super.start()}U_(){this.Z_&&this.X_([])}z_(e,t){return this.connection.P_("Write",e,t)}j_(e){return U(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,U(!e.writeResults||e.writeResults.length===0,55816),this.listener.ea()}onNext(e){U(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.F_.reset();const t=BE(e.writeResults,e.commitTime),n=ze(e.commitTime);return this.listener.ta(n,t)}na(){const e={};e.database=ml(this.serializer),this.k_(e)}X_(e){const t={streamToken:this.lastStreamToken,writes:e.map(n=>uo(this.serializer,n))};this.k_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dn="RemoteStore";class MI{constructor(e,t,n,i,r){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=r,this.Ea.xo(o=>{n.enqueueAndForget(async()=>{Ln(this)&&(N(Dn,"Restarting streams for network reachability change."),await async function(u){const c=L(u);c.Ia.add(4),await nr(c),c.Aa.set("Unknown"),c.Ia.delete(4),await Jo(c)}(this))})}),this.Aa=new OI(n,i)}}async function Jo(s){if(Ln(s))for(const e of s.da)await e(!0)}async function nr(s){for(const e of s.da)await e(!1)}function Zo(s,e){const t=L(s);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),yu(t)?gu(t):Os(t).x_()&&mu(t,e))}function Rs(s,e){const t=L(s),n=Os(t);t.Ta.delete(e),n.x_()&&xp(t,e),t.Ta.size===0&&(n.x_()?n.B_():Ln(t)&&t.Aa.set("Unknown"))}function mu(s,e){if(s.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(q.min())>0){const t=s.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Os(s).H_(e)}function xp(s,e){s.Ra.$e(e),Os(s).Y_(e)}function gu(s){s.Ra=new NE({getRemoteKeysForTarget:e=>s.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>s.Ta.get(e)||null,lt:()=>s.datastore.serializer.databaseId}),Os(s).start(),s.Aa.aa()}function yu(s){return Ln(s)&&!Os(s).M_()&&s.Ta.size>0}function Ln(s){return L(s).Ia.size===0}function Np(s){s.Ra=void 0}async function FI(s){s.Aa.set("Online")}async function LI(s){s.Ta.forEach((e,t)=>{mu(s,e)})}async function UI(s,e){Np(s),yu(s)?(s.Aa.la(e),gu(s)):s.Aa.set("Unknown")}async function BI(s,e,t){if(s.Aa.set("Online"),e instanceof G_&&e.state===2&&e.cause)try{await async function(i,r){const o=r.cause;for(const l of r.targetIds)i.Ta.has(l)&&(await i.remoteSyncer.rejectListen(l,o),i.Ta.delete(l),i.Ra.removeTarget(l))}(s,e)}catch(n){N(Dn,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await yo(s,n)}else if(e instanceof Wr?s.Ra.Ye(e):e instanceof j_?s.Ra.it(e):s.Ra.et(e),!t.isEqual(q.min()))try{const n=await Ip(s.localStore);t.compareTo(n)>=0&&await function(r,o){const l=r.Ra.Pt(o);return l.targetChanges.forEach((u,c)=>{if(u.resumeToken.approximateByteSize()>0){const f=r.Ta.get(c);f&&r.Ta.set(c,f.withResumeToken(u.resumeToken,o))}}),l.targetMismatches.forEach((u,c)=>{const f=r.Ta.get(u);if(!f)return;r.Ta.set(u,f.withResumeToken(Ie.EMPTY_BYTE_STRING,f.snapshotVersion)),xp(r,u);const _=new wt(f.target,u,c,f.sequenceNumber);mu(r,_)}),r.remoteSyncer.applyRemoteEvent(l)}(s,t)}catch(n){N(Dn,"Failed to raise snapshot:",n),await yo(s,n)}}async function yo(s,e,t){if(!sn(e))throw e;s.Ia.add(1),await nr(s),s.Aa.set("Offline"),t||(t=()=>Ip(s.localStore)),s.asyncQueue.enqueueRetryable(async()=>{N(Dn,"Retrying IndexedDB access"),await t(),s.Ia.delete(1),await Jo(s)})}function Dp(s,e){return e().catch(t=>yo(s,t,e))}async function ks(s){const e=L(s),t=Xt(e);let n=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:Tn;for(;qI(e);)try{const i=await RI(e.localStore,n);if(i===null){e.Pa.length===0&&t.B_();break}n=i.batchId,jI(e,i)}catch(i){await yo(e,i)}kp(e)&&Op(e)}function qI(s){return Ln(s)&&s.Pa.length<10}function jI(s,e){s.Pa.push(e);const t=Xt(s);t.x_()&&t.Z_&&t.X_(e.mutations)}function kp(s){return Ln(s)&&!Xt(s).M_()&&s.Pa.length>0}function Op(s){Xt(s).start()}async function GI(s){Xt(s).na()}async function zI(s){const e=Xt(s);for(const t of s.Pa)e.X_(t.mutations)}async function KI(s,e,t){const n=s.Pa.shift(),i=iu.from(n,e,t);await Dp(s,()=>s.remoteSyncer.applySuccessfulWrite(i)),await ks(s)}async function WI(s,e){e&&Xt(s).Z_&&await async function(n,i){if(function(o){return VE(o)&&o!==b.ABORTED}(i.code)){const r=n.Pa.shift();Xt(n).N_(),await Dp(n,()=>n.remoteSyncer.rejectFailedWrite(r.batchId,i)),await ks(n)}}(s,e),kp(s)&&Op(s)}async function wd(s,e){const t=L(s);t.asyncQueue.verifyOperationInProgress(),N(Dn,"RemoteStore received new credentials");const n=Ln(t);t.Ia.add(3),await nr(t),n&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await Jo(t)}async function Al(s,e){const t=L(s);e?(t.Ia.delete(2),await Jo(t)):e||(t.Ia.add(2),await nr(t),t.Aa.set("Unknown"))}function Os(s){return s.Va||(s.Va=function(t,n,i){const r=L(t);return r.ia(),new xI(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)}(s.datastore,s.asyncQueue,{Zo:FI.bind(null,s),e_:LI.bind(null,s),n_:UI.bind(null,s),J_:BI.bind(null,s)}),s.da.push(async e=>{e?(s.Va.N_(),yu(s)?gu(s):s.Aa.set("Unknown")):(await s.Va.stop(),Np(s))})),s.Va}function Xt(s){return s.ma||(s.ma=function(t,n,i){const r=L(t);return r.ia(),new NI(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)}(s.datastore,s.asyncQueue,{Zo:()=>Promise.resolve(),e_:GI.bind(null,s),n_:WI.bind(null,s),ea:zI.bind(null,s),ta:KI.bind(null,s)}),s.da.push(async e=>{e?(s.ma.N_(),await ks(s)):(await s.ma.stop(),s.Pa.length>0&&(N(Dn,`Stopping write stream with ${s.Pa.length} pending writes`),s.Pa=[]))})),s.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Up{constructor(e){this.key=e}}class Bp{constructor(e){this.key=e}}class XI{constructor(e,t){this.query=e,this.Ha=t,this.Ya=null,this.hasCachedResults=!1,this.current=!1,this.Za=W(),this.mutatedKeys=W(),this.Xa=P_(e),this.eu=new rs(this.Xa)}get tu(){return this.Ha}nu(e,t){const n=t?t.ru:new Ad,i=t?t.eu:this.eu;let r=t?t.mutatedKeys:this.mutatedKeys,o=i,l=!1;const u=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,c=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((f,_)=>{const m=i.get(f),I=Zi(this.query,_)?_:null,S=!!m&&this.mutatedKeys.has(m.key),V=!!I&&(I.hasLocalMutations||this.mutatedKeys.has(I.key)&&I.hasCommittedMutations);let x=!1;m&&I?m.data.isEqual(I.data)?S!==V&&(n.track({type:3,doc:I}),x=!0):this.iu(m,I)||(n.track({type:2,doc:I}),x=!0,(u&&this.Xa(I,u)>0||c&&this.Xa(I,c)<0)&&(l=!0)):!m&&I?(n.track({type:0,doc:I}),x=!0):m&&!I&&(n.track({type:1,doc:m}),x=!0,(u||c)&&(l=!0)),x&&(I?(o=o.add(I),r=V?r.add(f):r.delete(f)):(o=o.delete(f),r=r.delete(f)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const f=this.query.limitType==="F"?o.last():o.first();o=o.delete(f.key),r=r.delete(f.key),n.track({type:1,doc:f})}return{eu:o,ru:n,Ds:l,mutatedKeys:r}}iu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n,i){const r=this.eu;this.eu=e.eu,this.mutatedKeys=e.mutatedKeys;const o=e.ru.pa();o.sort((f,_)=>function(I,S){const V=x=>{switch(x){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return F(20277,{At:x})}};return V(I)-V(S)}(f.type,_.type)||this.Xa(f.doc,_.doc)),this.su(n),i=i!=null&&i;const l=t&&!i?this.ou():[],u=this.Za.size===0&&this.current&&!i?1:0,c=u!==this.Ya;return this.Ya=u,o.length!==0||c?{snapshot:new Cs(this.query,e.eu,r,o,e.mutatedKeys,u===0,c,!1,!!n&&n.resumeToken.approximateByteSize()>0),_u:l}:{_u:l}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({eu:this.eu,ru:new Ad,mutatedKeys:this.mutatedKeys,Ds:!1},!1)):{_u:[]}}au(e){return!this.Ha.has(e)&&!!this.eu.has(e)&&!this.eu.get(e).hasLocalMutations}su(e){e&&(e.addedDocuments.forEach(t=>this.Ha=this.Ha.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ha=this.Ha.delete(t)),this.current=e.current)}ou(){if(!this.current)return[];const e=this.Za;this.Za=W(),this.eu.forEach(n=>{this.au(n.key)&&(this.Za=this.Za.add(n.key))});const t=[];return e.forEach(n=>{this.Za.has(n)||t.push(new Bp(n))}),this.Za.forEach(n=>{e.has(n)||t.push(new Up(n))}),t}uu(e){this.Ha=e.qs,this.Za=W();const t=this.nu(e.documents);return this.applyChanges(t,!0)}cu(){return Cs.fromInitialDocuments(this.query,this.eu,this.mutatedKeys,this.Ya===0,this.hasCachedResults)}}const Ms="SyncEngine";class JI{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class ZI{constructor(e){this.key=e,this.lu=!1}}class ev{constructor(e,t,n,i,r,o){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=i,this.currentUser=r,this.maxConcurrentLimboResolutions=o,this.hu={},this.Pu=new xt(l=>C_(l),zo),this.Tu=new Map,this.Iu=new Set,this.du=new _e(M.comparator),this.Eu=new Map,this.Au=new cu,this.Ru={},this.Vu=new Map,this.mu=Nn.ur(),this.onlineState="Unknown",this.fu=void 0}get isPrimaryClient(){return this.fu===!0}}async function tv(s,e,t=!0){const n=ea(s);let i;const r=n.Pu.get(e);return r?(n.sharedClientState.addLocalQueryTarget(r.targetId),i=r.view.cu()):i=await qp(n,e,t,!0),i}async function nv(s,e){const t=ea(s);await qp(t,e,!0,!1)}async function qp(s,e,t,n){const i=await po(s.localStore,et(e)),r=i.targetId,o=s.sharedClientState.addLocalQueryTarget(r,t);let l;return n&&(l=await Tu(s,e,r,o==="current",i.resumeToken)),s.isPrimaryClient&&t&&Zo(s.remoteStore,i),l}async function Tu(s,e,t,n,i){s.gu=(_,m,I)=>async function(V,x,K,j){let B=x.view.nu(K);B.Ds&&(B=await vl(V.localStore,x.query,!1).then(({documents:v})=>x.view.nu(v,B)));const J=j&&j.targetChanges.get(x.targetId),le=j&&j.targetMismatches.get(x.targetId)!=null,Z=x.view.applyChanges(B,V.isPrimaryClient,J,le);return Cl(V,x.targetId,Z._u),Z.snapshot}(s,_,m,I);const r=await vl(s.localStore,e,!0),o=new XI(e,r.qs),l=o.nu(r.documents),u=tr.createSynthesizedTargetChangeForCurrentChange(t,n&&s.onlineState!=="Offline",i),c=o.applyChanges(l,s.isPrimaryClient,u);Cl(s,t,c._u);const f=new JI(e,t,o);return s.Pu.set(e,f),s.Tu.has(t)?s.Tu.get(t).push(e):s.Tu.set(t,[e]),c.snapshot}async function sv(s,e,t){const n=L(s),i=n.Pu.get(e),r=n.Tu.get(i.targetId);if(r.length>1)return n.Tu.set(i.targetId,r.filter(o=>!zo(o,e))),void n.Pu.delete(e);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(i.targetId),n.sharedClientState.isActiveQueryTarget(i.targetId)||await As(n.localStore,i.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(i.targetId),t&&Rs(n.remoteStore,i.targetId),Ss(n,i.targetId)}).catch(nn)):(Ss(n,i.targetId),await As(n.localStore,i.targetId,!0))}async function iv(s,e){const t=L(s),n=t.Pu.get(e),i=t.Tu.get(n.targetId);t.isPrimaryClient&&i.length===1&&(t.sharedClientState.removeLocalQueryTarget(n.targetId),Rs(t.remoteStore,n.targetId))}async function rv(s,e,t){const n=Cu(s);try{const i=await function(o,l){const u=L(o),c=se.now(),f=l.reduce((I,S)=>I.add(S.key),W());let _,m;return u.persistence.runTransaction("Locally write mutations","readwrite",I=>{let S=Ze(),V=W();return u.Os.getEntries(I,f).next(x=>{S=x,S.forEach((K,j)=>{j.isValidDocument()||(V=V.add(K))})}).next(()=>u.localDocuments.getOverlayedDocuments(I,S)).next(x=>{_=x;const K=[];for(const j of l){const B=PE(j,_.get(j.key).overlayedDocument);B!=null&&K.push(new Nt(j.key,B,m_(B.value.mapValue),Be.exists(!0)))}return u.mutationQueue.addMutationBatch(I,c,K,l)}).next(x=>{m=x;const K=x.applyToLocalDocumentSet(_,V);return u.documentOverlayCache.saveOverlays(I,x.batchId,K)})}).then(()=>({batchId:m.batchId,changes:V_(_)}))}(n.localStore,e);n.sharedClientState.addPendingMutation(i.batchId),function(o,l,u){let c=o.Ru[o.currentUser.toKey()];c||(c=new _e(G)),c=c.insert(l,u),o.Ru[o.currentUser.toKey()]=c}(n,i.batchId,t),await on(n,i.changes),await ks(n.remoteStore)}catch(i){const r=Iu(i,"Failed to persist write");t.reject(r)}}async function jp(s,e){const t=L(s);try{const n=await wI(t.localStore,e);e.targetChanges.forEach((i,r)=>{const o=t.Eu.get(r);o&&(U(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1,22616),i.addedDocuments.size>0?o.lu=!0:i.modifiedDocuments.size>0?U(o.lu,14607):i.removedDocuments.size>0&&(U(o.lu,42227),o.lu=!1))}),await on(t,n,e)}catch(n){await nn(n)}}function Sd(s,e,t){const n=L(s);if(n.isPrimaryClient&&t===0||!n.isPrimaryClient&&t===1){const i=[];n.Pu.forEach((r,o)=>{const l=o.view.va(e);l.snapshot&&i.push(l.snapshot)}),function(o,l){const u=L(o);u.onlineState=l;let c=!1;u.queries.forEach((f,_)=>{for(const m of _.wa)m.va(l)&&(c=!0)}),c&&vu(u)}(n.eventManager,e),i.length&&n.hu.J_(i),n.onlineState=e,n.isPrimaryClient&&n.sharedClientState.setOnlineState(e)}}async function ov(s,e,t){const n=L(s);n.sharedClientState.updateQueryState(e,"rejected",t);const i=n.Eu.get(e),r=i&&i.key;if(r){let o=new _e(M.comparator);o=o.insert(r,me.newNoDocument(r,q.min()));const l=W().add(r),u=new er(q.min(),new Map,new _e(G),o,l);await jp(n,u),n.du=n.du.remove(r),n.Eu.delete(e),Ru(n)}else await As(n.localStore,e,!1).then(()=>Ss(n,e,t)).catch(nn)}async function av(s,e){const t=L(s),n=e.batch.batchId;try{const i=await TI(t.localStore,e);Au(t,n,null),wu(t,n),t.sharedClientState.updateMutationState(n,"acknowledged"),await on(t,i)}catch(i){await nn(i)}}async function lv(s,e,t){const n=L(s);try{const i=await function(o,l){const u=L(o);return u.persistence.runTransaction("Reject batch","readwrite-primary",c=>{let f;return u.mutationQueue.lookupMutationBatch(c,l).next(_=>(U(_!==null,37113),f=_.keys(),u.mutationQueue.removeMutationBatch(c,_))).next(()=>u.mutationQueue.performConsistencyCheck(c)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(c,f,l)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(c,f)).next(()=>u.localDocuments.getDocuments(c,f))})}(n.localStore,e);Au(n,e,t),wu(n,e),n.sharedClientState.updateMutationState(e,"rejected",t),await on(n,i)}catch(i){await nn(i)}}function wu(s,e){(s.Vu.get(e)||[]).forEach(t=>{t.resolve()}),s.Vu.delete(e)}function Au(s,e,t){const n=L(s);let i=n.Ru[n.currentUser.toKey()];if(i){const r=i.get(e);r&&(t?r.reject(t):r.resolve(),i=i.remove(e)),n.Ru[n.currentUser.toKey()]=i}}function Ss(s,e,t=null){s.sharedClientState.removeLocalQueryTarget(e);for(const n of s.Tu.get(e))s.Pu.delete(n),t&&s.hu.pu(n,t);s.Tu.delete(e),s.isPrimaryClient&&s.Au.zr(e).forEach(n=>{s.Au.containsKey(n)||Gp(s,n)})}function Gp(s,e){s.Iu.delete(e.path.canonicalString());const t=s.du.get(e);t!==null&&(Rs(s.remoteStore,t),s.du=s.du.remove(e),s.Eu.delete(t),Ru(s))}function Cl(s,e,t){for(const n of t)n instanceof Up?(s.Au.addReference(n.key,e),uv(s,n)):n instanceof Bp?(N(Ms,"Document no longer in limbo: "+n.key),s.Au.removeReference(n.key,e),s.Au.containsKey(n.key)||Gp(s,n.key)):F(19791,{yu:n})}function uv(s,e){const t=e.key,n=t.path.canonicalString();s.du.get(t)||s.Iu.has(n)||(N(Ms,"New document in limbo: "+t),s.Iu.add(n),Ru(s))}function Ru(s){for(;s.Iu.size>0&&s.du.size<s.maxConcurrentLimboResolutions;){const e=s.Iu.values().next().value;s.Iu.delete(e);const t=new M(te.fromString(e)),n=s.mu.next();s.Eu.set(n,new ZI(t)),s.du=s.du.insert(t,n),Zo(s.remoteStore,new wt(et(Go(t.path)),n,"TargetPurposeLimboResolution",Ke.ue))}}async function on(s,e,t){const n=L(s),i=[],r=[],o=[];n.Pu.isEmpty()||(n.Pu.forEach((l,u)=>{o.push(n.gu(u,e,t).then(c=>{var f;if((c||t)&&n.isPrimaryClient){const _=c?!c.fromCache:(f=t==null?void 0:t.targetChanges.get(u.targetId))===null||f===void 0?void 0:f.current;n.sharedClientState.updateQueryState(u.targetId,_?"current":"not-current")}if(c){i.push(c);const _=fu.Es(u.targetId,c);r.push(_)}}))}),await Promise.all(o),n.hu.J_(i),await async function(u,c){const f=L(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",_=>A.forEach(c,m=>A.forEach(m.Is,I=>f.persistence.referenceDelegate.addReference(_,m.targetId,I)).next(()=>A.forEach(m.ds,I=>f.persistence.referenceDelegate.removeReference(_,m.targetId,I)))))}catch(_){if(!sn(_))throw _;N(_u,"Failed to update sequence numbers: "+_)}for(const _ of c){const m=_.targetId;if(!_.fromCache){const I=f.Fs.get(m),S=I.snapshotVersion,V=I.withLastLimboFreeSnapshotVersion(S);f.Fs=f.Fs.insert(m,V)}}}(n.localStore,r))}async function cv(s,e){const t=L(s);if(!t.currentUser.isEqual(e)){N(Ms,"User change. New user:",e.toKey());const n=await Ep(t.localStore,e);t.currentUser=e,function(r,o){r.Vu.forEach(l=>{l.forEach(u=>{u.reject(new D(b.CANCELLED,o))})}),r.Vu.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,n.removedBatchIds,n.addedBatchIds),await on(t,n.Bs)}}function hv(s,e){const t=L(s),n=t.Eu.get(e);if(n&&n.lu)return W().add(n.key);{let i=W();const r=t.Tu.get(e);if(!r)return i;for(const o of r){const l=t.Pu.get(o);i=i.unionWith(l.view.tu)}return i}}async function dv(s,e){const t=L(s),n=await vl(t.localStore,e.query,!0),i=e.view.uu(n);return t.isPrimaryClient&&Cl(t,e.targetId,i._u),i}async function fv(s,e){const t=L(s);return Tp(t.localStore,e).then(n=>on(t,n))}async function _v(s,e,t,n){const i=L(s),r=await function(l,u){const c=L(l),f=L(c.mutationQueue);return c.persistence.runTransaction("Lookup mutation documents","readonly",_=>f.Xn(_,u).next(m=>m?c.localDocuments.getDocuments(_,m):A.resolve(null)))}(i.localStore,e);r!==null?(t==="pending"?await ks(i.remoteStore):t==="acknowledged"||t==="rejected"?(Au(i,e,n||null),wu(i,e),function(l,u){L(L(l).mutationQueue).rr(u)}(i.localStore,e)):F(6720,"Unknown batchState",{wu:t}),await on(i,r)):N(Ms,"Cannot apply mutation batch with id: "+e)}async function pv(s,e){const t=L(s);if(ea(t),Cu(t),e===!0&&t.fu!==!0){const n=t.sharedClientState.getAllActiveQueryTargets(),i=await Pd(t,n.toArray());t.fu=!0,await Al(t.remoteStore,!0);for(const r of i)Zo(t.remoteStore,r)}else if(e===!1&&t.fu!==!1){const n=[];let i=Promise.resolve();t.Tu.forEach((r,o)=>{t.sharedClientState.isLocalQueryTarget(o)?n.push(o):i=i.then(()=>(Ss(t,o),As(t.localStore,o,!0))),Rs(t.remoteStore,o)}),await i,await Pd(t,n),function(o){const l=L(o);l.Eu.forEach((u,c)=>{Rs(l.remoteStore,c)}),l.Au.jr(),l.Eu=new Map,l.du=new _e(M.comparator)}(t),t.fu=!1,await Al(t.remoteStore,!1)}}async function Pd(s,e,t){const n=L(s),i=[],r=[];for(const o of e){let l;const u=n.Tu.get(o);if(u&&u.length!==0){l=await po(n.localStore,et(u[0]));for(const c of u){const f=n.Pu.get(c),_=await dv(n,f);_.snapshot&&r.push(_.snapshot)}}else{const c=await vp(n.localStore,o);l=await po(n.localStore,c),await Tu(n,zp(c),o,!1,l.resumeToken)}i.push(l)}return n.hu.J_(r),i}function zp(s){return A_(s.path,s.collectionGroup,s.orderBy,s.filters,s.limit,"F",s.startAt,s.endAt)}function mv(s){return function(t){return L(L(t).persistence).Ps()}(L(s).localStore)}async function gv(s,e,t,n){const i=L(s);if(i.fu)return void N(Ms,"Ignoring unexpected query state notification.");const r=i.Tu.get(e);if(r&&r.length>0)switch(t){case"current":case"not-current":{const o=await Tp(i.localStore,S_(r[0])),l=er.createSynthesizedRemoteEventForCurrentChange(e,t==="current",Ie.EMPTY_BYTE_STRING);await on(i,o,l);break}case"rejected":await As(i.localStore,e,!0),Ss(i,e,n);break;default:F(64155,t)}}async function yv(s,e,t){const n=ea(s);if(n.fu){for(const i of e){if(n.Tu.has(i)&&n.sharedClientState.isActiveQueryTarget(i)){N(Ms,"Adding an already active target "+i);continue}const r=await vp(n.localStore,i),o=await po(n.localStore,r);await Tu(n,zp(r),o.targetId,!1,o.resumeToken),Zo(n.remoteStore,o)}for(const i of t)n.Tu.has(i)&&await As(n.localStore,i,!1).then(()=>{Rs(n.remoteStore,i),Ss(n,i)}).catch(nn)}}function ea(s){const e=L(s);return e.remoteStore.remoteSyncer.applyRemoteEvent=jp.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=hv.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=ov.bind(null,e),e.hu.J_=HI.bind(null,e.eventManager),e.hu.pu=YI.bind(null,e.eventManager),e}function Cu(s){const e=L(s);return e.remoteStore.remoteSyncer.applySuccessfulWrite=av.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=lv.bind(null,e),e}class qi{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Xo(e.databaseInfo.databaseId),this.sharedClientState=this.bu(e),this.persistence=this.Du(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Cu(e,this.localStore),this.indexBackfillerScheduler=this.Fu(e,this.localStore)}Cu(e,t){return null}Fu(e,t){return null}vu(e){return yp(this.persistence,new gp,e.initialUser,this.serializer)}Du(e){return new hu(Yo.Vi,this.serializer)}bu(e){return new Sp}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}qi.provider={build:()=>new qi};class Ev extends qi{constructor(e){super(),this.cacheSizeBytes=e}Cu(e,t){U(this.persistence.referenceDelegate instanceof _o,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new hp(n,e.asyncQueue,t)}Du(e){const t=this.cacheSizeBytes!==void 0?Me.withCacheSize(this.cacheSizeBytes):Me.DEFAULT;return new hu(n=>_o.Vi(n,t),this.serializer)}}class Kp extends qi{constructor(e,t,n){super(),this.Mu=e,this.cacheSizeBytes=t,this.forceOwnership=n,this.kind="persistent",this.synchronizeTabs=!1}async initialize(e){await super.initialize(e),await this.Mu.initialize(this,e),await Cu(this.Mu.syncEngine),await ks(this.Mu.remoteStore),await this.persistence.ji(()=>(this.gcScheduler&&!this.gcScheduler.started&&this.gcScheduler.start(),this.indexBackfillerScheduler&&!this.indexBackfillerScheduler.started&&this.indexBackfillerScheduler.start(),Promise.resolve()))}vu(e){return yp(this.persistence,new gp,e.initialUser,this.serializer)}Cu(e,t){const n=this.persistence.referenceDelegate.garbageCollector;return new hp(n,e.asyncQueue,t)}Fu(e,t){const n=new xy(t,this.persistence);return new Vy(e.asyncQueue,n)}Du(e){const t=mp(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey),n=this.cacheSizeBytes!==void 0?Me.withCacheSize(this.cacheSizeBytes):Me.DEFAULT;return new du(this.synchronizeTabs,t,e.clientId,n,e.asyncQueue,Pp(),Qr(),this.serializer,this.sharedClientState,!!this.forceOwnership)}bu(e){return new Sp}}class Iv extends Kp{constructor(e,t){super(e,t,!1),this.Mu=e,this.cacheSizeBytes=t,this.synchronizeTabs=!0}async initialize(e){await super.initialize(e);const t=this.Mu.syncEngine;this.sharedClientState instanceof za&&(this.sharedClientState.syncEngine={Do:_v.bind(null,t),vo:gv.bind(null,t),Co:yv.bind(null,t),Ps:mv.bind(null,t),bo:fv.bind(null,t)},await this.sharedClientState.start()),await this.persistence.ji(async n=>{await pv(this.Mu.syncEngine,n),this.gcScheduler&&(n&&!this.gcScheduler.started?this.gcScheduler.start():n||this.gcScheduler.stop()),this.indexBackfillerScheduler&&(n&&!this.indexBackfillerScheduler.started?this.indexBackfillerScheduler.start():n||this.indexBackfillerScheduler.stop())})}bu(e){const t=Pp();if(!za.C(t))throw new D(b.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.");const n=mp(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey);return new za(t,e.asyncQueue,n,e.clientId,e.initialUser)}}class ji{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>Sd(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=cv.bind(null,this.syncEngine),await Al(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new QI}()}createDatastore(e){const t=Xo(e.databaseInfo.databaseId),n=function(r){return new VI(r)}(e.databaseInfo);return function(r,o,l,u){return new kI(r,o,l,u)}(e.authCredentials,e.appCheckCredentials,n,t)}createRemoteStore(e){return function(n,i,r,o,l){return new MI(n,i,r,o,l)}(this.localStore,this.datastore,e.asyncQueue,t=>Sd(this.syncEngine,t,0),function(){return vd.C()?new vd:new CI}())}createSyncEngine(e,t){return function(i,r,o,l,u,c,f){const _=new ev(i,r,o,l,u,c);return f&&(_.fu=!0),_}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(i){const r=L(i);N(Dn,"RemoteStore shutting down."),r.Ia.add(5),await nr(r),r.Ea.shutdown(),r.Aa.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}ji.provider={build:()=>new ji};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kv{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Vt(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const om=function(s){try{if(typeof window<"u"&&typeof window[s]<"u"){const e=window[s];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new zv(e)}}catch{}return new Kv},vn=om("localStorage"),Wv=om("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const os=new vf("@firebase/database"),$v=function(){let s=1;return function(){return s++}}(),am=function(s){const e=sy(s),t=new iy;t.update(e);const n=t.digest();return ry.encodeByteArray(n)},ir=function(...s){let e="";for(let t=0;t<s.length;t++){const n=s[t];Array.isArray(n)||n&&typeof n=="object"&&typeof n.length=="number"?e+=ir.apply(null,n):typeof n=="object"?e+=Pe(n):e+=n,e+=" "}return e};let Ri=null,jd=!0;const Qv=function(s,e){k(!0,"Can't turn on custom loggers persistently."),os.logLevel=ft.VERBOSE,Ri=os.log.bind(os)},Fe=function(...s){if(jd===!0&&(jd=!1,Ri===null&&Wv.get("logging_enabled")===!0&&Qv()),Ri){const e=ir.apply(null,s);Ri(e)}},rr=function(s){return function(...e){Fe(s,...e)}},bl=function(...s){const e="FIREBASE INTERNAL ERROR: "+ir(...s);os.error(e)},bt=function(...s){const e=`FIREBASE FATAL ERROR: ${ir(...s)}`;throw os.error(e),new Error(e)},tt=function(...s){const e="FIREBASE WARNING: "+ir(...s);os.warn(e)},Hv=function(){typeof window<"u"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&tt("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},lm=function(s){return typeof s=="number"&&(s!==s||s===Number.POSITIVE_INFINITY||s===Number.NEGATIVE_INFINITY)},Yv=function(s){if(document.readyState==="complete")s();else{let e=!1;const t=function(){if(!document.body){setTimeout(t,Math.floor(10));return}e||(e=!0,s())};document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&t()}),window.attachEvent("onload",t))}},Ps="[MIN_NAME]",kn="[MAX_NAME]",Fs=function(s,e){if(s===e)return 0;if(s===Ps||e===kn)return-1;if(e===Ps||s===kn)return 1;{const t=Gd(s),n=Gd(e);return t!==null?n!==null?t-n===0?s.length-e.length:t-n:-1:n!==null?1:s<e?-1:1}},Xv=function(s,e){return s===e?0:s<e?-1:1},ai=function(s,e){if(e&&s in e)return e[s];throw new Error("Missing required key ("+s+") in object: "+Pe(e))},Uu=function(s){if(typeof s!="object"||s===null)return Pe(s);const e=[];for(const n in s)e.push(n);e.sort();let t="{";for(let n=0;n<e.length;n++)n!==0&&(t+=","),t+=Pe(e[n]),t+=":",t+=Uu(s[e[n]]);return t+="}",t},um=function(s,e){const t=s.length;if(t<=e)return[s];const n=[];for(let i=0;i<t;i+=e)i+e>t?n.push(s.substring(i,t)):n.push(s.substring(i,i+e));return n};function Ye(s,e){for(const t in s)s.hasOwnProperty(t)&&e(t,s[t])}const cm=function(s){k(!lm(s),"Invalid JSON number");const e=11,t=52,n=(1<<e-1)-1;let i,r,o,l,u;s===0?(r=0,o=0,i=1/s===-1/0?1:0):(i=s<0,s=Math.abs(s),s>=Math.pow(2,1-n)?(l=Math.min(Math.floor(Math.log(s)/Math.LN2),n),r=l+n,o=Math.round(s*Math.pow(2,t-l)-Math.pow(2,t))):(r=0,o=Math.round(s/Math.pow(2,1-n-t))));const c=[];for(u=t;u;u-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(u=e;u;u-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(i?1:0),c.reverse();const f=c.join("");let _="";for(u=0;u<64;u+=8){let m=parseInt(f.substr(u,8),2).toString(16);m.length===1&&(m="0"+m),_=_+m}return _.toLowerCase()},Jv=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},Zv=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function eT(s,e){let t="Unknown Error";s==="too_big"?t="The data requested exceeds the maximum size that can be accessed with a single request.":s==="permission_denied"?t="Client doesn't have permission to access the desired data.":s==="unavailable"&&(t="The service is unavailable");const n=new Error(s+" at "+e._path.toString()+": "+t);return n.code=s.toUpperCase(),n}const tT=new RegExp("^-?(0*)\\d{1,10}$"),nT=-2147483648,sT=2147483647,Gd=function(s){if(tT.test(s)){const e=Number(s);if(e>=nT&&e<=sT)return e}return null},or=function(s){try{s()}catch(e){setTimeout(()=>{const t=e.stack||"";throw tt("Exception was thrown by user callback.",t),e},Math.floor(0))}},iT=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Ci=function(s,e){const t=setTimeout(s,e);return typeof t=="number"&&typeof Deno<"u"&&Deno.unrefTimer?Deno.unrefTimer(t):typeof t=="object"&&t.unref&&t.unref(),t};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rT{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Af(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(n=>this.appCheck=n)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,n)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,n):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(n=>n.addTokenListener(e))}notifyForInvalidToken(){tt(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lT{constructor(){this.counters_={}}incrementCounter(e,t=1){Vt(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return cy(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $a={},Qa={};function qu(s){const e=s.toString();return $a[e]||($a[e]=new lT),$a[e]}function uT(s,e){const t=s.toString();return Qa[t]||(Qa[t]=e()),Qa[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cT{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const n=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<n.length;++i)n[i]&&or(()=>{this.onMessage_(n[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zd="start",hT="close",dT="pLPCommand",fT="pRTLPCB",Tm="id",wm="pw",Am="ser",_T="cb",pT="seg",mT="ts",gT="d",yT="dframe",Rm=1870,Cm=30,ET=Rm-Cm,IT=25e3,vT=3e4;class ss{constructor(e,t,n,i,r,o,l){this.connId=e,this.repoInfo=t,this.applicationId=n,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=rr(e),this.stats_=qu(t),this.urlFn=u=>(this.appCheckToken&&(u[Vl]=this.appCheckToken),vm(t,Em,u))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new cT(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(vT)),Yv(()=>{if(this.isClosed_)return;this.scriptTagHolder=new ju((...r)=>{const[o,l,u,c,f]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===zd)this.id=l,this.password=u;else if(o===hT)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,l]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,l)},()=>{this.onClosed_()},this.urlFn);const n={};n[zd]="t",n[Am]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(n[_T]=this.scriptTagHolder.uniqueCallbackIdentifier),n[hm]=Bu,this.transportSessionId&&(n[dm]=this.transportSessionId),this.lastSessionId&&(n[mm]=this.lastSessionId),this.applicationId&&(n[gm]=this.applicationId),this.appCheckToken&&(n[Vl]=this.appCheckToken),typeof location<"u"&&location.hostname&&pm.test(location.hostname)&&(n[fm]=_m);const i=this.urlFn(n);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){ss.forceAllow_=!0}static forceDisallow(){ss.forceDisallow_=!0}static isAvailable(){return ss.forceAllow_?!0:!ss.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!Jv()&&!Zv()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=Pe(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const n=hy(t),i=um(n,ET);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const n={};n[yT]="t",n[Tm]=e,n[wm]=t,this.myDisconnFrame.src=this.urlFn(n),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=Pe(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class ju{constructor(e,t,n,i){this.onDisconnect=n,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=$v(),window[dT+this.uniqueCallbackIdentifier]=e,window[fT+this.uniqueCallbackIdentifier]=t,this.myIFrame=ju.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(l){Fe("frame writing exception"),l.stack&&Fe(l.stack),Fe(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||Fe("No IE domain setting required")}catch{const n=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+n+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Tm]=this.myID,e[wm]=this.myPW,e[Am]=this.currentSerial;let t=this.urlFn(e),n="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Cm+n.length<=Rm;){const o=this.pendingSegs.shift();n=n+"&"+pT+i+"="+o.seg+"&"+mT+i+"="+o.ts+"&"+gT+i+"="+o.d,i++}return t=t+n,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,n){this.pendingSegs.push({seg:e,ts:t,d:n}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const n=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(n,Math.floor(IT)),r=()=>{clearTimeout(i),n()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const n=this.myIFrame.doc.createElement("script");n.type="text/javascript",n.async=!0,n.src=e,n.onload=n.onreadystatechange=function(){const i=n.readyState;(!i||i==="loaded"||i==="complete")&&(n.onload=n.onreadystatechange=null,n.parentNode&&n.parentNode.removeChild(n),t())},n.onerror=()=>{Fe("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(n)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qT(s,e){return Fs(s.name,e.name)}function Ku(s,e){return Fs(s,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Mm,Fm;function GT(s){Mm=s}function zT(s){Fm=s}class KT extends la{compare(e,t){const n=e.node.getPriority(),i=t.node.getPriority(),r=n.compareTo(i);return r===0?Fs(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return $.MIN}maxPost(){return new $(kn,new Re("[PRIORITY-POST]",Fm))}makePost(e,t){const n=Mm(e);return new $(t,new Re("[PRIORITY-POST]",n))}toString(){return".priority"}}const ge=new KT;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WT=Math.log(2);class $T{constructor(e){const t=r=>parseInt(Math.log(r)/WT,10),n=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=n(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const To=function(s,e,t,n){s.sort(e);const i=function(u,c){const f=c-u;let _,m;if(f===0)return null;if(f===1)return _=s[u],m=t?t(_):_,new Se(m,_.node,Se.BLACK,null,null);{const I=parseInt(f/2,10)+u,S=i(u,I),V=i(I+1,c);return _=s[I],m=t?t(_):_,new Se(m,_.node,Se.BLACK,S,V)}},r=function(u){let c=null,f=null,_=s.length;const m=function(S,V){const x=_-S,K=_;_-=S;const j=i(x+1,K),B=s[x],J=t?t(B):B;I(new Se(J,B.node,V,null,j))},I=function(S){c?(c.left=S,c=S):(f=S,c=S)};for(let S=0;S<u.count;++S){const V=u.nextBitIsOne(),x=Math.pow(2,u.count-(S+1));V?m(x,Se.BLACK):(m(x,Se.BLACK),m(x,Se.RED))}return f},o=new $T(s.length),l=r(o);return new Qe(n||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HT=!0;function Le(s,e=null){if(s===null)return z.EMPTY_NODE;if(typeof s=="object"&&".priority"in s&&(e=s[".priority"]),k(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof s=="object"&&".value"in s&&s[".value"]!==null&&(s=s[".value"]),typeof s!="object"||".sv"in s){const t=s;return new Re(t,Le(e))}if(!(s instanceof Array)&&HT){const t=[];let n=!1;if(Ye(s,(o,l)=>{if(o.substring(0,1)!=="."){const u=Le(l);u.isEmpty()||(n=n||!u.getPriority().isEmpty(),t.push(new $(o,u)))}}),t.length===0)return z.EMPTY_NODE;const r=To(t,qT,o=>o.name,Ku);if(n){const o=To(t,ge.getCompare());return new z(r,Le(e),new At({".priority":o},{".priority":ge}))}else return new z(r,Le(e),At.Default)}else{let t=z.EMPTY_NODE;return Ye(s,(n,i)=>{if(Vt(s,n)&&n.substring(0,1)!=="."){const r=Le(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(n,r))}}),t.updatePriority(Le(e))}}GT(Le);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XT extends la{compare(e,t){const n=e.node.compareTo(t.node);return n===0?Fs(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return $.MIN}maxPost(){return $.MAX}makePost(e,t){const n=Le(e);return new $(t,n)}toString(){return".value"}}const JT=new XT;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lm(s){return{type:"value",snapshotNode:s}}function bs(s,e){return{type:"child_added",snapshotNode:e,childName:s}}function zi(s,e){return{type:"child_removed",snapshotNode:e,childName:s}}function Ki(s,e,t){return{type:"child_changed",snapshotNode:e,childName:s,oldSnap:t}}function ZT(s,e){return{type:"child_moved",snapshotNode:e,childName:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nw{constructor(){this.rootNode_=z.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ao(){return{value:null,children:new Map}}function Um(s,e,t){if(H(e))s.value=t,s.children.clear();else if(s.value!==null)s.value=s.value.updateChild(e,t);else{const n=Q(e);s.children.has(n)||s.children.set(n,Ao());const i=s.children.get(n);e=ue(e),Um(i,e,t)}}function Nl(s,e,t){s.value!==null?t(e,s.value):sw(s,(n,i)=>{const r=new ae(e.toString()+"/"+n);Nl(i,r,t)})}function sw(s,e){s.children.forEach((t,n)=>{e(n,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iw{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Ye(this.last_,(n,i)=>{t[n]=t[n]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rf=10*1e3,rw=30*1e3,ow=5*60*1e3;class aw{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new iw(e);const n=rf+(rw-rf)*Math.random();Ci(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Ye(e,(i,r)=>{r>0&&Vt(this.statsToReport_,i)&&(t[i]=r,n=!0)}),n&&this.server_.reportStats(t),Ci(this.reportStats_.bind(this),Math.floor(Math.random()*2*ow))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lw{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function uw(s,e,t,n){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&s.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(ZT(o.childName,o.snapshotNode))}),ci(s,i,"child_removed",e,n,t),ci(s,i,"child_added",e,n,t),ci(s,i,"child_moved",r,n,t),ci(s,i,"child_changed",e,n,t),ci(s,i,"value",e,n,t),i}function ci(s,e,t,n,i,r){const o=n.filter(l=>l.type===t);o.sort((l,u)=>hw(s,l,u)),o.forEach(l=>{const u=cw(s,l,r);i.forEach(c=>{c.respondsTo(l.type)&&e.push(c.createEvent(u,s.query_))})})}function cw(s,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,s.index_)),e}function hw(s,e,t){if(e.childName==null||t.childName==null)throw Hi("Should only compare child_ events.");const n=new $(e.childName,e.snapshotNode),i=new $(t.childName,t.snapshotNode);return s.index_.compare(n,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yu(s,e){return Wm(e,s)}function fw(s,e,t,n,i){k(n>s.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),s.allWrites.push({path:e,snap:t,writeId:n,visible:i}),i&&(s.visibleWrites=Pi(s.visibleWrites,e,t)),s.lastWriteId=n}function _w(s,e){for(let t=0;t<s.allWrites.length;t++){const n=s.allWrites[t];if(n.writeId===e)return n}return null}function pw(s,e){const t=s.allWrites.findIndex(l=>l.writeId===e);k(t>=0,"removeWrite called with nonexistent writeId.");const n=s.allWrites[t];s.allWrites.splice(t,1);let i=n.visible,r=!1,o=s.allWrites.length-1;for(;i&&o>=0;){const l=s.allWrites[o];l.visible&&(o>=t&&mw(l,n.path)?i=!1:at(n.path,l.path)&&(r=!0)),o--}if(i){if(r)return gw(s),!0;if(n.snap)s.visibleWrites=af(s.visibleWrites,n.path);else{const l=n.children;Ye(l,u=>{s.visibleWrites=af(s.visibleWrites,we(n.path,u))})}return!0}else return!1}function mw(s,e){if(s.snap)return at(s.path,e);for(const t in s.children)if(s.children.hasOwnProperty(t)&&at(we(s.path,t),e))return!0;return!1}function gw(s){s.visibleWrites=Gm(s.allWrites,yw,ne()),s.allWrites.length>0?s.lastWriteId=s.allWrites[s.allWrites.length-1].writeId:s.lastWriteId=-1}function yw(s){return s.visible}function Gm(s,e,t){let n=ct.empty();for(let i=0;i<s.length;++i){const r=s[i];if(e(r)){const o=r.path;let l;if(r.snap)at(t,o)?(l=$e(t,o),n=Pi(n,l,r.snap)):at(o,t)&&(l=$e(o,t),n=Pi(n,ne(),r.snap.getChild(l)));else if(r.children){if(at(t,o))l=$e(t,o),n=of(n,l,r.children);else if(at(o,t))if(l=$e(o,t),H(l))n=of(n,ne(),r.children);else{const u=us(r.children,Q(l));if(u){const c=u.getChild(ue(l));n=Pi(n,ne(),c)}}}else throw Hi("WriteRecord should have .snap or .children")}}return n}function zm(s,e,t,n,i){if(!n&&!i){const r=Un(s.visibleWrites,e);if(r!=null)return r;{const o=$t(s.visibleWrites,e);if(Ol(o))return t;if(t==null&&!kl(o,ne()))return null;{const l=t||z.EMPTY_NODE;return Vs(o,l)}}}else{const r=$t(s.visibleWrites,e);if(!i&&Ol(r))return t;if(!i&&t==null&&!kl(r,ne()))return null;{const o=function(c){return(c.visible||i)&&(!n||!~n.indexOf(c.writeId))&&(at(c.path,e)||at(e,c.path))},l=Gm(s.allWrites,o,e),u=t||z.EMPTY_NODE;return Vs(l,u)}}}function Ew(s,e,t){let n=z.EMPTY_NODE;const i=Un(s.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(ge,(r,o)=>{n=n.updateImmediateChild(r,o)}),n;if(t){const r=$t(s.visibleWrites,e);return t.forEachChild(ge,(o,l)=>{const u=Vs($t(r,new ae(o)),l);n=n.updateImmediateChild(o,u)}),lf(r).forEach(o=>{n=n.updateImmediateChild(o.name,o.node)}),n}else{const r=$t(s.visibleWrites,e);return lf(r).forEach(o=>{n=n.updateImmediateChild(o.name,o.node)}),n}}function Iw(s,e,t,n,i){k(n||i,"Either existingEventSnap or existingServerSnap must exist");const r=we(e,t);if(kl(s.visibleWrites,r))return null;{const o=$t(s.visibleWrites,r);return Ol(o)?i.getChild(t):Vs(o,i.getChild(t))}}function vw(s,e,t,n){const i=we(e,t),r=Un(s.visibleWrites,i);if(r!=null)return r;if(n.isCompleteForChild(t)){const o=$t(s.visibleWrites,i);return Vs(o,n.getNode().getImmediateChild(t))}else return null}function Tw(s,e){return Un(s.visibleWrites,e)}function ww(s,e,t,n,i,r,o){let l;const u=$t(s.visibleWrites,e),c=Un(u,ne());if(c!=null)l=c;else if(t!=null)l=Vs(u,t);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const f=[],_=o.getCompare(),m=r?l.getReverseIteratorFrom(n,o):l.getIteratorFrom(n,o);let I=m.getNext();for(;I&&f.length<i;)_(I,n)!==0&&f.push(I),I=m.getNext();return f}else return[]}function Aw(){return{visibleWrites:ct.empty(),allWrites:[],lastWriteId:-1}}function Co(s,e,t,n){return zm(s.writeTree,s.treePath,e,t,n)}function Xu(s,e){return Ew(s.writeTree,s.treePath,e)}function uf(s,e,t,n){return Iw(s.writeTree,s.treePath,e,t,n)}function So(s,e){return Tw(s.writeTree,we(s.treePath,e))}function Rw(s,e,t,n,i,r){return ww(s.writeTree,s.treePath,e,t,n,i,r)}function Ju(s,e,t){return vw(s.writeTree,s.treePath,e,t)}function Km(s,e){return Wm(we(s.treePath,e),s.writeTree)}function Wm(s,e){return{treePath:s,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cw{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,n=e.childName;k(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),k(n!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const r=i.type;if(t==="child_added"&&r==="child_removed")this.changeMap.set(n,Ki(n,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&r==="child_added")this.changeMap.delete(n);else if(t==="child_removed"&&r==="child_changed")this.changeMap.set(n,zi(n,i.oldSnap));else if(t==="child_changed"&&r==="child_added")this.changeMap.set(n,bs(n,e.snapshotNode));else if(t==="child_changed"&&r==="child_changed")this.changeMap.set(n,Ki(n,e.snapshotNode,i.oldSnap));else throw Hi("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sw{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}}const $m=new Sw;class Zu{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const n=this.optCompleteServerCache_!=null?new Mn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ju(this.writes_,e,n)}}getChildAfterChild(e,t,n){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Fn(this.viewCache_),r=Rw(this.writes_,i,t,1,n,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mw{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const n=this.query_._queryParams,i=new Wu(n.getIndex()),r=tw(n);this.processor_=Pw(r);const o=t.serverCache,l=t.eventCache,u=i.updateFullNode(z.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(z.EMPTY_NODE,l.getNode(),null),f=new Mn(u,o.isFullyInitialized(),i.filtersNodes()),_=new Mn(c,l.isFullyInitialized(),r.filtersNodes());this.viewCache_=ua(_,f),this.eventGenerator_=new lw(this.query_)}get query(){return this.query_}}function Fw(s){return s.viewCache_.serverCache.getNode()}function Lw(s,e){const t=Fn(s.viewCache_);return t&&(s.query._queryParams.loadsAllData()||!H(e)&&!t.getImmediateChild(Q(e)).isEmpty())?t.getChild(e):null}function df(s){return s.eventRegistrations_.length===0}function Uw(s,e){s.eventRegistrations_.push(e)}function ff(s,e,t){const n=[];if(t){k(e==null,"A cancel should cancel all event registrations.");const i=s.query._path;s.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,i);o&&n.push(o)})}if(e){let i=[];for(let r=0;r<s.eventRegistrations_.length;++r){const o=s.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(s.eventRegistrations_.slice(r+1));break}}s.eventRegistrations_=i}else s.eventRegistrations_=[];return n}function _f(s,e,t,n){e.type===lt.MERGE&&e.source.queryId!==null&&(k(Fn(s.viewCache_),"We should always have a full cache before handling merges"),k(Dl(s.viewCache_),"Missing event cache, even though we have a server cache"));const i=s.viewCache_,r=Vw(s.processor_,i,e,t,n);return bw(s.processor_,r.viewCache),k(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),s.viewCache_=r.viewCache,Hm(s,r.changes,r.viewCache.eventCache.getNode(),null)}function Bw(s,e){const t=s.viewCache_.eventCache,n=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(ge,(r,o)=>{n.push(bs(r,o))}),t.isFullyInitialized()&&n.push(Lm(t.getNode())),Hm(s,n,t.getNode(),e)}function Hm(s,e,t,n){const i=n?[n]:s.eventRegistrations_;return uw(s.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bo;class qw{constructor(){this.views=new Map}}function jw(s){k(!bo,"__referenceConstructor has already been defined"),bo=s}function Gw(){return k(bo,"Reference.ts has not been loaded"),bo}function zw(s){return s.views.size===0}function ec(s,e,t,n){const i=e.source.queryId;if(i!==null){const r=s.views.get(i);return k(r!=null,"SyncTree gave us an op for an invalid query."),_f(r,e,t,n)}else{let r=[];for(const o of s.views.values())r=r.concat(_f(o,e,t,n));return r}}function Kw(s,e,t,n,i){const r=e._queryIdentifier,o=s.views.get(r);if(!o){let l=Co(t,i?n:null),u=!1;l?u=!0:n instanceof z?(l=Xu(t,n),u=!1):(l=z.EMPTY_NODE,u=!1);const c=ua(new Mn(l,u,!1),new Mn(n,i,!1));return new Mw(e,c)}return o}function Ww(s,e,t,n,i,r){const o=Kw(s,e,n,i,r);return s.views.has(e._queryIdentifier)||s.views.set(e._queryIdentifier,o),Uw(o,t),Bw(o,t)}function $w(s,e,t,n){const i=e._queryIdentifier,r=[];let o=[];const l=tn(s);if(i==="default")for(const[u,c]of s.views.entries())o=o.concat(ff(c,t,n)),df(c)&&(s.views.delete(u),c.query._queryParams.loadsAllData()||r.push(c.query));else{const u=s.views.get(i);u&&(o=o.concat(ff(u,t,n)),df(u)&&(s.views.delete(i),u.query._queryParams.loadsAllData()||r.push(u.query)))}return l&&!tn(s)&&r.push(new(Gw())(e._repo,e._path)),{removed:r,events:o}}function Ym(s){const e=[];for(const t of s.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function ls(s,e){let t=null;for(const n of s.views.values())t=t||Lw(n,e);return t}function Xm(s,e){if(e._queryParams.loadsAllData())return ca(s);{const n=e._queryIdentifier;return s.views.get(n)}}function Jm(s,e){return Xm(s,e)!=null}function tn(s){return ca(s)!=null}function ca(s){for(const e of s.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vo;function Qw(s){k(!Vo,"__referenceConstructor has already been defined"),Vo=s}function Hw(){return k(Vo,"Reference.ts has not been loaded"),Vo}let Yw=1;class pf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new he(null),this.pendingWriteTree_=Aw(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Xw(s,e,t,n,i){return fw(s.pendingWriteTree_,e,t,n,i),i?lr(s,new On(Bm(),e,t)):[]}function is(s,e,t=!1){const n=_w(s.pendingWriteTree_,e);if(pw(s.pendingWriteTree_,e)){let r=new he(null);return n.snap!=null?r=r.set(ne(),!0):Ye(n.children,o=>{r=r.set(new ae(o),!0)}),lr(s,new Ro(n.path,r,t))}else return[]}function ha(s,e,t){return lr(s,new On(Qu(),e,t))}function Jw(s,e,t){const n=he.fromObject(t);return lr(s,new Qi(Qu(),e,n))}function Zw(s,e){return lr(s,new $i(Qu(),e))}function eA(s,e,t){const n=tc(s,t);if(n){const i=nc(n),r=i.path,o=i.queryId,l=$e(r,e),u=new $i(Hu(o),l);return sc(s,r,u)}else return[]}function Ll(s,e,t,n,i=!1){const r=e._path,o=s.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||Jm(o,e))){const u=$w(o,e,t,n);zw(o)&&(s.syncPointTree_=s.syncPointTree_.remove(r));const c=u.removed;if(l=u.events,!i){const f=c.findIndex(m=>m._queryParams.loadsAllData())!==-1,_=s.syncPointTree_.findOnPath(r,(m,I)=>tn(I));if(f&&!_){const m=s.syncPointTree_.subtree(r);if(!m.isEmpty()){const I=sA(m);for(let S=0;S<I.length;++S){const V=I[S],x=V.query,K=ng(s,V);s.listenProvider_.startListening(bi(x),xo(s,x),K.hashFn,K.onComplete)}}}!_&&c.length>0&&!n&&(f?s.listenProvider_.stopListening(bi(e),null):c.forEach(m=>{const I=s.queryToTagMap.get(da(m));s.listenProvider_.stopListening(bi(m),I)}))}iA(s,c)}return l}function tA(s,e,t,n){const i=tc(s,n);if(i!=null){const r=nc(i),o=r.path,l=r.queryId,u=$e(o,e),c=new On(Hu(l),u,t);return sc(s,o,c)}else return[]}function nA(s,e,t,n){const i=tc(s,n);if(i){const r=nc(i),o=r.path,l=r.queryId,u=$e(o,e),c=he.fromObject(t),f=new Qi(Hu(l),u,c);return sc(s,o,f)}else return[]}function mf(s,e,t,n=!1){const i=e._path;let r=null,o=!1;s.syncPointTree_.foreachOnPath(i,(m,I)=>{const S=$e(m,i);r=r||ls(I,S),o=o||tn(I)});let l=s.syncPointTree_.get(i);l?(o=o||tn(l),r=r||ls(l,ne())):(l=new qw,s.syncPointTree_=s.syncPointTree_.set(i,l));let u;r!=null?u=!0:(u=!1,r=z.EMPTY_NODE,s.syncPointTree_.subtree(i).foreachChild((I,S)=>{const V=ls(S,ne());V&&(r=r.updateImmediateChild(I,V))}));const c=Jm(l,e);if(!c&&!e._queryParams.loadsAllData()){const m=da(e);k(!s.queryToTagMap.has(m),"View does not exist, but we have a tag");const I=rA();s.queryToTagMap.set(m,I),s.tagToQueryMap.set(I,m)}const f=Yu(s.pendingWriteTree_,i);let _=Ww(l,e,t,f,r,u);if(!c&&!o&&!n){const m=Xm(l,e);_=_.concat(oA(s,e,m))}return _}function Zm(s,e,t){const i=s.pendingWriteTree_,r=s.syncPointTree_.findOnPath(e,(o,l)=>{const u=$e(o,e),c=ls(l,u);if(c)return c});return zm(i,e,r,t,!0)}function lr(s,e){return eg(e,s.syncPointTree_,null,Yu(s.pendingWriteTree_,ne()))}function eg(s,e,t,n){if(H(s.path))return tg(s,e,t,n);{const i=e.get(ne());t==null&&i!=null&&(t=ls(i,ne()));let r=[];const o=Q(s.path),l=s.operationForChild(o),u=e.children.get(o);if(u&&l){const c=t?t.getImmediateChild(o):null,f=Km(n,o);r=r.concat(eg(l,u,c,f))}return i&&(r=r.concat(ec(i,s,n,t))),r}}function tg(s,e,t,n){const i=e.get(ne());t==null&&i!=null&&(t=ls(i,ne()));let r=[];return e.children.inorderTraversal((o,l)=>{const u=t?t.getImmediateChild(o):null,c=Km(n,o),f=s.operationForChild(o);f&&(r=r.concat(tg(f,l,u,c)))}),i&&(r=r.concat(ec(i,s,n,t))),r}function ng(s,e){const t=e.query,n=xo(s,t);return{hashFn:()=>(Fw(e)||z.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return n?eA(s,t._path,n):Zw(s,t._path);{const r=eT(i,t);return Ll(s,t,null,r)}}}}function xo(s,e){const t=da(e);return s.queryToTagMap.get(t)}function da(s){return s._path.toString()+"$"+s._queryIdentifier}function tc(s,e){return s.tagToQueryMap.get(e)}function nc(s){const e=s.indexOf("$");return k(e!==-1&&e<s.length-1,"Bad queryKey."),{queryId:s.substr(e+1),path:new ae(s.substr(0,e))}}function sc(s,e,t){const n=s.syncPointTree_.get(e);k(n,"Missing sync point for query tag that we're tracking");const i=Yu(s.pendingWriteTree_,e);return ec(n,t,i,null)}function sA(s){return s.fold((e,t,n)=>{if(t&&tn(t))return[ca(t)];{let i=[];return t&&(i=Ym(t)),Ye(n,(r,o)=>{i=i.concat(o)}),i}})}function bi(s){return s._queryParams.loadsAllData()&&!s._queryParams.isDefault()?new(Hw())(s._repo,s._path):s}function iA(s,e){for(let t=0;t<e.length;++t){const n=e[t];if(!n._queryParams.loadsAllData()){const i=da(n),r=s.queryToTagMap.get(i);s.queryToTagMap.delete(i),s.tagToQueryMap.delete(r)}}}function rA(){return Yw++}function oA(s,e,t){const n=e._path,i=xo(s,e),r=ng(s,t),o=s.listenProvider_.startListening(bi(e),i,r.hashFn,r.onComplete),l=s.syncPointTree_.subtree(n);if(i)k(!tn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const u=l.fold((c,f,_)=>{if(!H(c)&&f&&tn(f))return[ca(f).query];{let m=[];return f&&(m=m.concat(Ym(f).map(I=>I.query))),Ye(_,(I,S)=>{m=m.concat(S)}),m}});for(let c=0;c<u.length;++c){const f=u[c];s.listenProvider_.stopListening(bi(f),xo(s,f))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ac{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function lc(s,e){let t=e instanceof ae?e:new ae(e),n=s,i=Q(t);for(;i!==null;){const r=us(n.node.children,i)||{children:{},childCount:0};n=new ac(i,n,r),t=ue(t),i=Q(t)}return n}function Ls(s){return s.node.value}function sg(s,e){s.node.value=e,Ul(s)}function ig(s){return s.node.childCount>0}function dA(s){return Ls(s)===void 0&&!ig(s)}function fa(s,e){Ye(s.node.children,(t,n)=>{e(new ac(t,s,n))})}function rg(s,e,t,n){t&&e(s),fa(s,i=>{rg(i,e,!0)})}function fA(s,e,t){let n=s.parent;for(;n!==null;){if(e(n))return!0;n=n.parent}return!1}function ur(s){return new ae(s.parent===null?s.name:ur(s.parent)+"/"+s.name)}function Ul(s){s.parent!==null&&_A(s.parent,s.name,s)}function _A(s,e,t){const n=dA(t),i=Vt(s.node.children,e);n&&i?(delete s.node.children[e],s.node.childCount--,Ul(s)):!n&&!i&&(s.node.children[e]=t.node,s.node.childCount++,Ul(s))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pA=/[\[\].#$\/\u0000-\u001F\u007F]/,mA=/[\[\].#$\u0000-\u001F\u007F]/,Ja=10*1024*1024,og=function(s){return typeof s=="string"&&s.length!==0&&!pA.test(s)},ag=function(s){return typeof s=="string"&&s.length!==0&&!mA.test(s)},gA=function(s){return s&&(s=s.replace(/^\/*\.info(\/|$)/,"/")),ag(s)},lg=function(s,e,t){const n=t instanceof ae?new DT(t,s):t;if(e===void 0)throw new Error(s+"contains undefined "+pn(n));if(typeof e=="function")throw new Error(s+"contains a function "+pn(n)+" with contents = "+e.toString());if(lm(e))throw new Error(s+"contains "+e.toString()+" "+pn(n));if(typeof e=="string"&&e.length>Ja/3&&ko(e)>Ja)throw new Error(s+"contains a string greater than "+Ja+" utf8 bytes "+pn(n)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(Ye(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!og(o)))throw new Error(s+" contains an invalid key ("+o+") "+pn(n)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);kT(n,o),lg(s,l,n),OT(n)}),i&&r)throw new Error(s+' contains ".value" child '+pn(n)+" in addition to actual children.")}},ug=function(s,e,t,n){if(!ag(t))throw new Error(xf(s,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},yA=function(s,e,t,n){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),ug(s,e,t)},EA=function(s,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!og(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!gA(t))throw new Error(xf(s,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IA{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function cg(s,e){let t=null;for(let n=0;n<e.length;n++){const i=e[n],r=i.getPath();t!==null&&!Gu(r,t.path)&&(s.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&s.eventLists_.push(t)}function hg(s,e,t){cg(s,t),dg(s,n=>Gu(n,e))}function Bn(s,e,t){cg(s,t),dg(s,n=>at(n,e)||at(e,n))}function dg(s,e){s.recursionDepth_++;let t=!0;for(let n=0;n<s.eventLists_.length;n++){const i=s.eventLists_[n];if(i){const r=i.path;e(r)?(vA(s.eventLists_[n]),s.eventLists_[n]=null):t=!1}}t&&(s.eventLists_=[]),s.recursionDepth_--}function vA(s){for(let e=0;e<s.events.length;e++){const t=s.events[e];if(t!==null){s.events[e]=null;const n=t.getEventRunner();Ri&&Fe("event: "+t.toString()),or(n)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TA="repo_interrupt",wA=25;class AA{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new IA,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ao(),this.transactionQueueTree_=new ac,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function RA(s,e,t){if(s.stats_=qu(s.repoInfo_),s.forceRestClient_||iT())s.server_=new wo(s.repoInfo_,(n,i,r,o)=>{yf(s,n,i,r,o)},s.authTokenProvider_,s.appCheckProvider_),setTimeout(()=>Ef(s,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Pe(t)}catch(n){throw new Error("Invalid authOverride provided: "+n)}}s.persistentConnection_=new Ct(s.repoInfo_,e,(n,i,r,o)=>{yf(s,n,i,r,o)},n=>{Ef(s,n)},n=>{SA(s,n)},s.authTokenProvider_,s.appCheckProvider_,t),s.server_=s.persistentConnection_}s.authTokenProvider_.addTokenChangeListener(n=>{s.server_.refreshAuthToken(n)}),s.appCheckProvider_.addTokenChangeListener(n=>{s.server_.refreshAppCheckToken(n.token)}),s.statsReporter_=uT(s.repoInfo_,()=>new aw(s.stats_,s.server_)),s.infoData_=new nw,s.infoSyncTree_=new pf({startListening:(n,i,r,o)=>{let l=[];const u=s.infoData_.getNode(n._path);return u.isEmpty()||(l=ha(s.infoSyncTree_,n._path,u),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),uc(s,"connected",!1),s.serverSyncTree_=new pf({startListening:(n,i,r,o)=>(s.server_.listen(n,r,i,(l,u)=>{const c=o(l,u);Bn(s.eventQueue_,n._path,c)}),[]),stopListening:(n,i)=>{s.server_.unlisten(n,i)}})}function CA(s){const t=s.infoData_.getNode(new ae(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function fg(s){return aA({timestamp:CA(s)})}function yf(s,e,t,n,i){s.dataUpdateCount++;const r=new ae(e);t=s.interceptServerDataCallback_?s.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(n){const u=Zr(t,c=>Le(c));o=nA(s.serverSyncTree_,r,u,i)}else{const u=Le(t);o=tA(s.serverSyncTree_,r,u,i)}else if(n){const u=Zr(t,c=>Le(c));o=Jw(s.serverSyncTree_,r,u)}else{const u=Le(t);o=ha(s.serverSyncTree_,r,u)}let l=r;o.length>0&&(l=hc(s,r)),Bn(s.eventQueue_,l,o)}function Ef(s,e){uc(s,"connected",e),e===!1&&bA(s)}function SA(s,e){Ye(e,(t,n)=>{uc(s,t,n)})}function uc(s,e,t){const n=new ae("/.info/"+e),i=Le(t);s.infoData_.updateSnapshot(n,i);const r=ha(s.infoSyncTree_,n,i);Bn(s.eventQueue_,n,r)}function PA(s){return s.nextWriteId_++}function bA(s){_g(s,"onDisconnectEvents");const e=fg(s),t=Ao();Nl(s.onDisconnect_,ne(),(i,r)=>{const o=cA(i,r,s.serverSyncTree_,e);Um(t,i,o)});let n=[];Nl(t,ne(),(i,r)=>{n=n.concat(ha(s.serverSyncTree_,i,r));const o=OA(s,i);hc(s,o)}),s.onDisconnect_=Ao(),Bn(s.eventQueue_,ne(),n)}function VA(s,e,t){let n;Q(e._path)===".info"?n=mf(s.infoSyncTree_,e,t):n=mf(s.serverSyncTree_,e,t),hg(s.eventQueue_,e._path,n)}function xA(s,e,t){let n;Q(e._path)===".info"?n=Ll(s.infoSyncTree_,e,t):n=Ll(s.serverSyncTree_,e,t),hg(s.eventQueue_,e._path,n)}function NA(s){s.persistentConnection_&&s.persistentConnection_.interrupt(TA)}function _g(s,...e){let t="";s.persistentConnection_&&(t=s.persistentConnection_.id+":"),Fe(t,...e)}function pg(s,e,t){return Zm(s.serverSyncTree_,e,t)||z.EMPTY_NODE}function cc(s,e=s.transactionQueueTree_){if(e||_a(s,e),Ls(e)){const t=gg(s,e);k(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&DA(s,ur(e),t)}else ig(e)&&fa(e,t=>{cc(s,t)})}function DA(s,e,t){const n=t.map(c=>c.currentWriteId),i=pg(s,e,n);let r=i;const o=i.hash();for(let c=0;c<t.length;c++){const f=t[c];k(f.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),f.status=1,f.retryCount++;const _=$e(e,f.path);r=r.updateChild(_,f.currentOutputSnapshotRaw)}const l=r.val(!0),u=e;s.server_.put(u.toString(),l,c=>{_g(s,"transaction put response",{path:u.toString(),status:c});let f=[];if(c==="ok"){const _=[];for(let m=0;m<t.length;m++)t[m].status=2,f=f.concat(is(s.serverSyncTree_,t[m].currentWriteId)),t[m].onComplete&&_.push(()=>t[m].onComplete(null,!0,t[m].currentOutputSnapshotResolved)),t[m].unwatcher();_a(s,lc(s.transactionQueueTree_,e)),cc(s,s.transactionQueueTree_),Bn(s.eventQueue_,e,f);for(let m=0;m<_.length;m++)or(_[m])}else{if(c==="datastale")for(let _=0;_<t.length;_++)t[_].status===3?t[_].status=4:t[_].status=0;else{tt("transaction at "+u.toString()+" failed: "+c);for(let _=0;_<t.length;_++)t[_].status=4,t[_].abortReason=c}hc(s,e)}},o)}function hc(s,e){const t=mg(s,e),n=ur(t),i=gg(s,t);return kA(s,i,n),n}function kA(s,e,t){if(e.length===0)return;const n=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const u=e[l],c=$e(t,u.path);let f=!1,_;if(k(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),u.status===4)f=!0,_=u.abortReason,i=i.concat(is(s.serverSyncTree_,u.currentWriteId,!0));else if(u.status===0)if(u.retryCount>=wA)f=!0,_="maxretry",i=i.concat(is(s.serverSyncTree_,u.currentWriteId,!0));else{const m=pg(s,u.path,o);u.currentInputSnapshot=m;const I=e[l].update(m.val());if(I!==void 0){lg("transaction failed: Data returned ",I,u.path);let S=Le(I);typeof I=="object"&&I!=null&&Vt(I,".priority")||(S=S.updatePriority(m.getPriority()));const x=u.currentWriteId,K=fg(s),j=hA(S,m,K);u.currentOutputSnapshotRaw=S,u.currentOutputSnapshotResolved=j,u.currentWriteId=PA(s),o.splice(o.indexOf(x),1),i=i.concat(Xw(s.serverSyncTree_,u.path,j,u.currentWriteId,u.applyLocally)),i=i.concat(is(s.serverSyncTree_,x,!0))}else f=!0,_="nodata",i=i.concat(is(s.serverSyncTree_,u.currentWriteId,!0))}Bn(s.eventQueue_,t,i),i=[],f&&(e[l].status=2,function(m){setTimeout(m,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(_==="nodata"?n.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):n.push(()=>e[l].onComplete(new Error(_),!1,null))))}_a(s,s.transactionQueueTree_);for(let l=0;l<n.length;l++)or(n[l]);cc(s,s.transactionQueueTree_)}function mg(s,e){let t,n=s.transactionQueueTree_;for(t=Q(e);t!==null&&Ls(n)===void 0;)n=lc(n,t),e=ue(e),t=Q(e);return n}function gg(s,e){const t=[];return yg(s,e,t),t.sort((n,i)=>n.order-i.order),t}function yg(s,e,t){const n=Ls(e);if(n)for(let i=0;i<n.length;i++)t.push(n[i]);fa(e,i=>{yg(s,i,t)})}function _a(s,e){const t=Ls(e);if(t){let n=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[n]=t[i],n++);t.length=n,sg(e,t.length>0?t:void 0)}fa(e,n=>{_a(s,n)})}function OA(s,e){const t=ur(mg(s,e)),n=lc(s.transactionQueueTree_,e);return fA(n,i=>{Za(s,i)}),Za(s,n),rg(n,i=>{Za(s,i)}),t}function Za(s,e){const t=Ls(e);if(t){const n=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(k(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(k(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(is(s.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&n.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?sg(e,void 0):t.length=r+1,Bn(s.eventQueue_,ur(e),i);for(let o=0;o<n.length;o++)or(n[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MA(s){let e="";const t=s.split("/");for(let n=0;n<t.length;n++)if(t[n].length>0){let i=t[n];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function FA(s){const e={};s.charAt(0)==="?"&&(s=s.substring(1));for(const t of s.split("&")){if(t.length===0)continue;const n=t.split("=");n.length===2?e[decodeURIComponent(n[0])]=decodeURIComponent(n[1]):tt(`Invalid query segment '${t}' in query '${s}'`)}return e}const If=function(s,e){const t=LA(s),n=t.namespace;t.domain==="firebase.com"&&bt(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!n||n==="undefined")&&t.domain!=="localhost"&&bt("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Hv();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Im(t.host,t.secure,n,i,e,"",n!==t.subdomain),path:new ae(t.pathString)}},LA=function(s){let e="",t="",n="",i="",r="",o=!0,l="https",u=443;if(typeof s=="string"){let c=s.indexOf("//");c>=0&&(l=s.substring(0,c-1),s=s.substring(c+2));let f=s.indexOf("/");f===-1&&(f=s.length);let _=s.indexOf("?");_===-1&&(_=s.length),e=s.substring(0,Math.min(f,_)),f<_&&(i=MA(s.substring(f,_)));const m=FA(s.substring(Math.min(s.length,_)));c=e.indexOf(":"),c>=0?(o=l==="https"||l==="wss",u=parseInt(e.substring(c+1),10)):c=e.length;const I=e.slice(0,c);if(I.toLowerCase()==="localhost")t="localhost";else if(I.split(".").length<=2)t=I;else{const S=e.indexOf(".");n=e.substring(0,S).toLowerCase(),t=e.substring(S+1),r=n}"ns"in m&&(r=m.ns)}return{host:e,port:u,domain:t,subdomain:n,secure:o,scheme:l,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class UA{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+Pe(this.snapshot.exportVal())}}class BA{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dc{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return H(this._path)?null:bm(this._path)}get ref(){return new an(this._repo,this._path)}get _queryIdentifier(){const e=sf(this._queryParams),t=Uu(e);return t==="{}"?"default":t}get _queryObject(){return sf(this._queryParams)}isEqual(e){if(e=He(e),!(e instanceof dc))return!1;const t=this._repo===e._repo,n=Gu(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+NT(this._path)}}class an extends dc{constructor(e,t){super(e,t,new $u,!1)}get parent(){const e=xm(this._path);return e===null?null:new an(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class No{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ae(e),n=Bl(this.ref,e);return new No(this._node.getChild(t),n,ge)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(n,i)=>e(new No(i,Bl(this.ref,n),ge)))}hasChild(e){const t=new ae(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function mR(s,e){return s=He(s),s._checkNotDeleted("ref"),e!==void 0?Bl(s._root,e):s._root}function Bl(s,e){return s=He(s),Q(s._path)===null?yA("child","path",e):ug("child","path",e),new an(s._repo,we(s._path,e))}class fc{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const n=t._queryParams.getIndex();return new UA("value",this,new No(e.snapshotNode,new an(t._repo,t._path),n))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new BA(this,e,t):null}matches(e){return e instanceof fc?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function jA(s,e,t,n,i){const r=new qA(t,void 0),o=new fc(r);return VA(s._repo,s,o),()=>xA(s._repo,s,o)}function gR(s,e,t,n){return jA(s,"value",e)}jw(an);Qw(an);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const GA="FIREBASE_DATABASE_EMULATOR_HOST",ql={};let zA=!1;function KA(s,e,t,n){const i=e.lastIndexOf(":"),r=e.substring(0,i),o=Do(r);s.repoInfo_=new Im(e,o,s.repoInfo_.namespace,s.repoInfo_.webSocketOnly,s.repoInfo_.nodeAdmin,s.repoInfo_.persistenceKey,s.repoInfo_.includeNamespaceInQueryParams,!0,t),n&&(s.authTokenProvider_=n)}function WA(s,e,t,n,i){let r=n||s.options.databaseURL;r===void 0&&(s.options.projectId||bt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Fe("Using default host for project ",s.options.projectId),r=`${s.options.projectId}-default-rtdb.firebaseio.com`);let o=If(r,i),l=o.repoInfo,u;typeof process<"u"&&Ud&&(u=Ud[GA]),u?(r=`http://${u}?ns=${l.namespace}`,o=If(r,i),l=o.repoInfo):o.repoInfo.secure;const c=new oT(s.name,s.options,e);EA("Invalid Firebase Database URL",o),H(o.path)||bt("Database URL must point to the root of a Firebase Database (not including a child path).");const f=QA(l,s,c,new rT(s,t));return new HA(f,s)}function $A(s,e){const t=ql[e];(!t||t[s.key]!==s)&&bt(`Database ${e}(${s.repoInfo_}) has already been deleted.`),NA(s),delete t[s.key]}function QA(s,e,t,n){let i=ql[e.name];i||(i={},ql[e.name]=i);let r=i[s.toURLString()];return r&&bt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new AA(s,zA,t,n),i[s.toURLString()]=r,r}class HA{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(RA(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new an(this._repo,ne())),this._rootInternal}_delete(){return this._rootInternal!==null&&($A(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&bt("Cannot call "+e+" on a deleted database.")}}function yR(s=_y(),e){const t=Rf(s,"database").getImmediate({identifier:e});if(!t._instanceStarted){const n=fy("database");n&&YA(t,...n)}return t}function YA(s,e,t,n={}){s=He(s),s._checkNotDeleted("useEmulator");const i=`${e}:${t}`,r=s._repoInternal;if(s._instanceStarted){if(i===s._repoInternal.repoInfo_.host&&Cf(n,r.repoInfo_.emulatorOptions))return;bt("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)n.mockUserToken&&bt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Yr(Yr.OWNER);else if(n.mockUserToken){const l=typeof n.mockUserToken=="string"?n.mockUserToken:py(n.mockUserToken,s.app.options.projectId);o=new Yr(l)}Do(e)&&(Sf(e),my("Database",!0)),KA(r,i,n,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function XA(s){Gv(Vf),Tf(new wf("database",(e,{instanceIdentifier:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return WA(n,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Xr(Bd,qd,s),Xr(Bd,qd,"esm2017")}Ct.prototype.simpleListen=function(s,e){this.sendRequest("q",{p:s},e)};Ct.prototype.echo=function(s,e){this.sendRequest("echo",{d:s},e)};XA();export{_R as a,hR as b,tR as c,Cv as d,cR as e,rR as f,yR as g,aR as h,nR as i,dR as j,pR as k,oR as l,gR as o,fR as p,sR as q,mR as r,lR as s,uR as u,iR as w};
