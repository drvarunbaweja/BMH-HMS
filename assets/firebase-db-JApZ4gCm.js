...
`}),h}function Na(a,h,d){e:{for(p in d){var p=!1;break e}p=!0}p||(d=Qc(d),typeof a=="string"?d!=null&&encodeURIComponent(String(d)):ce(a,h,d))}function pe(a){xe.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}S(pe,xe);var Yg=/^https?$/i,Xg=["POST","PUT"];s=pe.prototype,s.Ha=function(a){this.J=a},s.ea=function(a,h,d,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():Ra.g(),this.v=this.o?wc(this.o):wc(Ra),this.g.onreadystatechange=m(this.Ea,this);try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(P){Hc(this,P);return}if(a=d||"",d=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var R in p)d.set(R,p[R]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const P of p.keys())d.set(P,p.get(P));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(d.keys()).find(P=>P.toLowerCase()=="content-type"),R=l.FormData&&a instanceof l.FormData,!(0<=Array.prototype.indexOf.call(Xg,h,void 0))||p||R||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[P,O]of d)this.g.setRequestHeader(P,O);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Jc(this),this.u=!0,this.g.send(a),this.u=!1}catch(P){Hc(this,P)}};function Hc(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.m=5,Yc(a),wr(a)}function Yc(a){a.A||(a.A=!0,qe(a,"complete"),qe(a,"error"))}s.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,qe(this,"complete"),qe(this,"abort"),wr(this))},s.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),wr(this,!0)),pe.aa.N.call(this)},s.Ea=function(){this.s||(this.B||this.u||this.j?Xc(this):this.bb())},s.bb=function(){Xc(this)};function Xc(a){if(a.h&&typeof o<"u"&&(!a.v[1]||vt(a)!=4||a.Z()!=2)){if(a.u&&vt(a)==4)Ec(a.Ea,0,a);else if(qe(a,"readystatechange"),vt(a)==4){a.h=!1;try{const O=a.Z();e:switch(O){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var d;if(!(d=h)){var p;if(p=O===0){var R=String(a.D).match(qc)[1]||null;!R&&l.self&&l.self.location&&(R=l.self.location.protocol.slice(0,-1)),p=!Yg.test(R?R.toLowerCase():"")}d=p}if(d)qe(a,"complete"),qe(a,"success");else{a.m=6;try{var P=2<vt(a)?a.g.statusText:""}catch{P=""}a.l=P+" ["+a.Z()+"]",Yc(a)}}finally{wr(a)}}}}function wr(a,h){if(a.g){Jc(a);const d=a.g,p=a.v[0]?()=>{}:null;a.g=null,a.v=null,h||qe(a,"ready");try{d.onreadystatechange=p}catch{}}}function Jc(a){a.I&&(l.clearTimeout(a.I),a.I=null)}s.isActive=function(){return!!this.g};function vt(a){return a.g?a.g.readyState:0}s.Z=function(){try{return 2<vt(this)?this.g.status:-1}catch{return-1}},s.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},s.Oa=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),bg(h)}};function Zc(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Jg(a){const h={};a=(a.g&&2<=vt(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<a.length;p++){if(j(a[p]))continue;var d=w(a[p]);const R=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const P=h[R]||[];h[R]=P,P.push(d)}v(h,function(p){return p.join(", ")})}s.Ba=function(){return this.m},s.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function ei(a,h,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||h}function eh(a){this.Aa=0,this.i=[],this.j=new $s,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=ei("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=ei("baseRetryDelayMs",5e3,a),this.cb=ei("retryDelaySeedMs",1e4,a),this.Wa=ei("forwardChannelMaxRetries",2,a),this.wa=ei("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Oc(a&&a.concurrentRequestLimit),this.Da=new Qg,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}s=eh.prototype,s.la=8,s.G=1,s.connect=function(a,h,d,p){je(0),this.W=a,this.H=h||{},d&&p!==void 0&&(this.H.OSID=d,this.H.OAID=p),this.F=this.X,this.I=uh(this,null,this.W),Rr(this)};function Da(a){if(th(a),a.G==3){var h=a.U++,d=It(a.I);if(ce(d,"SID",a.K),ce(d,"RID",h),ce(d,"TYPE","terminate"),ti(a,d),h=new Ot(a,a.j,h),h.L=2,h.v=Ir(It(d)),d=!1,l.navigator&&l.navigator.sendBeacon)try{d=l.navigator.sendBeacon(h.v.toString(),"")}catch{}!d&&l.Image&&(new Image().src=h.v,d=!0),d||(h.g=ch(h.j,null),h.g.ea(h.v)),h.F=Date.now(),gr(h)}lh(a)}function Ar(a){a.g&&(Oa(a),a.g.cancel(),a.g=null)}function th(a){Ar(a),a.u&&(l.clearTimeout(a.u),a.u=null),Cr(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&l.clearTimeout(a.s),a.s=null)}function Rr(a){if(!Mc(a.h)&&!a.s){a.s=!0;var h=a.Ga;Bs||_c(),qs||(Bs(),qs=!0),fa.add(h,a),a.B=0}}function Zg(a,h){return Fc(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=h.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Ws(m(a.Ga,a,h),ah(a,a.B)),a.B++,!0)}s.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const R=new Ot(this,this.j,a);let P=this.o;if(this.S&&(P?(P=g(P),T(P,this.S)):P=this.S),this.m!==null||this.O||(R.H=P,P=null),this.P)e:{for(var h=0,d=0;d<this.i.length;d++){t:{var p=this.i[d];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(h+=p,4096<h){h=d;break e}if(h===4096||d===this.i.length-1){h=d+1;break e}}h=1e3}else h=1e3;h=sh(this,R,h),d=It(this.I),ce(d,"RID",a),ce(d,"CVER",22),this.D&&ce(d,"X-HTTP-Session-Id",this.D),ti(this,d),P&&(this.O?h="headers="+encodeURIComponent(String(Qc(P)))+"&"+h:this.m&&Na(d,this.m,P)),xa(this.h,R),this.Ua&&ce(d,"TYPE","init"),this.P?(ce(d,"$req",h),ce(d,"SID","null"),R.T=!0,Sa(R,d,null)):Sa(R,d,h),this.G=2}}else this.G==3&&(a?nh(this,a):this.i.length==0||Mc(this.h)||nh(this))};function nh(a,h){var d;h?d=h.l:d=a.U++;const p=It(a.I);ce(p,"SID",a.K),ce(p,"RID",d),ce(p,"AID",a.T),ti(a,p),a.m&&a.o&&Na(p,a.m,a.o),d=new Ot(a,a.j,d,a.B+1),a.m===null&&(d.H=a.o),h&&(a.i=h.D.concat(a.i)),h=sh(a,d,1e3),d.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),xa(a.h,d),Sa(d,p,h)}function ti(a,h){a.H&&Z(a.H,function(d,p){ce(h,p,d)}),a.l&&Bc({},function(d,p){ce(h,p,d)})}function sh(a,h,d){d=Math.min(a.i.length,d);var p=a.l?m(a.l.Na,a.l,a):null;e:{var R=a.i;let P=-1;for(;;){const O=["count="+d];P==-1?0<d?(P=R[0].g,O.push("ofs="+P)):P=0:O.push("ofs="+P);let oe=!0;for(let be=0;be<d;be++){let ee=R[be].g;const Ne=R[be].map;if(ee-=P,0>ee)P=Math.max(0,R[be].g-100),oe=!1;else try{Hg(Ne,O,"req"+ee+"_")}catch{p&&p(Ne)}}if(oe){p=O.join("&");break e}}}return a=a.i.splice(0,d),h.D=a,p}function ih(a){if(!a.g&&!a.u){a.Y=1;var h=a.Fa;Bs||_c(),qs||(Bs(),qs=!0),fa.add(h,a),a.v=0}}function ka(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Ws(m(a.Fa,a),ah(a,a.v)),a.v++,!0)}s.Fa=function(){if(this.u=null,rh(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Ws(m(this.ab,this),a)}},s.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,je(10),Ar(this),rh(this))};function Oa(a){a.A!=null&&(l.clearTimeout(a.A),a.A=null)}function rh(a){a.g=new Ot(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var h=It(a.qa);ce(h,"RID","rpc"),ce(h,"SID",a.K),ce(h,"AID",a.T),ce(h,"CI",a.F?"0":"1"),!a.F&&a.ja&&ce(h,"TO",a.ja),ce(h,"TYPE","xmlhttp"),ti(a,h),a.m&&a.o&&Na(h,a.m,a.o),a.L&&(a.g.I=a.L);var d=a.g;a=a.ia,d.L=1,d.v=Ir(It(h)),d.m=null,d.P=!0,Nc(d,a)}s.Za=function(){this.C!=null&&(this.C=null,Ar(this),ka(this),je(19))};function Cr(a){a.C!=null&&(l.clearTimeout(a.C),a.C=null)}function oh(a,h){var d=null;if(a.g==h){Cr(a),Oa(a),a.g=null;var p=2}else if(Va(a.h,h))d=h.D,Lc(a.h,h),p=1;else return;if(a.G!=0){if(h.o)if(p==1){d=h.m?h.m.length:0,h=Date.now()-h.F;var R=a.B;p=_r(),qe(p,new Pc(p,d)),Rr(a)}else ih(a);else if(R=h.s,R==3||R==0&&0<h.X||!(p==1&&Zg(a,h)||p==2&&ka(a)))switch(d&&0<d.length&&(h=a.h,h.i=h.i.concat(d)),R){case 1:cn(a,5);break;case 4:cn(a,10);break;case 3:cn(a,6);break;default:cn(a,2)}}}function ah(a,h){let d=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(d*=2),d*h}function cn(a,h){if(a.j.info("Error code "+h),h==2){var d=m(a.fb,a),p=a.Xa;const R=!p;p=new un(p||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||yr(p,"https"),Ir(p),R?Wg(p.toString(),d):$g(p.toString(),d)}else je(2);a.G=0,a.l&&a.l.sa(h),lh(a),th(a)}s.fb=function(a){a?(this.j.info("Successfully pinged google.com"),je(2)):(this.j.info("Failed to ping google.com"),je(1))};function lh(a){if(a.G=0,a.ka=[],a.l){const h=Uc(a.h);(h.length!=0||a.i.length!=0)&&(x(a.ka,h),x(a.ka,a.i),a.h.i.length=0,V(a.i),a.i.length=0),a.l.ra()}}function uh(a,h,d){var p=d instanceof un?It(d):new un(d);if(p.g!="")h&&(p.g=h+"."+p.g),Er(p,p.s);else{var R=l.location;p=R.protocol,h=h?h+"."+R.hostname:R.hostname,R=+R.port;var P=new un(null);p&&yr(P,p),h&&(P.g=h),R&&Er(P,R),d&&(P.l=d),p=P}return d=a.D,h=a.ya,d&&h&&ce(p,d,h),ce(p,"VER",a.la),ti(a,p),p}function ch(a,h,d){if(h&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Ca&&!a.pa?new pe(new vr({eb:d})):new pe(a.pa),h.Ha(a.J),h}s.isActive=function(){return!!this.l&&this.l.isActive(this)};function hh(){}s=hh.prototype,s.ua=function(){},s.ta=function(){},s.sa=function(){},s.ra=function(){},s.isActive=function(){return!0},s.Na=function(){};function Sr(){}Sr.prototype.g=function(a,h){return new Xe(a,h)};function Xe(a,h){xe.call(this),this.g=new eh(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.va&&(a?a["X-WebChannel-Client-Profile"]=h.va:a={"X-WebChannel-Client-Profile":h.va}),this.g.S=a,(a=h&&h.Sb)&&!j(a)&&(this.g.m=a),this.v=h&&h.supportsCrossDomainXhr||!1,this.u=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!j(h)&&(this.g.D=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new Gn(this)}S(Xe,xe),Xe.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Xe.prototype.close=function(){Da(this.g)},Xe.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.u&&(d={},d.__data__=va(a),a=d);h.i.push(new Mg(h.Ya++,a)),h.G==3&&Rr(h)},Xe.prototype.N=function(){this.g.l=null,delete this.j,Da(this.g),delete this.g,Xe.aa.N.call(this)};function dh(a){wa.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const d in h){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}S(dh,wa);function fh(){Aa.call(this),this.status=1}S(fh,Aa);function Gn(a){this.g=a}S(Gn,hh),Gn.prototype.ua=function(){qe(this.g,"a")},Gn.prototype.ta=function(a){qe(this.g,new dh(a))},Gn.prototype.sa=function(a){qe(this.g,new fh)},Gn.prototype.ra=function(){qe(this.g,"b")},Sr.prototype.createWebChannel=Sr.prototype.g,Xe.prototype.send=Xe.prototype.o,Xe.prototype.open=Xe.prototype.m,Xe.prototype.close=Xe.prototype.close,Uf=function(){return new Sr},Lf=function(){return _r()},Ff=an,Ja={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},pr.NO_ERROR=0,pr.TIMEOUT=8,pr.HTTP_ERROR=6,Lr=pr,bc.COMPLETE="complete",Mf=bc,Ac.EventType=zs,zs.OPEN="a",zs.CLOSE="b",zs.ERROR="c",zs.MESSAGE="d",xe.prototype.listen=xe.prototype.K,hi=Ac,pe.prototype.listenOnce=pe.prototype.L,pe.prototype.getLastError=pe.prototype.Ka,pe.prototype.getLastErrorCode=pe.prototype.Ba,pe.prototype.getStatus=pe.prototype.Z,pe.prototype.getResponseJson=pe.prototype.Oa,pe.prototype.getResponseText=pe.prototype.oa,pe.prototype.send=pe.prototype.ea,pe.prototype.setWithCredentials=pe.prototype.Ha,Of=pe}).apply(typeof br<"u"?br:typeof self<"u"?self:typeof window<"u"?window:{});const mh="@firebase/firestore",gh="4.8.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cn=new vf("@firebase/firestore");function Jn(){return Cn.logLevel}function N(s,...e){if(Cn.logLevel<=dt.DEBUG){const t=e.map(ql);Cn.debug(`Firestore (${xs}): ${s}`,...t)}}function ye(s,...e){if(Cn.logLevel<=dt.ERROR){const t=e.map(ql);Cn.error(`Firestore (${xs}): ${s}`,...t)}}function Qt(s,...e){if(Cn.logLevel<=dt.WARN){const t=e.map(ql);Cn.warn(`Firestore (${xs}): ${s}`,...t)}}function ql(s){if(typeof s=="string")return s;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hs=-1;class eo{constructor(e,t,n,i){this.indexId=e,this.collectionGroup=t,this.fields=n,this.indexState=i}}function el(s){return s.fields.find(e=>e.kind===2)}function dn(s){return s.fields.filter(e=>e.kind!==2)}eo.UNKNOWN_ID=-1;class Ur{constructor(e,t){this.fieldPath=e,this.kind=t}}class Vi{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new Vi(0,nt.min())}}function Kf(s,e){const t=s.toTimestamp().seconds,n=s.toTimestamp().nanoseconds+1,i=q.fromTimestamp(n===1e9?new se(t+1,0):new se(t,n));return new nt(i,M.empty(),e)}function Wf(s){return new nt(s.readTime,s.key,hs)}class nt{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new nt(q.min(),M.empty(),hs)}static max(){return new nt(q.max(),M.empty(),hs)}}function Gl(s,e){let t=s.readTime.compareTo(e.readTime);return t!==0?t:(t=M.comparator(s.documentKey,e.documentKey),t!==0?t:G(s.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tn(s){if(s.code!==b.FAILED_PRECONDITION||s.message!==$f)throw s;N("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vn=-1;function Fo(s){return s==null}function xi(s){return s===0&&1/s==-1/0}function Yf(s){return typeof s=="number"&&Number.isInteger(s)&&!xi(s)&&s<=Number.MAX_SAFE_INTEGER&&s>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn="remoteDocuments",Xi="owner",Kn="owner",Ni="mutationQueues",Ny="userId",rt="mutations",Sh="batchId",En="userMutationsIndex",Ph=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Br(s,e){return[s,Be(e)]}function Xf(s,e,t){return[s,Be(e),t]}const Dy={},ds="documentMutations",no="remoteDocumentsV14",ky=["prefixPath","collectionGroup","readTime","documentId"],qr="documentKeyIndex",Oy=["prefixPath","collectionGroup","documentId"],Jf="collectionGroupIndex",My=["collectionGroup","readTime","prefixPath","documentId"],Di="remoteDocumentGlobal",tl="remoteDocumentGlobalKey",fs="targets",Zf="queryTargetsIndex",Fy=["canonicalId","targetId"],_s="targetDocuments",Ly=["targetId","path"],Kl="documentTargetsIndex",Uy=["path","targetId"],so="targetGlobalKey",Tn="targetGlobal",ki="collectionParents",By=["collectionId","parent"],ps="clientMetadata",qy="clientId",Lo="bundles",jy="bundleId",Uo="namedQueries",Gy="name",Wl="indexConfiguration",zy="indexId",nl="collectionGroupIndex",Ky="collectionGroup",yi="indexState",Wy=["indexId","uid"],e_="sequenceNumberIndex",$y=["uid","sequenceNumber"],Ei="indexEntries",Qy=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],t_="documentKeyIndex",Hy=["indexId","uid","orderedDocumentKey"],Bo="documentOverlays",Yy=["userId","collectionPath","documentId"],sl="collectionPathOverlayIndex",Xy=["userId","collectionPath","largestBatchId"],n_="collectionGroupOverlayIndex",Jy=["userId","collectionGroup","largestBatchId"],$l="globals",Zy="name",s_=[Ni,rt,ds,fn,fs,Xi,Tn,_s,ps,Di,ki,Lo,Uo],eE=[...s_,Bo],i_=[Ni,rt,ds,no,fs,Xi,Tn,_s,ps,Di,ki,Lo,Uo,Bo],r_=i_,Ql=[...r_,Wl,yi,Ei],tE=Ql,o_=[...Ql,$l],nE=o_;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class il extends Qf{constructor(e,t){super(),this.ce=e,this.currentSequenceNumber=t}}function Ae(s,e){const t=L(s);return zt.N(t.ce,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bh(s){let e=0;for(const t in s)Object.prototype.hasOwnProperty.call(s,t)&&e++;return e}function sn(s,e){for(const t in s)Object.prototype.hasOwnProperty.call(s,t)&&e(t,s[t])}function a_(s){for(const e in s)if(Object.prototype.hasOwnProperty.call(s,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u_="server_timestamp",c_="__type__",h_="__previous_value__",d_="__local_write_time__";function Hl(s){var e,t;return((t=(((e=s==null?void 0:s.mapValue)===null||e===void 0?void 0:e.fields)||{})[c_])===null||t===void 0?void 0:t.stringValue)===u_}function qo(s){const e=s.mapValue.fields[h_];return Hl(e)?qo(e):e}function Oi(s){const e=St(s.mapValue.fields[d_].timestampValue);return new se(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),n=this.inner[t];if(n!==void 0){for(const[i,r]of n)if(this.equalsFn(i,e))return r}}has(e){return this.get(e)!==void 0}set(e,t){const n=this.mapKeyFn(e),i=this.inner[n];if(i===void 0)return this.inner[n]=[[e,t]],void this.innerSize++;for(let r=0;r<i.length;r++)if(this.equalsFn(i[r][0],e))return void(i[r]=[e,t]);i.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),n=this.inner[t];if(n===void 0)return!1;for(let i=0;i<n.length;i++)if(this.equalsFn(n[i][0],e))return n.length===1?delete this.inner[t]:n.splice(i,1),this.innerSize--,!0;return!1}forEach(e){sn(this.inner,(t,n)=>{for(const[i,r]of n)e(i,r)})}isEmpty(){return a_(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gE=new _e(M.comparator);function Ze(){return gE}const b_=new _e(M.comparator);function di(...s){let e=b_;for(const t of s)e=e.insert(t.key,t);return e}function V_(s){let e=b_;return s.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function _t(){return Ti()}function x_(){return Ti()}function Ti(){return new xt(s=>s.toString(),(s,e)=>s.isEqual(e))}const yE=new _e(M.comparator),EE=new re(M.comparator);function W(...s){let e=EE;for(const t of s)e=e.add(t);return e}const IE=new re(G);function Zl(){return IE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eu(s,e){if(s.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:xi(e)?"-0":e}}function N_(s){return{integerValue:""+s}}function vE(s,e){return Yf(e)?N_(e):eu(s,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WE{getBundleMetadata(e,t){return ed(e).get(t).next(n=>{if(n)return function(r){return{id:r.bundleId,createTime:Vn(r.createTime),version:r.version}}(n)})}saveBundleMetadata(e,t){return ed(e).put(function(i){return{bundleId:i.id,createTime:bn(ze(i.createTime)),version:i.version}}(t))}getNamedQuery(e,t){return td(e).get(t).next(n=>{if(n)return function(r){return{name:r.name,query:sp(r.bundledQuery),readTime:Vn(r.readTime)}}(n)})}saveNamedQuery(e,t){return td(e).put(function(i){return{name:i.name,readTime:bn(ze(i.readTime)),bundledQuery:i.bundledQuery}}(t))}}function ed(s){return Ae(s,Lo)}function td(s){return Ae(s,Uo)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $o{constructor(e,t){this.serializer=e,this.userId=t}static yt(e,t){const n=t.uid||"";return new $o(e,n)}getOverlay(e,t){return ni(e).get(Jh(this.userId,t)).next(n=>n?Fa(this.serializer,n):null)}getOverlays(e,t){const n=_t();return A.forEach(t,i=>this.getOverlay(e,i).next(r=>{r!==null&&n.set(i,r)})).next(()=>n)}saveOverlays(e,t,n){const i=[];return n.forEach((r,o)=>{const l=new iu(t,o);i.push(this.wt(e,l))}),A.waitFor(i)}removeOverlaysForBatchId(e,t,n){const i=new Set;t.forEach(o=>i.add(Be(o.getCollectionPath())));const r=[];return i.forEach(o=>{const l=IDBKeyRange.bound([this.userId,o,n],[this.userId,o,n+1],!1,!0);r.push(ni(e).Y(sl,l))}),A.waitFor(r)}getOverlaysForCollection(e,t,n){const i=_t(),r=Be(t),o=IDBKeyRange.bound([this.userId,r,n],[this.userId,r,Number.POSITIVE_INFINITY],!0);return ni(e).j(sl,o).next(l=>{for(const u of l){const c=Fa(this.serializer,u);i.set(c.getKey(),c)}return i})}getOverlaysForCollectionGroup(e,t,n,i){const r=_t();let o;const l=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return ni(e).X({index:n_,range:l},(u,c,f)=>{const _=Fa(this.serializer,c);r.size()<i||_.largestBatchId===o?(r.set(_.getKey(),_),o=_.largestBatchId):f.done()}).next(()=>r)}wt(e,t){return ni(e).put(function(i,r,o){const[l,u,c]=Jh(r,o.mutation.key);return{userId:r,collectionPath:u,documentId:c,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:uo(i.gt,o.mutation)}}(this.serializer,this.userId,t))}}function ni(s){return Ae(s,Bo)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $E{St(e){return Ae(e,$l)}getSessionToken(e){return this.St(e).get("sessionToken").next(t=>{const n=t==null?void 0:t.value;return n?Ie.fromUint8Array(n):Ie.EMPTY_BYTE_STRING})}setSessionToken(e,t){return this.St(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ip(s){var e,t;if(U(s instanceof Y||s instanceof ie,20012),s instanceof Y){if(s instanceof w_){const i=((t=(e=s.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map(r=>Y.create(s.field,"==",r)))||[];return ie.create(i,"or")}return s}const n=s.filters.map(i=>ip(i));return ie.create(n,s.op)}function JE(s){if(s.getFilters().length===0)return[];const e=yl(ip(s));return U(rp(e),7391),ml(e)||gl(e)?[e]:e.getFilters()}function ml(s){return s instanceof Y}function gl(s){return s instanceof ie&&Jl(s)}function rp(s){return ml(s)||gl(s)||function(t){if(t instanceof ie&&ll(t)){for(const n of t.getFilters())if(!ml(n)&&!gl(n))return!1;return!0}return!1}(s)}function yl(s){if(U(s instanceof Y||s instanceof ie,34018),s instanceof Y)return s;if(s.filters.length===1)return yl(s.filters[0]);const e=s.filters.map(n=>yl(n));let t=ie.create(e,s.op);return t=ho(t),rp(t)?t:(U(t instanceof ie,64498),U(Es(t),40251),U(t.filters.length>1,57927),t.filters.reduce((n,i)=>au(n,i)))}function au(s,e){let t;return U(s instanceof Y||s instanceof ie,38388),U(e instanceof Y||e instanceof ie,25473),t=s instanceof Y?e instanceof Y?function(i,r){return ie.create([i,r],"and")}(s,e):od(s,e):e instanceof Y?od(e,s):function(i,r){if(U(i.filters.length>0&&r.filters.length>0,48005),Es(i)&&Es(r))return I_(i,r.getFilters());const o=ll(i)?i:r,l=ll(i)?r:i,u=o.filters.map(c=>au(c,l));return ie.create(u,"or")}(s,e),ho(t)}function od(s,e){if(Es(e))return I_(e,s.getFilters());{const t=e.filters.map(n=>au(s,n));return ie.create(t,"or")}}function ho(s){if(U(s instanceof Y||s instanceof ie,11850),s instanceof Y)return s;const e=s.getFilters();if(e.length===1)return ho(e[0]);if(y_(s))return s;const t=e.map(i=>ho(i)),n=[];return t.forEach(i=>{i instanceof Y?n.push(i):i instanceof ie&&(i.op===s.op?n.push(...i.filters):n.push(i))}),n.length===1?n[0]:ie.create(n,s.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tI{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.cr(e).next(t=>{const n=new xn(t.highestTargetId);return t.highestTargetId=n.next(),this.lr(e,t).next(()=>t.highestTargetId)})}getLastRemoteSnapshotVersion(e){return this.cr(e).next(t=>q.fromTimestamp(new se(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds)))}getHighestSequenceNumber(e){return this.cr(e).next(t=>t.highestListenSequenceNumber)}setTargetsMetadata(e,t,n){return this.cr(e).next(i=>(i.highestListenSequenceNumber=t,n&&(i.lastRemoteSnapshotVersion=n.toTimestamp()),t>i.highestListenSequenceNumber&&(i.highestListenSequenceNumber=t),this.lr(e,i)))}addTargetData(e,t){return this.hr(e,t).next(()=>this.cr(e).next(n=>(n.targetCount+=1,this.Pr(t,n),this.lr(e,n))))}updateTargetData(e,t){return this.hr(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next(()=>Yn(e).delete(t.targetId)).next(()=>this.cr(e)).next(n=>(U(n.targetCount>0,8065),n.targetCount-=1,this.lr(e,n)))}removeTargets(e,t,n){let i=0;const r=[];return Yn(e).X((o,l)=>{const u=_i(l);u.sequenceNumber<=t&&n.get(u.targetId)===null&&(i++,r.push(this.removeTargetData(e,u)))}).next(()=>A.waitFor(r)).next(()=>i)}forEachTarget(e,t){return Yn(e).X((n,i)=>{const r=_i(i);t(r)})}cr(e){return hd(e).get(so).next(t=>(U(t!==null,2888),t))}lr(e,t){return hd(e).put(so,t)}hr(e,t){return Yn(e).put(np(this.serializer,t))}Pr(e,t){let n=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,n=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,n=!0),n}getTargetCount(e){return this.cr(e).next(t=>t.targetCount)}getTargetData(e,t){const n=Pn(t),i=IDBKeyRange.bound([n,Number.NEGATIVE_INFINITY],[n,Number.POSITIVE_INFINITY]);let r=null;return Yn(e).X({range:i,index:Zf},(o,l,u)=>{const c=_i(l);Ji(t,c.target)&&(r=c,u.done())}).next(()=>r)}addMatchingKeys(e,t,n){const i=[],r=qt(e);return t.forEach(o=>{const l=Be(o.path);i.push(r.put({targetId:n,path:l})),i.push(this.referenceDelegate.addReference(e,n,o))}),A.waitFor(i)}removeMatchingKeys(e,t,n){const i=qt(e);return A.forEach(t,r=>{const o=Be(r.path);return A.waitFor([i.delete([n,o]),this.referenceDelegate.removeReference(e,n,r)])})}removeMatchingKeysForTargetId(e,t){const n=qt(e),i=IDBKeyRange.bound([t],[t+1],!1,!0);return n.delete(i)}getMatchingKeysForTargetId(e,t){const n=IDBKeyRange.bound([t],[t+1],!1,!0),i=qt(e);let r=W();return i.X({range:n,Z:!0},(o,l,u)=>{const c=ft(o[1]),f=new M(c);r=r.add(f)}).next(()=>r)}containsKey(e,t){const n=Be(t.path),i=IDBKeyRange.bound([n],[jf(n)],!1,!0);let r=0;return qt(e).X({index:Kl,Z:!0,range:i},([o,l],u,c)=>{o!==0&&(r++,c.done())}).next(()=>r>0)}Et(e,t){return Yn(e).get(t).next(n=>n?_i(n):null)}}function Yn(s){return Ae(s,fs)}function hd(s){return Ae(s,Tn)}function qt(s){return Ae(s,_s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rI{constructor(e){this.serializer=e}setIndexManager(e){this.indexManager=e}addEntry(e,t,n){return hn(e).put(n)}removeEntry(e,t,n){return hn(e).delete(function(r,o){const l=r.path.toArray();return[l.slice(0,l.length-2),l[l.length-2],co(o),l[l.length-1]]}(t,n))}updateMetadata(e,t){return this.getMetadata(e).next(n=>(n.byteSize+=t,this.br(e,n)))}getEntry(e,t){let n=me.newInvalidDocument(t);return hn(e).X({index:qr,range:IDBKeyRange.only(ri(t))},(i,r)=>{n=this.Dr(t,r)}).next(()=>n)}vr(e,t){let n={size:0,document:me.newInvalidDocument(t)};return hn(e).X({index:qr,range:IDBKeyRange.only(ri(t))},(i,r)=>{n={document:this.Dr(t,r),size:fo(r)}}).next(()=>n)}getEntries(e,t){let n=Ze();return this.Cr(e,t,(i,r)=>{const o=this.Dr(i,r);n=n.insert(i,o)}).next(()=>n)}Fr(e,t){let n=Ze(),i=new _e(M.comparator);return this.Cr(e,t,(r,o)=>{const l=this.Dr(r,o);n=n.insert(r,l),i=i.insert(r,fo(o))}).next(()=>({documents:n,Mr:i}))}Cr(e,t,n){if(t.isEmpty())return A.resolve();let i=new re(md);t.forEach(u=>i=i.add(u));const r=IDBKeyRange.bound(ri(i.first()),ri(i.last())),o=i.getIterator();let l=o.getNext();return hn(e).X({index:qr,range:r},(u,c,f)=>{const _=M.fromSegments([...c.prefixPath,c.collectionGroup,c.documentId]);for(;l&&md(l,_)<0;)n(l,null),l=o.getNext();l&&l.isEqual(_)&&(n(l,c),l=o.hasNext()?o.getNext():null),l?f.G(ri(l)):f.done()}).next(()=>{for(;l;)n(l,null),l=o.hasNext()?o.getNext():null})}getDocumentsMatchingQuery(e,t,n,i,r){const o=t.path,l=[o.popLast().toArray(),o.lastSegment(),co(n.readTime),n.documentKey.path.isEmpty()?"":n.documentKey.path.lastSegment()],u=[o.popLast().toArray(),o.lastSegment(),[Number.MAX_SAFE_INTEGER,Number.MAX_SAFE_INTEGER],""];return hn(e).j(IDBKeyRange.bound(l,u,!0)).next(c=>{r==null||r.incrementDocumentReadCount(c.length);let f=Ze();for(const _ of c){const m=this.Dr(M.fromSegments(_.prefixPath.concat(_.collectionGroup,_.documentId)),_);m.isFoundDocument()&&(Zi(t,m)||i.has(m.key))&&(f=f.insert(m.key,m))}return f})}getAllFromCollectionGroup(e,t,n,i){let r=Ze();const o=pd(t,n),l=pd(t,nt.max());return hn(e).X({index:Jf,range:IDBKeyRange.bound(o,l,!0)},(u,c,f)=>{const _=this.Dr(M.fromSegments(c.prefixPath.concat(c.collectionGroup,c.documentId)),c);r=r.insert(_.key,_),r.size===i&&f.done()}).next(()=>r)}newChangeBuffer(e){return new oI(this,!!e&&e.trackRemovals)}getSize(e){return this.getMetadata(e).next(t=>t.byteSize)}getMetadata(e){return _d(e).get(tl).next(t=>(U(!!t,20021),t))}br(e,t){return _d(e).put(tl,t)}Dr(e,t){if(t){const n=KE(this.serializer,t);if(!(n.isNoDocument()&&n.version.isEqual(q.min())))return n}return me.newInvalidDocument(e)}}function _p(s){return new rI(s)}class oI extends fp{constructor(e,t){super(),this.Or=e,this.trackRemovals=t,this.Nr=new xt(n=>n.toString(),(n,i)=>n.isEqual(i))}applyChanges(e){const t=[];let n=0,i=new re((r,o)=>G(r.canonicalString(),o.canonicalString()));return this.changes.forEach((r,o)=>{const l=this.Nr.get(r);if(t.push(this.Or.removeEntry(e,r,l.readTime)),o.isValidDocument()){const u=Xh(this.Or.serializer,o);i=i.add(r.path.popLast());const c=fo(u);n+=c-l.size,t.push(this.Or.addEntry(e,r,u))}else if(n-=l.size,this.trackRemovals){const u=Xh(this.Or.serializer,o.convertToNoDocument(q.min()));t.push(this.Or.addEntry(e,r,u))}}),i.forEach(r=>{t.push(this.Or.indexManager.addToCollectionParentIndex(e,r))}),t.push(this.Or.updateMetadata(e,n)),A.waitFor(t)}getFromCache(e,t){return this.Or.vr(e,t).next(n=>(this.Nr.set(t,{size:n.size,readTime:n.document.readTime}),n.document))}getAllFromCache(e,t){return this.Or.Fr(e,t).next(({documents:n,Mr:i})=>(i.forEach((r,o)=>{this.Nr.set(r,{size:o,readTime:n.get(r).readTime})}),n))}}function _d(s){return Ae(s,Di)}function hn(s){return Ae(s,no)}function ri(s){const e=s.path.toArray();return[e.slice(0,e.length-2),e[e.length-2],e[e.length-1]]}function pd(s,e){const t=e.documentKey.path.toArray();return[s,co(e.readTime),t.slice(0,t.length-2),t.length>0?t[t.length-1]:""]}function md(s,e){const t=s.path.toArray(),n=e.path.toArray();let i=0;for(let r=0;r<t.length-2&&r<n.length-2;++r)if(i=G(t[r],n[r]),i)return i;return i=G(t.length,n.length),i||(i=G(t[t.length-2],n[n.length-2]),i||G(t[t.length-1],n[n.length-1]))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mI{constructor(e){this.serializer=e}q(e,t,n,i){const r=new Mo("createOrUpgrade",t);n<1&&i>=1&&(function(u){u.createObjectStore(Xi)}(e),function(u){u.createObjectStore(Ni,{keyPath:Ny}),u.createObjectStore(rt,{keyPath:Sh,autoIncrement:!0}).createIndex(En,Ph,{unique:!0}),u.createObjectStore(ds)}(e),gd(e),function(u){u.createObjectStore(fn)}(e));let o=A.resolve();return n<3&&i>=3&&(n!==0&&(function(u){u.deleteObjectStore(_s),u.deleteObjectStore(fs),u.deleteObjectStore(Tn)}(e),gd(e)),o=o.next(()=>function(u){const c=u.store(Tn),f={highestTargetId:0,highestListenSequenceNumber:0,lastRemoteSnapshotVersion:q.min().toTimestamp(),targetCount:0};return c.put(so,f)}(r))),n<4&&i>=4&&(n!==0&&(o=o.next(()=>function(u,c){return c.store(rt).j().next(_=>{u.deleteObjectStore(rt),u.createObjectStore(rt,{keyPath:Sh,autoIncrement:!0}).createIndex(En,Ph,{unique:!0});const m=c.store(rt),I=_.map(S=>m.put(S));return A.waitFor(I)})}(e,r))),o=o.next(()=>{(function(u){u.createObjectStore(ps,{keyPath:qy})})(e)})),n<5&&i>=5&&(o=o.next(()=>this.pi(r))),n<6&&i>=6&&(o=o.next(()=>(function(u){u.createObjectStore(Di)}(e),this.yi(r)))),n<7&&i>=7&&(o=o.next(()=>this.wi(r))),n<8&&i>=8&&(o=o.next(()=>this.Si(e,r))),n<9&&i>=9&&(o=o.next(()=>{(function(u){u.objectStoreNames.contains("remoteDocumentChanges")&&u.deleteObjectStore("remoteDocumentChanges")})(e)})),n<10&&i>=10&&(o=o.next(()=>this.bi(r))),n<11&&i>=11&&(o=o.next(()=>{(function(u){u.createObjectStore(Lo,{keyPath:jy})})(e),function(u){u.createObjectStore(Uo,{keyPath:Gy})}(e)})),n<12&&i>=12&&(o=o.next(()=>{(function(u){const c=u.createObjectStore(Bo,{keyPath:Yy});c.createIndex(sl,Xy,{unique:!1}),c.createIndex(n_,Jy,{unique:!1})})(e)})),n<13&&i>=13&&(o=o.next(()=>function(u){const c=u.createObjectStore(no,{keyPath:ky});c.createIndex(qr,Oy),c.createIndex(Jf,My)}(e)).next(()=>this.Di(e,r)).next(()=>e.deleteObjectStore(fn))),n<14&&i>=14&&(o=o.next(()=>this.Ci(e,r))),n<15&&i>=15&&(o=o.next(()=>function(u){u.createObjectStore(Wl,{keyPath:zy,autoIncrement:!0}).createIndex(nl,Ky,{unique:!1}),u.createObjectStore(yi,{keyPath:Wy}).createIndex(e_,$y,{unique:!1}),u.createObjectStore(Ei,{keyPath:Qy}).createIndex(t_,Hy,{unique:!1})}(e))),n<16&&i>=16&&(o=o.next(()=>{t.objectStore(yi).clear()}).next(()=>{t.objectStore(Ei).clear()})),n<17&&i>=17&&(o=o.next(()=>{(function(u){u.createObjectStore($l,{keyPath:Zy})})(e)})),n<18&&i>=18&&bf()&&(o=o.next(()=>{t.objectStore(yi).clear()}).next(()=>{t.objectStore(Ei).clear()})),o}yi(e){let t=0;return e.store(fn).X((n,i)=>{t+=fo(i)}).next(()=>{const n={byteSize:t};return e.store(Di).put(tl,n)})}pi(e){const t=e.store(Ni),n=e.store(rt);return t.j().next(i=>A.forEach(i,r=>{const o=IDBKeyRange.bound([r.userId,vn],[r.userId,r.lastAcknowledgedBatchId]);return n.j(En,o).next(l=>A.forEach(l,u=>{U(u.userId===r.userId,18650,"Cannot process batch from unexpected user",{batchId:u.batchId});const c=mn(this.serializer,u);return ap(e,r.userId,c).next(()=>{})}))}))}wi(e){const t=e.store(_s),n=e.store(fn);return e.store(Tn).get(so).next(i=>{const r=[];return n.X((o,l)=>{const u=new te(o),c=function(_){return[0,Be(_)]}(u);r.push(t.get(c).next(f=>f?A.resolve():(_=>t.put({targetId:0,path:Be(_),sequenceNumber:i.highestListenSequenceNumber}))(u)))}).next(()=>A.waitFor(r))})}Si(e,t){e.createObjectStore(ki,{keyPath:By});const n=t.store(ki),i=new lu,r=o=>{if(i.add(o)){const l=o.lastSegment(),u=o.popLast();return n.put({collectionId:l,parent:Be(u)})}};return t.store(fn).X({Z:!0},(o,l)=>{const u=new te(o);return r(u.popLast())}).next(()=>t.store(ds).X({Z:!0},([o,l,u],c)=>{const f=ft(l);return r(f.popLast())}))}bi(e){const t=e.store(fs);return t.X((n,i)=>{const r=_i(i),o=np(this.serializer,r);return t.put(o)})}Di(e,t){const n=t.store(fn),i=[];return n.X((r,o)=>{const l=t.store(no),u=function(_){return _.document?new M(te.fromString(_.document.name).popFirst(5)):_.noDocument?M.fromSegments(_.noDocument.path):_.unknownDocument?M.fromSegments(_.unknownDocument.path):F(36783)}(o).path.toArray(),c={prefixPath:u.slice(0,u.length-2),collectionGroup:u[u.length-2],documentId:u[u.length-1],readTime:o.readTime||[0,0],unknownDocument:o.unknownDocument,noDocument:o.noDocument,document:o.document,hasCommittedMutations:!!o.hasCommittedMutations};i.push(l.put(c))}).next(()=>A.waitFor(i))}Ci(e,t){const n=t.store(rt),i=_p(this.serializer),r=new cu(Ho.Vi,this.serializer.gt);return n.j().next(o=>{const l=new Map;return o.forEach(u=>{var c;let f=(c=l.get(u.userId))!==null&&c!==void 0?c:W();mn(this.serializer,u).keys().forEach(_=>f=f.add(_)),l.set(u.userId,f)}),A.forEach(l,(u,c)=>{const f=new Oe(c),_=$o.yt(this.serializer,f),m=r.getIndexManager(f),I=Qo.yt(f,this.serializer,m,r.referenceDelegate);return new pp(i,I,_,m).recalculateAndSaveOverlaysForDocumentKeys(new il(t,Ke.ue),u).next()})})}}function gd(s){s.createObjectStore(_s,{keyPath:Ly}).createIndex(Kl,Uy,{unique:!0}),s.createObjectStore(fs,{keyPath:"targetId"}).createIndex(Zf,Fy,{unique:!0}),s.createObjectStore(Tn)}const Bt="IndexedDbPersistence",La=18e5,Ua=5e3,Ba="Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.",gI="main";class hu{constructor(e,t,n,i,r,o,l,u,c,f,_=18){if(this.allowTabSynchronization=e,this.persistenceKey=t,this.clientId=n,this.Fi=r,this.window=o,this.document=l,this.Mi=c,this.xi=f,this.Oi=_,this.ui=null,this.ci=!1,this.isPrimary=!1,this.networkEnabled=!0,this.Ni=null,this.inForeground=!1,this.Bi=null,this.Li=null,this.ki=Number.NEGATIVE_INFINITY,this.qi=m=>Promise.resolve(),!hu.C())throw new D(b.UNIMPLEMENTED,"This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");this.referenceDelegate=new iI(this,i),this.Qi=t+gI,this.serializer=new tp(u),this.$i=new zt(this.Qi,this.Oi,new mI(this.serializer)),this.li=new $E,this.hi=new tI(this.referenceDelegate,this.serializer),this.remoteDocumentCache=_p(this.serializer),this.Ti=new WE,this.window&&this.window.localStorage?this.Ui=this.window.localStorage:(this.Ui=null,f===!1&&ye(Bt,"LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."))}start(){return this.Ki().then(()=>{if(!this.isPrimary&&!this.allowTabSynchronization)throw new D(b.FAILED_PRECONDITION,Ba);return this.Wi(),this.Gi(),this.zi(),this.runTransaction("getHighestListenSequenceNumber","readonly",e=>this.hi.getHighestSequenceNumber(e))}).then(e=>{this.ui=new Ke(e,this.Mi)}).then(()=>{this.ci=!0}).catch(e=>(this.$i&&this.$i.close(),Promise.reject(e)))}ji(e){return this.qi=async t=>{if(this.started)return e(t)},e(this.isPrimary)}setDatabaseDeletedListener(e){this.$i.setDatabaseDeletedListener(e)}setNetworkEnabled(e){this.networkEnabled!==e&&(this.networkEnabled=e,this.Fi.enqueueAndForget(async()=>{this.started&&await this.Ki()}))}Ki(){return this.runTransaction("updateClientMetadataAndTryBecomePrimary","readwrite",e=>kr(e).put({clientId:this.clientId,updateTimeMs:Date.now(),networkEnabled:this.networkEnabled,inForeground:this.inForeground}).next(()=>{if(this.isPrimary)return this.Ji(e).next(t=>{t||(this.isPrimary=!1,this.Fi.enqueueRetryable(()=>this.qi(!1)))})}).next(()=>this.Hi(e)).next(t=>this.isPrimary&&!t?this.Yi(e).next(()=>!1):!!t&&this.Zi(e).next(()=>!0))).catch(e=>{if(nn(e))return N(Bt,"Failed to extend owner lease: ",e),this.isPrimary;if(!this.allowTabSynchronization)throw e;return N(Bt,"Releasing owner lease after error during lease refresh",e),!1}).then(e=>{this.isPrimary!==e&&this.Fi.enqueueRetryable(()=>this.qi(e)),this.isPrimary=e})}Ji(e){return oi(e).get(Kn).next(t=>A.resolve(this.Xi(t)))}es(e){return kr(e).delete(this.clientId)}async ts(){if(this.isPrimary&&!this.ns(this.ki,La)){this.ki=Date.now();const e=await this.runTransaction("maybeGarbageCollectMultiClientState","readwrite-primary",t=>{const n=Ae(t,ps);return n.j().next(i=>{const r=this.rs(i,La),o=i.filter(l=>r.indexOf(l)===-1);return A.forEach(o,l=>n.delete(l.clientId)).next(()=>o)})}).catch(()=>[]);if(this.Ui)for(const t of e)this.Ui.removeItem(this.ss(t.clientId))}}zi(){this.Li=this.Fi.enqueueAfterDelay("client_metadata_refresh",4e3,()=>this.Ki().then(()=>this.ts()).then(()=>this.zi()))}Xi(e){return!!e&&e.ownerId===this.clientId}Hi(e){return this.xi?A.resolve(!0):oi(e).get(Kn).next(t=>{if(t!==null&&this.ns(t.leaseTimestampMs,Ua)&&!this._s(t.ownerId)){if(this.Xi(t)&&this.networkEnabled)return!0;if(!this.Xi(t)){if(!t.allowTabSynchronization)throw new D(b.FAILED_PRECONDITION,Ba);return!1}}return!(!this.networkEnabled||!this.inForeground)||kr(e).j().next(n=>this.rs(n,Ua).find(i=>{if(this.clientId!==i.clientId){const r=!this.networkEnabled&&i.networkEnabled,o=!this.inForeground&&i.inForeground,l=this.networkEnabled===i.networkEnabled;if(r||o&&l)return!0}return!1})===void 0)}).next(t=>(this.isPrimary!==t&&N(Bt,`Client ${t?"is":"is not"} eligible for a primary lease.`),t))}async shutdown(){this.ci=!1,this.us(),this.Li&&(this.Li.cancel(),this.Li=null),this.cs(),this.ls(),await this.$i.runTransaction("shutdown","readwrite",[Xi,ps],e=>{const t=new il(e,Ke.ue);return this.Yi(t).next(()=>this.es(t))}),this.$i.close(),this.hs()}rs(e,t){return e.filter(n=>this.ns(n.updateTimeMs,t)&&!this._s(n.clientId))}Ps(){return this.runTransaction("getActiveClients","readonly",e=>kr(e).j().next(t=>this.rs(t,La).map(n=>n.clientId)))}get started(){return this.ci}getGlobalsCache(){return this.li}getMutationQueue(e,t){return Qo.yt(e,this.serializer,t,this.referenceDelegate)}getTargetCache(){return this.hi}getRemoteDocumentCache(){return this.remoteDocumentCache}getIndexManager(e){return new eI(e,this.serializer.gt.databaseId)}getDocumentOverlayCache(e){return $o.yt(this.serializer,e)}getBundleCache(){return this.Ti}runTransaction(e,t,n){N(Bt,"Starting transaction:",e);const i=t==="readonly"?"readonly":"readwrite",r=function(u){return u===18?nE:u===17?o_:u===16?tE:u===15?Ql:u===14?r_:u===13?i_:u===12?eE:u===11?s_:void F(60245)}(this.Oi);let o;return this.$i.runTransaction(e,i,r,l=>(o=new il(l,this.ui?this.ui.next():Ke.ue),t==="readwrite-primary"?this.Ji(o).next(u=>!!u||this.Hi(o)).next(u=>{if(!u)throw ye(`Failed to obtain primary lease for action '${e}'.`),this.isPrimary=!1,this.Fi.enqueueRetryable(()=>this.qi(!1)),new D(b.FAILED_PRECONDITION,$f);return n(o)}).next(u=>this.Zi(o).next(()=>u)):this.Ts(o).next(()=>n(o)))).then(l=>(o.raiseOnCommittedEvent(),l))}Ts(e){return oi(e).get(Kn).next(t=>{if(t!==null&&this.ns(t.leaseTimestampMs,Ua)&&!this._s(t.ownerId)&&!this.Xi(t)&&!(this.xi||this.allowTabSynchronization&&t.allowTabSynchronization))throw new D(b.FAILED_PRECONDITION,Ba)})}Zi(e){const t={ownerId:this.clientId,allowTabSynchronization:this.allowTabSynchronization,leaseTimestampMs:Date.now()};return oi(e).put(Kn,t)}static C(){return zt.C()}Yi(e){const t=oi(e);return t.get(Kn).next(n=>this.Xi(n)?(N(Bt,"Releasing primary lease."),t.delete(Kn)):A.resolve())}ns(e,t){const n=Date.now();return!(e<n-t)&&(!(e>n)||(ye(`Detected an update time that is in the future: ${e} > ${n}`),!1))}Wi(){this.document!==null&&typeof this.document.addEventListener=="function"&&(this.Bi=()=>{this.Fi.enqueueAndForget(()=>(this.inForeground=this.document.visibilityState==="visible",this.Ki()))},this.document.addEventListener("visibilitychange",this.Bi),this.inForeground=this.document.visibilityState==="visible")}cs(){this.Bi&&(this.document.removeEventListener("visibilitychange",this.Bi),this.Bi=null)}Gi(){var e;typeof((e=this.window)===null||e===void 0?void 0:e.addEventListener)=="function"&&(this.Ni=()=>{this.us();const t=/(?:Version|Mobile)\/1[456]/;Pf()&&(navigator.appVersion.match(t)||navigator.userAgent.match(t))&&this.Fi.enterRestrictedMode(!0),this.Fi.enqueueAndForget(()=>this.shutdown())},this.window.addEventListener("pagehide",this.Ni))}ls(){this.Ni&&(this.window.removeEventListener("pagehide",this.Ni),this.Ni=null)}_s(e){var t;try{const n=((t=this.Ui)===null||t===void 0?void 0:t.getItem(this.ss(e)))!==null;return N(Bt,`Client '${e}' ${n?"is":"is not"} zombied in LocalStorage`),n}catch(n){return ye(Bt,"Failed to get zombied client id.",n),!1}}us(){if(this.Ui)try{this.Ui.setItem(this.ss(this.clientId),String(Date.now()))}catch(e){ye("Failed to set zombie client id.",e)}}hs(){if(this.Ui)try{this.Ui.removeItem(this.ss(this.clientId))}catch{}}ss(e){return`firestore_zombie_${this.persistenceKey}_${e}`}}function oi(s){return Ae(s,Xi)}function kr(s){return Ae(s,ps)}function mp(s,e){let t=s.projectId;return s.isDefaultDatabase||(t+="."+s.database),"firestore/"+e+"/"+t+"/"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ap="firestore_clients";function yd(s,e){return`${Ap}_${s}_${e}`}const Rp="firestore_mutations";function Ed(s,e,t){let n=`${Rp}_${s}_${t}`;return e.isAuthenticated()&&(n+=`_${e.uid}`),n}const Cp="firestore_targets";function qa(s,e){return`${Cp}_${s}_${e}`}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ht="SharedClientState";class mo{constructor(e,t,n,i){this.user=e,this.batchId=t,this.state=n,this.error=i}static Ks(e,t,n){const i=JSON.parse(n);let r,o=typeof i=="object"&&["pending","acknowledged","rejected"].indexOf(i.state)!==-1&&(i.error===void 0||typeof i.error=="object");return o&&i.error&&(o=typeof i.error.message=="string"&&typeof i.error.code=="string",o&&(r=new D(i.error.code,i.error.message))),o?new mo(e,t,i.state,r):(ye(ht,`Failed to parse mutation state for ID '${t}': ${n}`),null)}Ws(){const e={state:this.state,updateTimeMs:Date.now()};return this.error&&(e.error={code:this.error.code,message:this.error.message}),JSON.stringify(e)}}class Ai{constructor(e,t,n){this.targetId=e,this.state=t,this.error=n}static Ks(e,t){const n=JSON.parse(t);let i,r=typeof n=="object"&&["not-current","current","rejected"].indexOf(n.state)!==-1&&(n.error===void 0||typeof n.error=="object");return r&&n.error&&(r=typeof n.error.message=="string"&&typeof n.error.code=="string",r&&(i=new D(n.error.code,n.error.message))),r?new Ai(e,n.state,i):(ye(ht,`Failed to parse target state for ID '${e}': ${t}`),null)}Ws(){const e={state:this.state,updateTimeMs:Date.now()};return this.error&&(e.error={code:this.error.code,message:this.error.message}),JSON.stringify(e)}}class go{constructor(e,t){this.clientId=e,this.activeTargetIds=t}static Ks(e,t){const n=JSON.parse(t);let i=typeof n=="object"&&n.activeTargetIds instanceof Array,r=Zl();for(let o=0;i&&o<n.activeTargetIds.length;++o)i=Yf(n.activeTargetIds[o]),r=r.add(n.activeTargetIds[o]);return i?new go(e,r):(ye(ht,`Failed to parse client data for instance '${e}': ${t}`),null)}}class _u{constructor(e,t){this.clientId=e,this.onlineState=t}static Ks(e){const t=JSON.parse(e);return typeof t=="object"&&["Unknown","Online","Offline"].indexOf(t.onlineState)!==-1&&typeof t.clientId=="string"?new _u(t.clientId,t.onlineState):(ye(ht,`Failed to parse online state: ${e}`),null)}}class Il{constructor(){this.activeTargetIds=Zl()}Gs(e){this.activeTargetIds=this.activeTargetIds.add(e)}zs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Ws(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class ja{constructor(e,t,n,i,r){this.window=e,this.Fi=t,this.persistenceKey=n,this.js=i,this.syncEngine=null,this.onlineStateHandler=null,this.sequenceNumberHandler=null,this.Js=this.Hs.bind(this),this.Ys=new _e(G),this.started=!1,this.Zs=[];const o=n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");this.storage=this.window.localStorage,this.currentUser=r,this.Xs=yd(this.persistenceKey,this.js),this.eo=function(u){return`firestore_sequence_number_${u}`}(this.persistenceKey),this.Ys=this.Ys.insert(this.js,new Il),this.no=new RegExp(`^${Ap}_${o}_([^_]*)$`),this.ro=new RegExp(`^${Rp}_${o}_(\\d+)(?:_(.*))?$`),this.io=new RegExp(`^${Cp}_${o}_(\\d+)$`),this.so=function(u){return`firestore_online_state_${u}`}(this.persistenceKey),this.oo=function(u){return`firestore_bundle_loaded_v2_${u}`}(this.persistenceKey),this.window.addEventListener("storage",this.Js)}static C(e){return!(!e||!e.localStorage)}async start(){const e=await this.syncEngine.Ps();for(const n of e){if(n===this.js)continue;const i=this.getItem(yd(this.persistenceKey,n));if(i){const r=go.Ks(n,i);r&&(this.Ys=this.Ys.insert(r.clientId,r))}}this._o();const t=this.storage.getItem(this.so);if(t){const n=this.ao(t);n&&this.uo(n)}for(const n of this.Zs)this.Hs(n);this.Zs=[],this.window.addEventListener("pagehide",()=>this.shutdown()),this.started=!0}writeSequenceNumber(e){this.setItem(this.eo,JSON.stringify(e))}getAllActiveQueryTargets(){return this.co(this.Ys)}isActiveQueryTarget(e){let t=!1;return this.Ys.forEach((n,i)=>{i.activeTargetIds.has(e)&&(t=!0)}),t}addPendingMutation(e){this.lo(e,"pending")}updateMutationState(e,t,n){this.lo(e,t,n),this.ho(e)}addLocalQueryTarget(e,t=!0){let n="not-current";if(this.isActiveQueryTarget(e)){const i=this.storage.getItem(qa(this.persistenceKey,e));if(i){const r=Ai.Ks(e,i);r&&(n=r.state)}}return t&&this.Po.Gs(e),this._o(),n}removeLocalQueryTarget(e){this.Po.zs(e),this._o()}isLocalQueryTarget(e){return this.Po.activeTargetIds.has(e)}clearQueryState(e){this.removeItem(qa(this.persistenceKey,e))}updateQueryState(e,t,n){this.To(e,t,n)}handleUserChange(e,t,n){t.forEach(i=>{this.ho(i)}),this.currentUser=e,n.forEach(i=>{this.addPendingMutation(i)})}setOnlineState(e){this.Io(e)}notifyBundleLoaded(e){this.Eo(e)}shutdown(){this.started&&(this.window.removeEventListener("storage",this.Js),this.removeItem(this.Xs),this.started=!1)}getItem(e){const t=this.storage.getItem(e);return N(ht,"READ",e,t),t}setItem(e,t){N(ht,"SET",e,t),this.storage.setItem(e,t)}removeItem(e){N(ht,"REMOVE",e),this.storage.removeItem(e)}Hs(e){const t=e;if(t.storageArea===this.storage){if(N(ht,"EVENT",t.key,t.newValue),t.key===this.Xs)return void ye("Received WebStorage notification for local change. Another client might have garbage-collected our state");this.Fi.enqueueRetryable(async()=>{if(this.started){if(t.key!==null){if(this.no.test(t.key)){if(t.newValue==null){const n=this.Ao(t.key);return this.Ro(n,null)}{const n=this.Vo(t.key,t.newValue);if(n)return this.Ro(n.clientId,n)}}else if(this.ro.test(t.key)){if(t.newValue!==null){const n=this.mo(t.key,t.newValue);if(n)return this.fo(n)}}else if(this.io.test(t.key)){if(t.newValue!==null){const n=this.po(t.key,t.newValue);if(n)return this.yo(n)}}else if(t.key===this.so){if(t.newValue!==null){const n=this.ao(t.newValue);if(n)return this.uo(n)}}else if(t.key===this.eo){const n=function(r){let o=Ke.ue;if(r!=null)try{const l=JSON.parse(r);U(typeof l=="number",30636,{wo:r}),o=l}catch(l){ye(ht,"Failed to read sequence number from WebStorage",l)}return o}(t.newValue);n!==Ke.ue&&this.sequenceNumberHandler(n)}else if(t.key===this.oo){const n=this.So(t.newValue);await Promise.all(n.map(i=>this.syncEngine.bo(i)))}}}else this.Zs.push(t)})}}get Po(){return this.Ys.get(this.js)}_o(){this.setItem(this.Xs,this.Po.Ws())}lo(e,t,n){const i=new mo(this.currentUser,e,t,n),r=Ed(this.persistenceKey,this.currentUser,e);this.setItem(r,i.Ws())}ho(e){const t=Ed(this.persistenceKey,this.currentUser,e);this.removeItem(t)}Io(e){const t={clientId:this.js,onlineState:e};this.storage.setItem(this.so,JSON.stringify(t))}To(e,t,n){const i=qa(this.persistenceKey,e),r=new Ai(e,t,n);this.setItem(i,r.Ws())}Eo(e){const t=JSON.stringify(Array.from(e));this.setItem(this.oo,t)}Ao(e){const t=this.no.exec(e);return t?t[1]:null}Vo(e,t){const n=this.Ao(e);return go.Ks(n,t)}mo(e,t){const n=this.ro.exec(e),i=Number(n[1]),r=n[2]!==void 0?n[2]:null;return mo.Ks(new Oe(r),i,t)}po(e,t){const n=this.io.exec(e),i=Number(n[1]);return Ai.Ks(i,t)}ao(e){return _u.Ks(e)}So(e){return JSON.parse(e)}async fo(e){if(e.user.uid===this.currentUser.uid)return this.syncEngine.Do(e.batchId,e.state,e.error);N(ht,`Ignoring mutation for non-active user ${e.user.uid}`)}yo(e){return this.syncEngine.vo(e.targetId,e.state,e.error)}Ro(e,t){const n=t?this.Ys.insert(e,t):this.Ys.remove(e),i=this.co(this.Ys),r=this.co(n),o=[],l=[];return r.forEach(u=>{i.has(u)||o.push(u)}),i.forEach(u=>{r.has(u)||l.push(u)}),this.syncEngine.Co(o,l).then(()=>{this.Ys=n})}uo(e){this.Ys.get(e.clientId)&&this.onlineStateHandler(e.onlineState)}co(e){let t=Zl();return e.forEach((n,i)=>{t=t.unionWith(i.activeTargetIds)}),t}}class Sp{constructor(){this.Fo=new Il,this.Mo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e,t=!0){return t&&this.Fo.Gs(e),this.Mo[e]||"not-current"}updateQueryState(e,t,n){this.Mo[e]=t}removeLocalQueryTarget(e){this.Fo.zs(e)}isLocalQueryTarget(e){return this.Fo.activeTargetIds.has(e)}clearQueryState(e){delete this.Mo[e]}getAllActiveQueryTargets(){return this.Fo.activeTargetIds}isActiveQueryTarget(e){return this.Fo.activeTargetIds.has(e)}start(){return this.Fo=new Il,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Or=null;function vl(){return Or===null?Or=function(){return 268435456+Math.round(2147483648*Math.random())}():Or++,"0x"+Or.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ga="RestConnection",CI={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class SI{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${n}/databases/${i}`,this.Ko=this.databaseId.database===io?`project_id=${n}`:`project_id=${n}&database_id=${i}`}Wo(e,t,n,i,r){const o=vl(),l=this.Go(e,t.toUriEncodedString());N(Ga,`Sending RPC '${e}' ${o}:`,l,n);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(u,i,r);const{host:c}=new URL(l),f=Do(c);return this.jo(e,l,u,n,f).then(_=>(N(Ga,`Received RPC '${e}' ${o}: `,_),_),_=>{throw Qt(Ga,`RPC '${e}' ${o} failed with error: `,_,"url: ",l,"request:",n),_})}Jo(e,t,n,i,r,o){return this.Wo(e,t,n,i,r)}zo(e,t,n){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+xs}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((i,r)=>e[r]=i),n&&n.headers.forEach((i,r)=>e[r]=i)}Go(e,t){const n=CI[e];return`${this.$o}/v1/${t}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yo(s){return new OE(s,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nn="RemoteStore";class OI{constructor(e,t,n,i,r){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=r,this.Ea.xo(o=>{n.enqueueAndForget(async()=>{Ln(this)&&(N(Nn,"Restarting streams for network reachability change."),await async function(u){const c=L(u);c.Ia.add(4),await nr(c),c.Aa.set("Unknown"),c.Ia.delete(4),await Xo(c)}(this))})}),this.Aa=new kI(n,i)}}async function Xo(s){if(Ln(s))for(const e of s.da)await e(!0)}async function nr(s){for(const e of s.da)await e(!1)}function Jo(s,e){const t=L(s);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),gu(t)?mu(t):Os(t).x_()&&pu(t,e))}function Rs(s,e){const t=L(s),n=Os(t);t.Ta.delete(e),n.x_()&&xp(t,e),t.Ta.size===0&&(n.x_()?n.B_():Ln(t)&&t.Aa.set("Unknown"))}function pu(s,e){if(s.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(q.min())>0){const t=s.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Os(s).H_(e)}function xp(s,e){s.Ra.$e(e),Os(s).Y_(e)}function mu(s){s.Ra=new xE({getRemoteKeysForTarget:e=>s.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>s.Ta.get(e)||null,lt:()=>s.datastore.serializer.databaseId}),Os(s).start(),s.Aa.aa()}function gu(s){return Ln(s)&&!Os(s).M_()&&s.Ta.size>0}function Ln(s){return L(s).Ia.size===0}function Np(s){s.Ra=void 0}async function MI(s){s.Aa.set("Online")}async function FI(s){s.Ta.forEach((e,t)=>{pu(s,e)})}async function LI(s,e){Np(s),gu(s)?(s.Aa.la(e),mu(s)):s.Aa.set("Unknown")}async function UI(s,e,t){if(s.Aa.set("Online"),e instanceof G_&&e.state===2&&e.cause)try{await async function(i,r){const o=r.cause;for(const l of r.targetIds)i.Ta.has(l)&&(await i.remoteSyncer.rejectListen(l,o),i.Ta.delete(l),i.Ra.removeTarget(l))}(s,e)}catch(n){N(Nn,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await yo(s,n)}else if(e instanceof Wr?s.Ra.Ye(e):e instanceof j_?s.Ra.it(e):s.Ra.et(e),!t.isEqual(q.min()))try{const n=await Ip(s.localStore);t.compareTo(n)>=0&&await function(r,o){const l=r.Ra.Pt(o);return l.targetChanges.forEach((u,c)=>{if(u.resumeToken.approximateByteSize()>0){const f=r.Ta.get(c);f&&r.Ta.set(c,f.withResumeToken(u.resumeToken,o))}}),l.targetMismatches.forEach((u,c)=>{const f=r.Ta.get(u);if(!f)return;r.Ta.set(u,f.withResumeToken(Ie.EMPTY_BYTE_STRING,f.snapshotVersion)),xp(r,u);const _=new wt(f.target,u,c,f.sequenceNumber);pu(r,_)}),r.remoteSyncer.applyRemoteEvent(l)}(s,t)}catch(n){N(Nn,"Failed to raise snapshot:",n),await yo(s,n)}}async function yo(s,e,t){if(!nn(e))throw e;s.Ia.add(1),await nr(s),s.Aa.set("Offline"),t||(t=()=>Ip(s.localStore)),s.asyncQueue.enqueueRetryable(async()=>{N(Nn,"Retrying IndexedDB access"),await t(),s.Ia.delete(1),await Xo(s)})}function Dp(s,e){return e().catch(t=>yo(s,t,e))}async function ks(s){const e=L(s),t=Xt(e);let n=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:vn;for(;BI(e);)try{const i=await AI(e.localStore,n);if(i===null){e.Pa.length===0&&t.B_();break}n=i.batchId,qI(e,i)}catch(i){await yo(e,i)}kp(e)&&Op(e)}function BI(s){return Ln(s)&&s.Pa.length<10}function qI(s,e){s.Pa.push(e);const t=Xt(s);t.x_()&&t.Z_&&t.X_(e.mutations)}function kp(s){return Ln(s)&&!Xt(s).M_()&&s.Pa.length>0}function Op(s){Xt(s).start()}async function jI(s){Xt(s).na()}async function GI(s){const e=Xt(s);for(const t of s.Pa)e.X_(t.mutations)}async function zI(s,e,t){const n=s.Pa.shift(),i=su.from(n,e,t);await Dp(s,()=>s.remoteSyncer.applySuccessfulWrite(i)),await ks(s)}async function KI(s,e){e&&Xt(s).Z_&&await async function(n,i){if(function(o){return bE(o)&&o!==b.ABORTED}(i.code)){const r=n.Pa.shift();Xt(n).N_(),await Dp(n,()=>n.remoteSyncer.rejectFailedWrite(r.batchId,i)),await ks(n)}}(s,e),kp(s)&&Op(s)}async function wd(s,e){const t=L(s);t.asyncQueue.verifyOperationInProgress(),N(Nn,"RemoteStore received new credentials");const n=Ln(t);t.Ia.add(3),await nr(t),n&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await Xo(t)}async function Tl(s,e){const t=L(s);e?(t.Ia.delete(2),await Xo(t)):e||(t.Ia.add(2),await nr(t),t.Aa.set("Unknown"))}function Os(s){return s.Va||(s.Va=function(t,n,i){const r=L(t);return r.ia(),new VI(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)}(s.datastore,s.asyncQueue,{Zo:MI.bind(null,s),e_:FI.bind(null,s),n_:LI.bind(null,s),J_:UI.bind(null,s)}),s.da.push(async e=>{e?(s.Va.N_(),gu(s)?mu(s):s.Aa.set("Unknown")):(await s.Va.stop(),Np(s))})),s.Va}function Xt(s){return s.ma||(s.ma=function(t,n,i){const r=L(t);return r.ia(),new xI(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,i)}(s.datastore,s.asyncQueue,{Zo:()=>Promise.resolve(),e_:jI.bind(null,s),n_:KI.bind(null,s),ea:GI.bind(null,s),ta:zI.bind(null,s)}),s.da.push(async e=>{e?(s.ma.N_(),await ks(s)):(await s.ma.stop(),s.Pa.length>0&&(N(Nn,`Stopping write stream with ${s.Pa.length} pending writes`),s.Pa=[]))})),s.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Up{constructor(e){this.key=e}}class Bp{constructor(e){this.key=e}}class YI{constructor(e,t){this.query=e,this.Ha=t,this.Ya=null,this.hasCachedResults=!1,this.current=!1,this.Za=W(),this.mutatedKeys=W(),this.Xa=P_(e),this.eu=new rs(this.Xa)}get tu(){return this.Ha}nu(e,t){const n=t?t.ru:new Ad,i=t?t.eu:this.eu;let r=t?t.mutatedKeys:this.mutatedKeys,o=i,l=!1;const u=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,c=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((f,_)=>{const m=i.get(f),I=Zi(this.query,_)?_:null,S=!!m&&this.mutatedKeys.has(m.key),V=!!I&&(I.hasLocalMutations||this.mutatedKeys.has(I.key)&&I.hasCommittedMutations);let x=!1;m&&I?m.data.isEqual(I.data)?S!==V&&(n.track({type:3,doc:I}),x=!0):this.iu(m,I)||(n.track({type:2,doc:I}),x=!0,(u&&this.Xa(I,u)>0||c&&this.Xa(I,c)<0)&&(l=!0)):!m&&I?(n.track({type:0,doc:I}),x=!0):m&&!I&&(n.track({type:1,doc:m}),x=!0,(u||c)&&(l=!0)),x&&(I?(o=o.add(I),r=V?r.add(f):r.delete(f)):(o=o.delete(f),r=r.delete(f)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const f=this.query.limitType==="F"?o.last():o.first();o=o.delete(f.key),r=r.delete(f.key),n.track({type:1,doc:f})}return{eu:o,ru:n,Ds:l,mutatedKeys:r}}iu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n,i){const r=this.eu;this.eu=e.eu,this.mutatedKeys=e.mutatedKeys;const o=e.ru.pa();o.sort((f,_)=>function(I,S){const V=x=>{switch(x){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return F(20277,{At:x})}};return V(I)-V(S)}(f.type,_.type)||this.Xa(f.doc,_.doc)),this.su(n),i=i!=null&&i;const l=t&&!i?this.ou():[],u=this.Za.size===0&&this.current&&!i?1:0,c=u!==this.Ya;return this.Ya=u,o.length!==0||c?{snapshot:new Cs(this.query,e.eu,r,o,e.mutatedKeys,u===0,c,!1,!!n&&n.resumeToken.approximateByteSize()>0),_u:l}:{_u:l}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({eu:this.eu,ru:new Ad,mutatedKeys:this.mutatedKeys,Ds:!1},!1)):{_u:[]}}au(e){return!this.Ha.has(e)&&!!this.eu.has(e)&&!this.eu.get(e).hasLocalMutations}su(e){e&&(e.addedDocuments.forEach(t=>this.Ha=this.Ha.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ha=this.Ha.delete(t)),this.current=e.current)}ou(){if(!this.current)return[];const e=this.Za;this.Za=W(),this.eu.forEach(n=>{this.au(n.key)&&(this.Za=this.Za.add(n.key))});const t=[];return e.forEach(n=>{this.Za.has(n)||t.push(new Bp(n))}),this.Za.forEach(n=>{e.has(n)||t.push(new Up(n))}),t}uu(e){this.Ha=e.qs,this.Za=W();const t=this.nu(e.documents);return this.applyChanges(t,!0)}cu(){return Cs.fromInitialDocuments(this.query,this.eu,this.mutatedKeys,this.Ya===0,this.hasCachedResults)}}const Ms="SyncEngine";class XI{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class JI{constructor(e){this.key=e,this.lu=!1}}class ZI{constructor(e,t,n,i,r,o){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=i,this.currentUser=r,this.maxConcurrentLimboResolutions=o,this.hu={},this.Pu=new xt(l=>C_(l),zo),this.Tu=new Map,this.Iu=new Set,this.du=new _e(M.comparator),this.Eu=new Map,this.Au=new uu,this.Ru={},this.Vu=new Map,this.mu=xn.ur(),this.onlineState="Unknown",this.fu=void 0}get isPrimaryClient(){return this.fu===!0}}async function ev(s,e,t=!0){const n=Zo(s);let i;const r=n.Pu.get(e);return r?(n.sharedClientState.addLocalQueryTarget(r.targetId),i=r.view.cu()):i=await qp(n,e,t,!0),i}async function tv(s,e){const t=Zo(s);await qp(t,e,!0,!1)}async function qp(s,e,t,n){const i=await po(s.localStore,et(e)),r=i.targetId,o=s.sharedClientState.addLocalQueryTarget(r,t);let l;return n&&(l=await vu(s,e,r,o==="current",i.resumeToken)),s.isPrimaryClient&&t&&Jo(s.remoteStore,i),l}async function vu(s,e,t,n,i){s.gu=(_,m,I)=>async function(V,x,K,j){let B=x.view.nu(K);B.Ds&&(B=await El(V.localStore,x.query,!1).then(({documents:v})=>x.view.nu(v,B)));const J=j&&j.targetChanges.get(x.targetId),le=j&&j.targetMismatches.get(x.targetId)!=null,Z=x.view.applyChanges(B,V.isPrimaryClient,J,le);return Al(V,x.targetId,Z._u),Z.snapshot}(s,_,m,I);const r=await El(s.localStore,e,!0),o=new YI(e,r.qs),l=o.nu(r.documents),u=tr.createSynthesizedTargetChangeForCurrentChange(t,n&&s.onlineState!=="Offline",i),c=o.applyChanges(l,s.isPrimaryClient,u);Al(s,t,c._u);const f=new XI(e,t,o);return s.Pu.set(e,f),s.Tu.has(t)?s.Tu.get(t).push(e):s.Tu.set(t,[e]),c.snapshot}async function nv(s,e,t){const n=L(s),i=n.Pu.get(e),r=n.Tu.get(i.targetId);if(r.length>1)return n.Tu.set(i.targetId,r.filter(o=>!zo(o,e))),void n.Pu.delete(e);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(i.targetId),n.sharedClientState.isActiveQueryTarget(i.targetId)||await As(n.localStore,i.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(i.targetId),t&&Rs(n.remoteStore,i.targetId),Ss(n,i.targetId)}).catch(tn)):(Ss(n,i.targetId),await As(n.localStore,i.targetId,!0))}async function sv(s,e){const t=L(s),n=t.Pu.get(e),i=t.Tu.get(n.targetId);t.isPrimaryClient&&i.length===1&&(t.sharedClientState.removeLocalQueryTarget(n.targetId),Rs(t.remoteStore,n.targetId))}async function iv(s,e,t){const n=Ru(s);try{const i=await function(o,l){const u=L(o),c=se.now(),f=l.reduce((I,S)=>I.add(S.key),W());let _,m;return u.persistence.runTransaction("Locally write mutations","readwrite",I=>{let S=Ze(),V=W();return u.Os.getEntries(I,f).next(x=>{S=x,S.forEach((K,j)=>{j.isValidDocument()||(V=V.add(K))})}).next(()=>u.localDocuments.getOverlayedDocuments(I,S)).next(x=>{_=x;const K=[];for(const j of l){const B=SE(j,_.get(j.key).overlayedDocument);B!=null&&K.push(new Nt(j.key,B,m_(B.value.mapValue),Ge.exists(!0)))}return u.mutationQueue.addMutationBatch(I,c,K,l)}).next(x=>{m=x;const K=x.applyToLocalDocumentSet(_,V);return u.documentOverlayCache.saveOverlays(I,x.batchId,K)})}).then(()=>({batchId:m.batchId,changes:V_(_)}))}(n.localStore,e);n.sharedClientState.addPendingMutation(i.batchId),function(o,l,u){let c=o.Ru[o.currentUser.toKey()];c||(c=new _e(G)),c=c.insert(l,u),o.Ru[o.currentUser.toKey()]=c}(n,i.batchId,t),await rn(n,i.changes),await ks(n.remoteStore)}catch(i){const r=Eu(i,"Failed to persist write");t.reject(r)}}async function jp(s,e){const t=L(s);try{const n=await TI(t.localStore,e);e.targetChanges.forEach((i,r)=>{const o=t.Eu.get(r);o&&(U(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1,22616),i.addedDocuments.size>0?o.lu=!0:i.modifiedDocuments.size>0?U(o.lu,14607):i.removedDocuments.size>0&&(U(o.lu,42227),o.lu=!1))}),await rn(t,n,e)}catch(n){await tn(n)}}function Sd(s,e,t){const n=L(s);if(n.isPrimaryClient&&t===0||!n.isPrimaryClient&&t===1){const i=[];n.Pu.forEach((r,o)=>{const l=o.view.va(e);l.snapshot&&i.push(l.snapshot)}),function(o,l){const u=L(o);u.onlineState=l;let c=!1;u.queries.forEach((f,_)=>{for(const m of _.wa)m.va(l)&&(c=!0)}),c&&Iu(u)}(n.eventManager,e),i.length&&n.hu.J_(i),n.onlineState=e,n.isPrimaryClient&&n.sharedClientState.setOnlineState(e)}}async function rv(s,e,t){const n=L(s);n.sharedClientState.updateQueryState(e,"rejected",t);const i=n.Eu.get(e),r=i&&i.key;if(r){let o=new _e(M.comparator);o=o.insert(r,me.newNoDocument(r,q.min()));const l=W().add(r),u=new er(q.min(),new Map,new _e(G),o,l);await jp(n,u),n.du=n.du.remove(r),n.Eu.delete(e),Au(n)}else await As(n.localStore,e,!1).then(()=>Ss(n,e,t)).catch(tn)}async function ov(s,e){const t=L(s),n=e.batch.batchId;try{const i=await vI(t.localStore,e);wu(t,n,null),Tu(t,n),t.sharedClientState.updateMutationState(n,"acknowledged"),await rn(t,i)}catch(i){await tn(i)}}async function av(s,e,t){const n=L(s);try{const i=await function(o,l){const u=L(o);return u.persistence.runTransaction("Reject batch","readwrite-primary",c=>{let f;return u.mutationQueue.lookupMutationBatch(c,l).next(_=>(U(_!==null,37113),f=_.keys(),u.mutationQueue.removeMutationBatch(c,_))).next(()=>u.mutationQueue.performConsistencyCheck(c)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(c,f,l)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(c,f)).next(()=>u.localDocuments.getDocuments(c,f))})}(n.localStore,e);wu(n,e,t),Tu(n,e),n.sharedClientState.updateMutationState(e,"rejected",t),await rn(n,i)}catch(i){await tn(i)}}function Tu(s,e){(s.Vu.get(e)||[]).forEach(t=>{t.resolve()}),s.Vu.delete(e)}function wu(s,e,t){const n=L(s);let i=n.Ru[n.currentUser.toKey()];if(i){const r=i.get(e);r&&(t?r.reject(t):r.resolve(),i=i.remove(e)),n.Ru[n.currentUser.toKey()]=i}}function Ss(s,e,t=null){s.sharedClientState.removeLocalQueryTarget(e);for(const n of s.Tu.get(e))s.Pu.delete(n),t&&s.hu.pu(n,t);s.Tu.delete(e),s.isPrimaryClient&&s.Au.zr(e).forEach(n=>{s.Au.containsKey(n)||Gp(s,n)})}function Gp(s,e){s.Iu.delete(e.path.canonicalString());const t=s.du.get(e);t!==null&&(Rs(s.remoteStore,t),s.du=s.du.remove(e),s.Eu.delete(t),Au(s))}function Al(s,e,t){for(const n of t)n instanceof Up?(s.Au.addReference(n.key,e),lv(s,n)):n instanceof Bp?(N(Ms,"Document no longer in limbo: "+n.key),s.Au.removeReference(n.key,e),s.Au.containsKey(n.key)||Gp(s,n.key)):F(19791,{yu:n})}function lv(s,e){const t=e.key,n=t.path.canonicalString();s.du.get(t)||s.Iu.has(n)||(N(Ms,"New document in limbo: "+t),s.Iu.add(n),Au(s))}function Au(s){for(;s.Iu.size>0&&s.du.size<s.maxConcurrentLimboResolutions;){const e=s.Iu.values().next().value;s.Iu.delete(e);const t=new M(te.fromString(e)),n=s.mu.next();s.Eu.set(n,new JI(t)),s.du=s.du.insert(t,n),Jo(s.remoteStore,new wt(et(Go(t.path)),n,"TargetPurposeLimboResolution",Ke.ue))}}async function rn(s,e,t){const n=L(s),i=[],r=[],o=[];n.Pu.isEmpty()||(n.Pu.forEach((l,u)=>{o.push(n.gu(u,e,t).then(c=>{var f;if((c||t)&&n.isPrimaryClient){const _=c?!c.fromCache:(f=t==null?void 0:t.targetChanges.get(u.targetId))===null||f===void 0?void 0:f.current;n.sharedClientState.updateQueryState(u.targetId,_?"current":"not-current")}if(c){i.push(c);const _=du.Es(u.targetId,c);r.push(_)}}))}),await Promise.all(o),n.hu.J_(i),await async function(u,c){const f=L(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",_=>A.forEach(c,m=>A.forEach(m.Is,I=>f.persistence.referenceDelegate.addReference(_,m.targetId,I)).next(()=>A.forEach(m.ds,I=>f.persistence.referenceDelegate.removeReference(_,m.targetId,I)))))}catch(_){if(!nn(_))throw _;N(fu,"Failed to update sequence numbers: "+_)}for(const _ of c){const m=_.targetId;if(!_.fromCache){const I=f.Fs.get(m),S=I.snapshotVersion,V=I.withLastLimboFreeSnapshotVersion(S);f.Fs=f.Fs.insert(m,V)}}}(n.localStore,r))}async function uv(s,e){const t=L(s);if(!t.currentUser.isEqual(e)){N(Ms,"User change. New user:",e.toKey());const n=await Ep(t.localStore,e);t.currentUser=e,function(r,o){r.Vu.forEach(l=>{l.forEach(u=>{u.reject(new D(b.CANCELLED,o))})}),r.Vu.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,n.removedBatchIds,n.addedBatchIds),await rn(t,n.Bs)}}function cv(s,e){const t=L(s),n=t.Eu.get(e);if(n&&n.lu)return W().add(n.key);{let i=W();const r=t.Tu.get(e);if(!r)return i;for(const o of r){const l=t.Pu.get(o);i=i.unionWith(l.view.tu)}return i}}async function hv(s,e){const t=L(s),n=await El(t.localStore,e.query,!0),i=e.view.uu(n);return t.isPrimaryClient&&Al(t,e.targetId,i._u),i}async function dv(s,e){const t=L(s);return Tp(t.localStore,e).then(n=>rn(t,n))}async function fv(s,e,t,n){const i=L(s),r=await function(l,u){const c=L(l),f=L(c.mutationQueue);return c.persistence.runTransaction("Lookup mutation documents","readonly",_=>f.Xn(_,u).next(m=>m?c.localDocuments.getDocuments(_,m):A.resolve(null)))}(i.localStore,e);r!==null?(t==="pending"?await ks(i.remoteStore):t==="acknowledged"||t==="rejected"?(wu(i,e,n||null),Tu(i,e),function(l,u){L(L(l).mutationQueue).rr(u)}(i.localStore,e)):F(6720,"Unknown batchState",{wu:t}),await rn(i,r)):N(Ms,"Cannot apply mutation batch with id: "+e)}async function _v(s,e){const t=L(s);if(Zo(t),Ru(t),e===!0&&t.fu!==!0){const n=t.sharedClientState.getAllActiveQueryTargets(),i=await Pd(t,n.toArray());t.fu=!0,await Tl(t.remoteStore,!0);for(const r of i)Jo(t.remoteStore,r)}else if(e===!1&&t.fu!==!1){const n=[];let i=Promise.resolve();t.Tu.forEach((r,o)=>{t.sharedClientState.isLocalQueryTarget(o)?n.push(o):i=i.then(()=>(Ss(t,o),As(t.localStore,o,!0))),Rs(t.remoteStore,o)}),await i,await Pd(t,n),function(o){const l=L(o);l.Eu.forEach((u,c)=>{Rs(l.remoteStore,c)}),l.Au.jr(),l.Eu=new Map,l.du=new _e(M.comparator)}(t),t.fu=!1,await Tl(t.remoteStore,!1)}}async function Pd(s,e,t){const n=L(s),i=[],r=[];for(const o of e){let l;const u=n.Tu.get(o);if(u&&u.length!==0){l=await po(n.localStore,et(u[0]));for(const c of u){const f=n.Pu.get(c),_=await hv(n,f);_.snapshot&&r.push(_.snapshot)}}else{const c=await vp(n.localStore,o);l=await po(n.localStore,c),await vu(n,zp(c),o,!1,l.resumeToken)}i.push(l)}return n.hu.J_(r),i}function zp(s){return A_(s.path,s.collectionGroup,s.orderBy,s.filters,s.limit,"F",s.startAt,s.endAt)}function pv(s){return function(t){return L(L(t).persistence).Ps()}(L(s).localStore)}async function mv(s,e,t,n){const i=L(s);if(i.fu)return void N(Ms,"Ignoring unexpected query state notification.");const r=i.Tu.get(e);if(r&&r.length>0)switch(t){case"current":case"not-current":{const o=await Tp(i.localStore,S_(r[0])),l=er.createSynthesizedRemoteEventForCurrentChange(e,t==="current",Ie.EMPTY_BYTE_STRING);await rn(i,o,l);break}case"rejected":await As(i.localStore,e,!0),Ss(i,e,n);break;default:F(64155,t)}}async function gv(s,e,t){const n=Zo(s);if(n.fu){for(const i of e){if(n.Tu.has(i)&&n.sharedClientState.isActiveQueryTarget(i)){N(Ms,"Adding an already active target "+i);continue}const r=await vp(n.localStore,i),o=await po(n.localStore,r);await vu(n,zp(r),o.targetId,!1,o.resumeToken),Jo(n.remoteStore,o)}for(const i of t)n.Tu.has(i)&&await As(n.localStore,i,!1).then(()=>{Rs(n.remoteStore,i),Ss(n,i)}).catch(tn)}}function Zo(s){const e=L(s);return e.remoteStore.remoteSyncer.applyRemoteEvent=jp.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=cv.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=rv.bind(null,e),e.hu.J_=QI.bind(null,e.eventManager),e.hu.pu=HI.bind(null,e.eventManager),e}function Ru(s){const e=L(s);return e.remoteStore.remoteSyncer.applySuccessfulWrite=ov.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=av.bind(null,e),e}class qi{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Yo(e.databaseInfo.databaseId),this.sharedClientState=this.bu(e),this.persistence=this.Du(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Cu(e,this.localStore),this.indexBackfillerScheduler=this.Fu(e,this.localStore)}Cu(e,t){return null}Fu(e,t){return null}vu(e){return yp(this.persistence,new gp,e.initialUser,this.serializer)}Du(e){return new cu(Ho.Vi,this.serializer)}bu(e){return new Sp}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}qi.provider={build:()=>new qi};class yv extends qi{constructor(e){super(),this.cacheSizeBytes=e}Cu(e,t){U(this.persistence.referenceDelegate instanceof _o,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new hp(n,e.asyncQueue,t)}Du(e){const t=this.cacheSizeBytes!==void 0?Me.withCacheSize(this.cacheSizeBytes):Me.DEFAULT;return new cu(n=>_o.Vi(n,t),this.serializer)}}class Kp extends qi{constructor(e,t,n){super(),this.Mu=e,this.cacheSizeBytes=t,this.forceOwnership=n,this.kind="persistent",this.synchronizeTabs=!1}async initialize(e){await super.initialize(e),await this.Mu.initialize(this,e),await Ru(this.Mu.syncEngine),await ks(this.Mu.remoteStore),await this.persistence.ji(()=>(this.gcScheduler&&!this.gcScheduler.started&&this.gcScheduler.start(),this.indexBackfillerScheduler&&!this.indexBackfillerScheduler.started&&this.indexBackfillerScheduler.start(),Promise.resolve()))}vu(e){return yp(this.persistence,new gp,e.initialUser,this.serializer)}Cu(e,t){const n=this.persistence.referenceDelegate.garbageCollector;return new hp(n,e.asyncQueue,t)}Fu(e,t){const n=new Vy(t,this.persistence);return new by(e.asyncQueue,n)}Du(e){const t=mp(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey),n=this.cacheSizeBytes!==void 0?Me.withCacheSize(this.cacheSizeBytes):Me.DEFAULT;return new hu(this.synchronizeTabs,t,e.clientId,n,e.asyncQueue,Pp(),Qr(),this.serializer,this.sharedClientState,!!this.forceOwnership)}bu(e){return new Sp}}class Ev extends Kp{constructor(e,t){super(e,t,!1),this.Mu=e,this.cacheSizeBytes=t,this.synchronizeTabs=!0}async initialize(e){await super.initialize(e);const t=this.Mu.syncEngine;this.sharedClientState instanceof ja&&(this.sharedClientState.syncEngine={Do:fv.bind(null,t),vo:mv.bind(null,t),Co:gv.bind(null,t),Ps:pv.bind(null,t),bo:dv.bind(null,t)},await this.sharedClientState.start()),await this.persistence.ji(async n=>{await _v(this.Mu.syncEngine,n),this.gcScheduler&&(n&&!this.gcScheduler.started?this.gcScheduler.start():n||this.gcScheduler.stop()),this.indexBackfillerScheduler&&(n&&!this.indexBackfillerScheduler.started?this.indexBackfillerScheduler.start():n||this.indexBackfillerScheduler.stop())})}bu(e){const t=Pp();if(!ja.C(t))throw new D(b.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.");const n=mp(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey);return new ja(t,e.asyncQueue,n,e.clientId,e.initialUser)}}class ji{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>Sd(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=uv.bind(null,this.syncEngine),await Tl(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new $I}()}createDatastore(e){const t=Yo(e.databaseInfo.databaseId),n=function(r){return new bI(r)}(e.databaseInfo);return function(r,o,l,u){return new DI(r,o,l,u)}(e.authCredentials,e.appCheckCredentials,n,t)}createRemoteStore(e){return function(n,i,r,o,l){return new OI(n,i,r,o,l)}(this.localStore,this.datastore,e.asyncQueue,t=>Sd(this.syncEngine,t,0),function(){return vd.C()?new vd:new RI}())}createSyncEngine(e,t){return function(i,r,o,l,u,c,f){const _=new ZI(i,r,o,l,u,c);return f&&(_.fu=!0),_}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(i){const r=L(i);N(Nn,"RemoteStore shutting down."),r.Ia.add(5),await nr(r),r.Ea.shutdown(),r.Aa.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}ji.provider={build:()=>new ji};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nm(s){if(s.limitType==="L"&&s.explicitOrderBy.length===0)throw new D(b.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Nu{}class Du extends Nu{}function nR(s,e,...t){let n=[];e instanceof Nu&&n.push(e),n=n.concat(t),function(r){const o=r.filter(u=>u instanceof ku).length,l=r.filter(u=>u instanceof ra).length;if(o>1||o>0&&l>0)throw new D(b.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(n);for(const i of n)s=i._apply(s);return s}class ra extends Du{constructor(e,t,n){super(),this._field=e,this._op=t,this._value=n,this.type="where"}static _create(e,t,n){return new ra(e,t,n)}_apply(e){const t=this._parse(e);return sm(e._query,t),new Dt(e.firestore,e.converter,hl(e._query,t))}_parse(e){const t=na(e.firestore);return function(r,o,l,u,c,f,_){let m;if(c.isKeyField()){if(f==="array-contains"||f==="array-contains-any")throw new D(b.INVALID_ARGUMENT,`Invalid Query. You can't perform '${f}' queries on documentId().`);if(f==="in"||f==="not-in"){Ld(_,f);const S=[];for(const V of _)S.push(Fd(u,r,V));m={arrayValue:{values:S}}}else m=Fd(u,r,_)}else f!=="in"&&f!=="not-in"&&f!=="array-contains-any"||Ld(_,f),m=Nv(l,o,_,f==="in"||f==="not-in");return Y.create(c,f,m)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}function sR(s,e,t){const n=e,i=ia("where",s);return ra._create(i,n,t)}class ku extends Nu{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new ku(e,t)}_parse(e){const t=this._queryConstraints.map(n=>n._parse(e)).filter(n=>n.getFilters().length>0);return t.length===1?t[0]:ie.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(i,r){let o=i;const l=r.getFlattenedFilters();for(const u of l)sm(o,u),o=hl(o,u)}(e._query,t),new Dt(e.firestore,e.converter,hl(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class Ou extends Du{constructor(e,t){super(),this._field=e,this._direction=t,this.type="orderBy"}static _create(e,t){return new Ou(e,t)}_apply(e){const t=function(i,r,o){if(i.startAt!==null)throw new D(b.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(i.endAt!==null)throw new D(b.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new Ui(r,o)}(e._query,this._field,this._direction);return new Dt(e.firestore,e.converter,function(i,r){const o=i.explicitOrderBy.concat([r]);return new Ns(i.path,i.collectionGroup,o,i.filters.slice(),i.limit,i.limitType,i.startAt,i.endAt)}(e._query,t))}}function iR(s,e="asc"){const t=e,n=ia("orderBy",s);return Ou._create(n,t)}class Mu extends Du{constructor(e,t,n){super(),this.type=e,this._limit=t,this._limitType=n}static _create(e,t,n){return new Mu(e,t,n)}_apply(e){return new Dt(e.firestore,e.converter,ao(e._query,this._limit,this._limitType))}}function rR(s){return Mu._create("limit",s,"F")}function Fd(s,e,t){if(typeof(t=He(t))=="string"){if(t==="")throw new D(b.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!R_(e)&&t.indexOf("/")!==-1)throw new D(b.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const n=e.path.child(te.fromString(t));if(!M.isDocumentKey(n))throw new D(b.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${n}' is not because it has an odd number of segments (${n.length}).`);return Fi(s,new M(n))}if(t instanceof Ee)return Fi(s,t._key);throw new D(b.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Oo(t)}.`)}function Ld(s,e){if(!Array.isArray(s)||s.length===0)throw new D(b.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function sm(s,e){const t=function(i,r){for(const o of i)for(const l of o.getFlattenedFilters())if(r.indexOf(l.op)>=0)return l.op;return null}(s.filters,function(i){switch(i){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new D(b.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new D(b.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class Ov{convertValue(e,t="none"){switch(Ht(e)){case 0:return null;case 1:return e.booleanValue;case 2:return de(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(Pt(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw F(62114,{value:e})}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const n={};return sn(e,(i,r)=>{n[i]=this.convertValue(r,t)}),n}convertVectorValue(e){var t,n,i;const r=(i=(n=(t=e.fields)===null||t===void 0?void 0:t[ms].arrayValue)===null||n===void 0?void 0:n.values)===null||i===void 0?void 0:i.map(o=>de(o.doubleValue));return new gt(r)}convertGeoPoint(e){return new mt(de(e.latitude),de(e.longitude))}convertArray(e,t){return(e.values||[]).map(n=>this.convertValue(n,t))}convertServerTimestamp(e,t){switch(t){case"previous":const n=qo(e);return n==null?null:this.convertValue(n,t);case"estimate":return this.convertTimestamp(Oi(e));default:return null}}convertTimestamp(e){const t=St(e);return new se(t.seconds,t.nanos)}convertDocumentKey(e,t){const n=te.fromString(e);U(ep(n),9688,{name:e});const i=new Sn(n.get(1),n.get(3)),r=new M(n.popFirst(5));return i.isEqual(t)||ye(`Document ${r} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),r}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const om=function(s){try{if(typeof window<"u"&&typeof window[s]<"u"){const e=window[s];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Gv(e)}}catch{}return new zv},In=om("localStorage"),Kv=om("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bu="5",hm="v",dm="s",fm="r",_m="f",pm=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,mm="ls",gm="p",Pl="ac",ym="websocket",Em="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ka={},Wa={};function qu(s){const e=s.toString();return Ka[e]||(Ka[e]=new aT),Ka[e]}function lT(s,e){const t=s.toString();return Wa[t]||(Wa[t]=e()),Wa[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oa{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new $(Ps,e),i=new $(Ps,t);return this.compare(n,i)!==0}minPost(){return $.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Mr;class Dm extends oa{static get __EMPTY_NODE(){return Mr}static set __EMPTY_NODE(e){Mr=e}compare(e,t){return Fs(e.name,t.name)}isDefinedOn(e){throw Hi("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return $.MIN}maxPost(){return new $(kn,Mr)}makePost(e,t){return k(typeof e=="string","KeyIndex indexValue must always be a string."),new $(e,Mr)}toString(){return".key"}}const as=new Dm;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bl;function qT(s){bl=s}const km=function(s){return typeof s=="number"?"number:"+cm(s):"string:"+s},Om=function(s){if(s.isLeafNode()){const e=s.val();k(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Vt(e,".sv"),"Priority must be a string or number.")}else k(s===bl||s.isEmpty(),"priority of unexpected type.");k(s===bl||s.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YT extends oa{compare(e,t){const n=e.node.compareTo(t.node);return n===0?Fs(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return $.MIN}maxPost(){return $.MAX}makePost(e,t){const n=Le(e);return new $(t,n)}toString(){return".value"}}const XT=new YT;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ao(){return{value:null,children:new Map}}function Um(s,e,t){if(H(e))s.value=t,s.children.clear();else if(s.value!==null)s.value=s.value.updateChild(e,t);else{const n=Q(e);s.children.has(n)||s.children.set(n,Ao());const i=s.children.get(n);e=ue(e),Um(i,e,t)}}function Vl(s,e,t){s.value!==null?t(e,s.value):nw(s,(n,i)=>{const r=new ae(e.toString()+"/"+n);Vl(i,r,t)})}function nw(s,e){s.children.forEach((t,n)=>{e(n,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function aa(s,e){return{eventCache:s,serverCache:e}}function Si(s,e,t,n){return aa(new Mn(e,t,n),s.serverCache)}function qm(s,e,t,n){return aa(s.eventCache,new Mn(e,t,n))}function xl(s){return s.eventCache.isFullyInitialized()?s.eventCache.getNode():null}function Fn(s){return s.serverCache.isFullyInitialized()?s.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(e){this.writeTree_=e}static empty(){return new ut(new he(null))}}function Pi(s,e,t){if(H(e))return new ut(new he(t));{const n=s.writeTree_.findRootMostValueAndPath(e);if(n!=null){const i=n.path;let r=n.value;const o=$e(i,e);return r=r.updateChild(o,t),new ut(s.writeTree_.set(i,r))}else{const i=new he(t),r=s.writeTree_.setTree(e,i);return new ut(r)}}}function of(s,e,t){let n=s;return Ye(t,(i,r)=>{n=Pi(n,we(e,i),r)}),n}function af(s,e){if(H(e))return ut.empty();{const t=s.writeTree_.setTree(e,new he(null));return new ut(t)}}function Nl(s,e){return Un(s,e)!=null}function Un(s,e){const t=s.writeTree_.findRootMostValueAndPath(e);return t!=null?s.writeTree_.get(t.path).getChild($e(t.path,e)):null}function lf(s){const e=[],t=s.writeTree_.value;return t!=null?t.isLeafNode()||t.forEachChild(ge,(n,i)=>{e.push(new $(n,i))}):s.writeTree_.children.inorderTraversal((n,i)=>{i.value!=null&&e.push(new $(n,i.value))}),e}function $t(s,e){if(H(e))return s;{const t=Un(s,e);return t!=null?new ut(new he(t)):new ut(s.writeTree_.subtree(e))}}function Dl(s){return s.writeTree_.isEmpty()}function Vs(s,e){return jm(ne(),s.writeTree_,e)}function jm(s,e,t){if(e.value!=null)return t.updateChild(s,e.value);{let n=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(k(r.value!==null,"Priority writes must always be leaf nodes"),n=r.value):t=jm(we(s,i),r,t)}),!t.getChild(s).isEmpty()&&n!==null&&(t=t.updateChild(we(s,".priority"),n)),t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bo;class Bw{constructor(){this.views=new Map}}function qw(s){k(!bo,"__referenceConstructor has already been defined"),bo=s}function jw(){return k(bo,"Reference.ts has not been loaded"),bo}function Gw(s){return s.views.size===0}function ec(s,e,t,n){const i=e.source.queryId;if(i!==null){const r=s.views.get(i);return k(r!=null,"SyncTree gave us an op for an invalid query."),_f(r,e,t,n)}else{let r=[];for(const o of s.views.values())r=r.concat(_f(o,e,t,n));return r}}function zw(s,e,t,n,i){const r=e._queryIdentifier,o=s.views.get(r);if(!o){let l=Co(t,i?n:null),u=!1;l?u=!0:n instanceof z?(l=Xu(t,n),u=!1):(l=z.EMPTY_NODE,u=!1);const c=aa(new Mn(l,u,!1),new Mn(n,i,!1));return new Ow(e,c)}return o}function Kw(s,e,t,n,i,r){const o=zw(s,e,n,i,r);return s.views.has(e._queryIdentifier)||s.views.set(e._queryIdentifier,o),Lw(o,t),Uw(o,t)}function Ww(s,e,t,n){const i=e._queryIdentifier,r=[];let o=[];const l=en(s);if(i==="default")for(const[u,c]of s.views.entries())o=o.concat(ff(c,t,n)),df(c)&&(s.views.delete(u),c.query._queryParams.loadsAllData()||r.push(c.query));else{const u=s.views.get(i);u&&(o=o.concat(ff(u,t,n)),df(u)&&(s.views.delete(i),u.query._queryParams.loadsAllData()||r.push(u.query)))}return l&&!en(s)&&r.push(new(jw())(e._repo,e._path)),{removed:r,events:o}}function Ym(s){const e=[];for(const t of s.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function ls(s,e){let t=null;for(const n of s.views.values())t=t||Fw(n,e);return t}function Xm(s,e){if(e._queryParams.loadsAllData())return la(s);{const n=e._queryIdentifier;return s.views.get(n)}}function Jm(s,e){return Xm(s,e)!=null}function en(s){return la(s)!=null}function la(s){for(const e of s.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vo;function $w(s){k(!Vo,"__referenceConstructor has already been defined"),Vo=s}function Qw(){return k(Vo,"Reference.ts has not been loaded"),Vo}let Hw=1;class pf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new he(null),this.pendingWriteTree_=ww(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Yw(s,e,t,n,i){return dw(s.pendingWriteTree_,e,t,n,i),i?lr(s,new On(Bm(),e,t)):[]}function is(s,e,t=!1){const n=fw(s.pendingWriteTree_,e);if(_w(s.pendingWriteTree_,e)){let r=new he(null);return n.snap!=null?r=r.set(ne(),!0):Ye(n.children,o=>{r=r.set(new ae(o),!0)}),lr(s,new Ro(n.path,r,t))}else return[]}function ua(s,e,t){return lr(s,new On(Qu(),e,t))}function Xw(s,e,t){const n=he.fromObject(t);return lr(s,new Qi(Qu(),e,n))}function Jw(s,e){return lr(s,new $i(Qu(),e))}function Zw(s,e,t){const n=tc(s,t);if(n){const i=nc(n),r=i.path,o=i.queryId,l=$e(r,e),u=new $i(Hu(o),l);return sc(s,r,u)}else return[]}function Ml(s,e,t,n,i=!1){const r=e._path,o=s.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||Jm(o,e))){const u=Ww(o,e,t,n);Gw(o)&&(s.syncPointTree_=s.syncPointTree_.remove(r));const c=u.removed;if(l=u.events,!i){const f=c.findIndex(m=>m._queryParams.loadsAllData())!==-1,_=s.syncPointTree_.findOnPath(r,(m,I)=>en(I));if(f&&!_){const m=s.syncPointTree_.subtree(r);if(!m.isEmpty()){const I=nA(m);for(let S=0;S<I.length;++S){const V=I[S],x=V.query,K=ng(s,V);s.listenProvider_.startListening(bi(x),xo(s,x),K.hashFn,K.onComplete)}}}!_&&c.length>0&&!n&&(f?s.listenProvider_.stopListening(bi(e),null):c.forEach(m=>{const I=s.queryToTagMap.get(ca(m));s.listenProvider_.stopListening(bi(m),I)}))}sA(s,c)}return l}function eA(s,e,t,n){const i=tc(s,n);if(i!=null){const r=nc(i),o=r.path,l=r.queryId,u=$e(o,e),c=new On(Hu(l),u,t);return sc(s,o,c)}else return[]}function tA(s,e,t,n){const i=tc(s,n);if(i){const r=nc(i),o=r.path,l=r.queryId,u=$e(o,e),c=he.fromObject(t),f=new Qi(Hu(l),u,c);return sc(s,o,f)}else return[]}function mf(s,e,t,n=!1){const i=e._path;let r=null,o=!1;s.syncPointTree_.foreachOnPath(i,(m,I)=>{const S=$e(m,i);r=r||ls(I,S),o=o||en(I)});let l=s.syncPointTree_.get(i);l?(o=o||en(l),r=r||ls(l,ne())):(l=new Bw,s.syncPointTree_=s.syncPointTree_.set(i,l));let u;r!=null?u=!0:(u=!1,r=z.EMPTY_NODE,s.syncPointTree_.subtree(i).foreachChild((I,S)=>{const V=ls(S,ne());V&&(r=r.updateImmediateChild(I,V))}));const c=Jm(l,e);if(!c&&!e._queryParams.loadsAllData()){const m=ca(e);k(!s.queryToTagMap.has(m),"View does not exist, but we have a tag");const I=iA();s.queryToTagMap.set(m,I),s.tagToQueryMap.set(I,m)}const f=Yu(s.pendingWriteTree_,i);let _=Kw(l,e,t,f,r,u);if(!c&&!o&&!n){const m=Xm(l,e);_=_.concat(rA(s,e,m))}return _}function Zm(s,e,t){const i=s.pendingWriteTree_,r=s.syncPointTree_.findOnPath(e,(o,l)=>{const u=$e(o,e),c=ls(l,u);if(c)return c});return zm(i,e,r,t,!0)}function lr(s,e){return eg(e,s.syncPointTree_,null,Yu(s.pendingWriteTree_,ne()))}function eg(s,e,t,n){if(H(s.path))return tg(s,e,t,n);{const i=e.get(ne());t==null&&i!=null&&(t=ls(i,ne()));let r=[];const o=Q(s.path),l=s.operationForChild(o),u=e.children.get(o);if(u&&l){const c=t?t.getImmediateChild(o):null,f=Km(n,o);r=r.concat(eg(l,u,c,f))}return i&&(r=r.concat(ec(i,s,n,t))),r}}function tg(s,e,t,n){const i=e.get(ne());t==null&&i!=null&&(t=ls(i,ne()));let r=[];return e.children.inorderTraversal((o,l)=>{const u=t?t.getImmediateChild(o):null,c=Km(n,o),f=s.operationForChild(o);f&&(r=r.concat(tg(f,l,u,c)))}),i&&(r=r.concat(ec(i,s,n,t))),r}function ng(s,e){const t=e.query,n=xo(s,t);return{hashFn:()=>(Mw(e)||z.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return n?Zw(s,t._path,n):Jw(s,t._path);{const r=Zv(i,t);return Ml(s,t,null,r)}}}}function xo(s,e){const t=ca(e);return s.queryToTagMap.get(t)}function ca(s){return s._path.toString()+"$"+s._queryIdentifier}function tc(s,e){return s.tagToQueryMap.get(e)}function nc(s){const e=s.indexOf("$");return k(e!==-1&&e<s.length-1,"Bad queryKey."),{queryId:s.substr(e+1),path:new ae(s.substr(0,e))}}function sc(s,e,t){const n=s.syncPointTree_.get(e);k(n,"Missing sync point for query tag that we're tracking");const i=Yu(s.pendingWriteTree_,e);return ec(n,t,i,null)}function nA(s){return s.fold((e,t,n)=>{if(t&&en(t))return[la(t)];{let i=[];return t&&(i=Ym(t)),Ye(n,(r,o)=>{i=i.concat(o)}),i}})}function bi(s){return s._queryParams.loadsAllData()&&!s._queryParams.isDefault()?new(Qw())(s._repo,s._path):s}function sA(s,e){for(let t=0;t<e.length;++t){const n=e[t];if(!n._queryParams.loadsAllData()){const i=ca(n),r=s.queryToTagMap.get(i);s.queryToTagMap.delete(i),s.tagToQueryMap.delete(r)}}}function iA(){return Hw++}function rA(s,e,t){const n=e._path,i=xo(s,e),r=ng(s,t),o=s.listenProvider_.startListening(bi(e),i,r.hashFn,r.onComplete),l=s.syncPointTree_.subtree(n);if(i)k(!en(l.value),"If we're adding a query, it shouldn't be shadowed");else{const u=l.fold((c,f,_)=>{if(!H(c)&&f&&en(f))return[la(f).query];{let m=[];return f&&(m=m.concat(Ym(f).map(I=>I.query))),Ye(_,(I,S)=>{m=m.concat(S)}),m}});for(let c=0;c<u.length;++c){const f=u[c];s.listenProvider_.stopListening(bi(f),xo(s,f))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ac{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function lc(s,e){let t=e instanceof ae?e:new ae(e),n=s,i=Q(t);for(;i!==null;){const r=us(n.node.children,i)||{children:{},childCount:0};n=new ac(i,n,r),t=ue(t),i=Q(t)}return n}function Ls(s){return s.node.value}function sg(s,e){s.node.value=e,Fl(s)}function ig(s){return s.node.childCount>0}function hA(s){return Ls(s)===void 0&&!ig(s)}function ha(s,e){Ye(s.node.children,(t,n)=>{e(new ac(t,s,n))})}function rg(s,e,t,n){t&&e(s),ha(s,i=>{rg(i,e,!0)})}function dA(s,e,t){let n=s.parent;for(;n!==null;){if(e(n))return!0;n=n.parent}return!1}function ur(s){return new ae(s.parent===null?s.name:ur(s.parent)+"/"+s.name)}function Fl(s){s.parent!==null&&fA(s.parent,s.name,s)}function fA(s,e,t){const n=hA(t),i=Vt(s.node.children,e);n&&i?(delete s.node.children[e],s.node.childCount--,Fl(s)):!n&&!i&&(s.node.children[e]=t.node,s.node.childCount++,Fl(s))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _A=/[\[\].#$\/\u0000-\u001F\u007F]/,pA=/[\[\].#$\u0000-\u001F\u007F]/,Ya=10*1024*1024,og=function(s){return typeof s=="string"&&s.length!==0&&!_A.test(s)},ag=function(s){return typeof s=="string"&&s.length!==0&&!pA.test(s)},mA=function(s){return s&&(s=s.replace(/^\/*\.info(\/|$)/,"/")),ag(s)},lg=function(s,e,t){const n=t instanceof ae?new NT(t,s):t;if(e===void 0)throw new Error(s+"contains undefined "+_n(n));if(typeof e=="function")throw new Error(s+"contains a function "+_n(n)+" with contents = "+e.toString());if(lm(e))throw new Error(s+"contains "+e.toString()+" "+_n(n));if(typeof e=="string"&&e.length>Ya/3&&ko(e)>Ya)throw new Error(s+"contains a string greater than "+Ya+" utf8 bytes "+_n(n)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(Ye(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!og(o)))throw new Error(s+" contains an invalid key ("+o+") "+_n(n)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);DT(n,o),lg(s,l,n),kT(n)}),i&&r)throw new Error(s+' contains ".value" child '+_n(n)+" in addition to actual children.")}},ug=function(s,e,t,n){if(!ag(t))throw new Error(xf(s,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},gA=function(s,e,t,n){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),ug(s,e,t)},yA=function(s,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!og(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!mA(t))throw new Error(xf(s,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dc{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return H(this._path)?null:bm(this._path)}get ref(){return new on(this._repo,this._path)}get _queryIdentifier(){const e=sf(this._queryParams),t=Uu(e);return t==="{}"?"default":t}get _queryObject(){return sf(this._queryParams)}isEqual(e){if(e=He(e),!(e instanceof dc))return!1;const t=this._repo===e._repo,n=Gu(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+xT(this._path)}}class on extends dc{constructor(e,t){super(e,t,new $u,!1)}get parent(){const e=xm(this._path);return e===null?null:new on(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class No{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ae(e),n=Ll(this.ref,e);return new No(this._node.getChild(t),n,ge)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(n,i)=>e(new No(i,Ll(this.ref,n),ge)))}hasChild(e){const t=new ae(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function _R(s,e){return s=He(s),s._checkNotDeleted("ref"),e!==void 0?Ll(s._root,e):s._root}function Ll(s,e){return s=He(s),Q(s._path)===null?gA("child","path",e):ug("child","path",e),new on(s._repo,we(s._path,e))}class fc{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const n=t._queryParams.getIndex();return new LA("value",this,new No(e.snapshotNode,new on(t._repo,t._path),n))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new UA(this,e,t):null}matches(e){return e instanceof fc?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function qA(s,e,t,n,i){const r=new BA(t,void 0),o=new fc(r);return bA(s._repo,s,o),()=>VA(s._repo,s,o)}function pR(s,e,t,n){return qA(s,"value",e)}qw(on);$w(on);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YA(s){jv(Vf),Tf(new wf("database",(e,{instanceIdentifier:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return KA(n,i,r,t)},"PUBLIC").setMultipleInstances(!0)),Xr(Bd,qd,s),Xr(Bd,qd,"esm2017")}Ct.prototype.simpleListen=function(s,e){this.sendRequest("q",{p:s},e)};Ct.prototype.echo=function(s,e){this.sendRequest("echo",{d:s},e)};YA();export{dR as a,uR as b,eR as c,Rv as d,iR as e,cR as f,mR as g,fR as h,tR as i,oR as j,rR as l,pR as o,hR as p,nR as q,_R as r,aR as s,lR as u,sR as w};
